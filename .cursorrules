...
src/lib/services/ticket-creator.ts  ← THE ticket creator (selected messages + the member twin → a TicketDraft; reasoning tier via the Elaya provider + maskPii; every call = sia.extraction_runs row; fails closed to null)
