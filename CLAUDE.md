...
src/lib/services/members-service.ts ← ALL /members reads (session client; RLS member_visible = the whole queendom + admin/founder): listMembers, getMemberDetail, searchMembersForPicker, getQueendoms. The mirror's tickets and the Sia group come from their own homes (getFreshdeskTicketsForMember, getSiaGroupForMember)
