...
src/lib/constants/vendors.ts        ← THE Vendors vocabulary (0182–0184): statuses / sources (ONE list for vendors.sources + engagements.source) / stances / outcomes / VENDOR_SERVICES (no SQL CHECK — grown as we learn) via defineEnum + REVIEW_DIMENSIONS (the 4 MANUAL ratings) + SCORE_WEIGHTS + window/limits + VENDOR_INVOICE_BUCKET + VENDORS_PATH
