...
src/lib/constants/freshdesk.ts      ← THE Freshdesk vocabulary as mirrored (status ids 2..9 + 9000 with labels/tones, priority, source, FD_TRACKED_FIELDS, the budget numbers, FRESHDESK_PATH); the synced ticket_fields choices always win over these fallbacks
