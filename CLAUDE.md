...
src/lib/services/member-mutations.ts ← THE context-free member write cores (create/update spine, addFact with supersede, people, linkGroup, health adjust, logMemberAccess); actions/members.ts AND future Elaya tools call the SAME core; the caller checks canAccessMember (lib/elaya/access.ts) first
