...
relationship (member records → Sia) → extend to further modules (call intelligence, oversight, and beyond).**
...
Member records (the post-won flow). The Elaya WhatsApp customer persona shipped 2026-06-26,
so member records is the remaining focus item. The
