...
\restrict mrOD0KCzCWEYNxMtKPz2HbGbDCIeanrdunoozwqIvBfxeSeK4ZZWf2PGyO6L9uH
...
CREATE TABLE public.leads (
    ...
    city text,
    lead_health text,
    CONSTRAINT leads_deal_duration_check CHECK (((deal_duration IS NULL) OR (deal_duration = ANY (ARRAY['3_months'::text, '6_months'::text, '1_year'::text])))),
    CONSTRAINT leads_deal_type_check CHECK ((deal_type = ANY (ARRAY['membership'::text, 'retail'::text]))),
    CONSTRAINT leads_lead_health_check CHECK ((lead_health = ANY (ARRAY['healthy'::text, 'needs_attention'::text, 'at_risk'::text])))
);
...
CREATE FUNCTION public.get_active_lead_by_phone(p_phone text) RETURNS SETOF public.leads
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT *
...
--
-- Name: get_campaign_pipeline_refresh(text, public.app_domain); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain) RETURNS jsonb
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain) OWNER TO postgres;
...
--
-- Name: get_dashboard_summary(text, public.app_domain, uuid, public.app_domain); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain DEFAULT NULL::public.app_domain) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain) OWNER TO postgres;
...
--
-- Name: refresh_lead_health_bulk(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.refresh_lead_health_bulk() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.refresh_lead_health_bulk() OWNER TO postgres;
...
--
-- Name: idx_leads_health; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_leads_health ON public.leads USING btree (lead_health, assigned_to) WHERE (archived_at IS NULL);
...
CREATE POLICY audit_log_select ON public.profile_audit_log FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY deals_admin_select ON public.deals FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY deals_agent_select ON public.deals FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND (assigned_to = auth.uid())));
...
CREATE POLICY deals_manager_select ON public.deals FOR SELECT USING (((public.get_user_role() = 'manager'::public.user_role) AND (domain = public.get_user_domain())));
...
CREATE POLICY lead_activities_select ON public.lead_activities FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.leads l
  WHERE ((l.id = lead_activities.lead_id) AND (((public.get_user_role() = 'agent'::public.user_role) AND (l.assigned_to = auth.uid())) OR ((public.get_user_role() = 'manager'::public.user_role) AND (l.domain = public.get_user_domain())) OR (public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role]))) AND (l.archived_at IS NULL)))));
...
CREATE POLICY lead_notes_select ON public.lead_notes FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.leads l
  WHERE ((l.id = lead_notes.lead_id) AND (((public.get_user_role() = 'agent'::public.user_role) AND (l.assigned_to = auth.uid())) OR ((public.get_user_role() = 'manager'::public.user_role) AND (l.domain = public.get_user_domain())) OR (public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role]))) AND (l.archived_at IS NULL)))));
...
CREATE POLICY lead_raw_payloads_admin_founder_select ON public.lead_raw_payloads FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY lead_sla_timers_admin_founder_select ON public.lead_sla_timers FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY lead_sla_timers_agent_select ON public.lead_sla_timers FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND (EXISTS ( SELECT 1
   FROM public.leads l
...
CREATE POLICY lead_sla_timers_manager_select ON public.lead_sla_timers FOR SELECT USING (((public.get_user_role() = 'manager'::public.user_role) AND (EXISTS ( SELECT 1
   FROM public.leads l
  WHERE ((l.id = lead_sla_timers.lead_id) AND (l.domain = public.get_user_domain()) AND (l.archived_at IS NULL))))));
...
CREATE POLICY leads_admin_founder_select ON public.leads FOR SELECT USING (((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])) AND (archived_at IS NULL)));
...
CREATE POLICY leads_agent_select ON public.leads FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND (assigned_to = auth.uid()) AND (archived_at IS NULL)));
...
CREATE POLICY leads_manager_select ON public.leads FOR SELECT USING (((public.get_user_role() = 'manager'::public.user_role) AND (domain = public.get_user_domain()) AND (archived_at IS NULL)));
...
CREATE POLICY leads_update ON public.leads FOR UPDATE USING ((((public.get_user_role() = 'agent'::public.user_role) AND (assigned_to = auth.uid())) OR ((public.get_user_role() = 'manager'::public.user_role) AND (domain = public.get_user_domain())) OR (public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role]))));
...
CREATE POLICY profiles_update ON public.profiles FOR UPDATE USING (((auth.uid() = id) OR (public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])))) WITH CHECK (((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])) OR ((auth.uid() = id) AND (role = ( SELECT profiles_1.role
...
CREATE POLICY routing_config_update ON public.agent_routing_config FOR UPDATE USING ((public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role]))) WITH CHECK ((public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY task_audit_log_select ON public.task_audit_log FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY task_gia_meta_select ON public.task_gia_meta FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tasks t
  WHERE ((t.id = task_gia_meta.task_id) AND (((public.get_user_role() = 'agent'::public.user_role) AND (t.assigned_to = auth.uid())) OR (public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role])))))));
...
CREATE POLICY task_remarks_insert ON public.task_remarks FOR INSERT WITH CHECK (((auth.uid() IS NOT NULL) AND (author_id = auth.uid()) AND (EXISTS ( SELECT 1
   FROM public.tasks t
  WHERE ((t.id = task_remarks.task_id) AND ((t.assigned_to = auth.uid()) OR (t.created_by = auth.uid()) OR (public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role]))))))));
...
CREATE POLICY task_remarks_suppression_update ON public.task_remarks FOR UPDATE USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role]))) WITH CHECK ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY tasks_agent_select ON public.tasks FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND ((assigned_to = auth.uid()) OR (created_by = auth.uid()))));
...
CREATE POLICY tasks_manager_admin_founder_select ON public.tasks FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY tasks_update ON public.tasks FOR UPDATE USING ((((public.get_user_role() = 'agent'::public.user_role) AND (assigned_to = auth.uid())) OR (public.get_user_role() = ANY (ARRAY['manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role]))));
...
CREATE POLICY wa_conversations_admin_founder_select ON public.whatsapp_conversations FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY wa_conversations_agent_select ON public.whatsapp_conversations FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND public.can_access_wa_conversation(lead_id)));
...
CREATE POLICY wa_conversations_manager_select ON public.whatsapp_conversations FOR SELECT USING (((public.get_user_role() = 'manager'::public.user_role) AND public.can_access_wa_conversation(lead_id)));
...
CREATE POLICY wa_conversations_update ON public.whatsapp_conversations FOR UPDATE USING ((((public.get_user_role() = 'agent'::public.user_role) AND public.can_access_wa_conversation(lead_id)) OR ((public.get_user_role() = 'manager'::public.user_role) AND public.can_access_wa_conversation(lead_id)) OR (public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role]))));
...
CREATE POLICY wa_messages_admin_founder_select ON public.whatsapp_messages FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
CREATE POLICY wa_messages_agent_select ON public.whatsapp_messages FOR SELECT USING (((public.get_user_role() = 'agent'::public.user_role) AND public.can_access_wa_conversation(lead_id)));
...
CREATE POLICY wa_messages_manager_select ON public.whatsapp_messages FOR SELECT USING (((public.get_user_role() = 'manager'::public.user_role) AND public.can_access_wa_conversation(lead_id)));
...
CREATE POLICY wa_messages_outbound_insert ON public.whatsapp_messages FOR INSERT TO authenticated WITH CHECK (((direction = 'outbound'::text) AND (sender_type = 'agent'::text) AND (sender_id = auth.uid()) AND public.can_access_wa_conversation(lead_id) AND (public.get_user_role() = ANY (ARRAY['agent'::public.user_role, 'manager'::public.user_role, 'admin'::public.user_role, 'founder'::public.user_role]))));
...
CREATE POLICY wa_notif_logs_admin_founder_select ON public.whatsapp_notification_logs FOR SELECT USING ((public.get_user_role() = ANY (ARRAY['admin'::public.user_role, 'founder'::public.user_role])));
...
--
-- Name: objects Ad Creative Modal delete; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Ad Creative Modal delete" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'ad-creatives'::text));


--
-- Name: objects Ad Creative Modal insert; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Ad Creative Modal insert" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'ad-creatives'::text));
...
CREATE POLICY "Users can delete their own avatar" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'avatars'::text) AND (name = (auth.uid())::text)));
...
CREATE POLICY "Users can update their own avatar" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'avatars'::text) AND (name = (auth.uid())::text))) WITH CHECK (((bucket_id = 'avatars'::text) AND (name = (auth.uid())::text)));
...
CREATE POLICY "Users can upload their own avatar" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'avatars'::text) AND (name = (auth.uid())::text)));
...
--
-- Name: FUNCTION get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain) TO anon;
GRANT ALL ON FUNCTION public.get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain) TO authenticated;
GRANT ALL ON FUNCTION public.get_campaign_pipeline_refresh(p_role text, p_domain public.app_domain) TO service_role;
...
--
-- Name: FUNCTION get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain) TO anon;
GRANT ALL ON FUNCTION public.get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain) TO authenticated;
GRANT ALL ON FUNCTION public.get_dashboard_summary(p_role text, p_domain public.app_domain, p_user_id uuid, p_initial_domain public.app_domain) TO service_role;
...
--
-- Name: FUNCTION refresh_lead_health_bulk(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.refresh_lead_health_bulk() TO anon;
GRANT ALL ON FUNCTION public.refresh_lead_health_bulk() TO authenticated;
GRANT ALL ON FUNCTION public.refresh_lead_health_bulk() TO service_role;
...
\unrestrict mrOD0KCzCWEYNxMtKPz2HbGbDCIeanrdunoozwqIvBfxeSeK4ZZWf2PGyO6L9uH
