...
| The client profile + Serene-native ticketing (the sentinel, intake, the profile layers) | planned | `client-ticket-plan.md` (supersedes `plan-sia-intelligence.md` where they differ) |
