# Graph Report - serene  (2026-08-31)

## Corpus Check
- 1066 files · ~5,740,945 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8219 nodes · 16452 edges · 482 communities (446 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9ca9e3f8`
...
Cohesion: 0.05
Nodes (66): addTaskRemarkAction(), statusLabel(), require, ElayaActionPayload, ElayaActionTarget, ElayaActionType, ElayaLeadTarget, ElayaTaskTarget (+58 more)
...
Cohesion: 0.05
Nodes (45): AgentSelfMetrics, Cell(), OversightStatRow(), AgentActivityTrendChart, CallOutcomeBar, CoreFourGrid, PipelineLine(), Props (+37 more)
...
Cohesion: 0.06
Nodes (44): AgentDetailAsync(), CallerRole, OversightAgentPage(), DOMAIN_ICONS, GIA_DOMAIN_ICONS, ALL_DOMAINS_ICON, DOMAIN_LABELS, isAppDomain() (+36 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.05
Nodes (68): assignLead(), createManualLead(), isNotificationCategoryKey(), SIA_ALERT_TIER1_PROFILE_IDS, CustomerTurnInput, resolveCustomerPrincipal(), handleCustomerReply(), maybeSendCustomerWelcome() (+60 more)
...
Cohesion: 0.06
Nodes (66): getAssignableUsersAction(), getCompletedTasksAction(), getGroupSubtasksAction(), getPersonalTaskTagsAction(), useCreateTriggerModal(), WorkspaceAsync(), WorkspaceAsyncProps, CompletedTaskCursor (+58 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.08
Nodes (22): compareDomainDisplayOrder(), loadCsv(), loadCsv(), AgentSettingsTableProps, DAY_DISPLAY_ORDER, DAY_LABELS, DEFAULT_WORK_DAYS, POOL_FILTER_ITEMS (+14 more)
...
Cohesion: 0.05
Nodes (58): deleteGroupTaskAction(), GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, TASK_STATUS_DEF, TASK_TYPE_DEF (+50 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.21
Nodes (9): buildLeadListKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS, REDIS_TTL, SIA_ALERT_KINDS, redis, ConversationHookRow, ServiceCaseRow (+1 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.09
Nodes (33): getSpendingOverview(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES, monthBounds(), SpendingOverviewFilters (+25 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.10
Nodes (26): getAgentUsageAction(), recordPresenceAction(), ChartSkeleton(), ChartSkeletonProps, INTERACTION_EVENTS, UsagePresence(), getAgentUsage(), HeartbeatInsert (+18 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.08
Nodes (33): createSlaPolicyAction(), generateUserPolicyCode(), RESERVED_CODE_PREFIXES, updateSlaPolicyAction(), isCadenceCode(), createSlaPolicy(), NewSlaPolicy, SlaPolicyPatch (+25 more)
...
Cohesion: 0.14
Nodes (17): ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, Props, getExistingSpendKeys(), AdSpendParseError, AdSpendUploadRow, ParsedAdSpend (+9 more)
...
Cohesion: 0.14
Nodes (22): getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), markReadSchema, useNotifications(), UseNotificationsReturn, useNotificationSound(), NotificationsContext (+14 more)
...
Cohesion: 0.08
Nodes (28): recordDeal(), JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, JOURNEY_STATUSES, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, LEAD_STATUSES (+20 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.11
Nodes (25): PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_DEPARTMENT_OPTIONS, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionShape, SubscriptionShapeInput (+17 more)
...
Cohesion: 0.17
Nodes (12): DashboardDateFilter(), PRESETS, UseUrlFiltersOptions, UseUrlFiltersReturn, DateRangeFields(), DateRangeFieldsProps, FIELD_LABEL_STYLE, DATE_PRESET_LABELS (+4 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.07
Nodes (46): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), metadata, MobileActivityPage() (+38 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.08
Nodes (21): AgentPerformanceShell(), FounderPerfActionsContext, FounderPerfActionsContextValue, FounderPerfActionsProvider(), useFounderPerfActions(), DomainOverviewPanel, FounderPerformanceShell(), Props (+13 more)
...
Cohesion: 0.10
Nodes (41): encoder, isRateLimited, POST(), SseEvent, ELAYA_DAILY_LINES, getElayaTimeGreeting(), pickElayaDailyLine(), metadata (+33 more)
...
Cohesion: 0.15
Nodes (17): getElayaChatSeedAction(), updateElayaPersonaAction(), ELAYA_STARTER_PROMPTS, CAPABILITIES, ElayaIdentityCard(), Props, ElayaChatShell, EmbeddedElayaChat() (+9 more)
...
Cohesion: 0.11
Nodes (14): EscalatedLeadsSection(), GoingColdSection(), OverdueTasksSection(), RECIPIENT_META, secondaryCell, tertiaryCell, EscalationsSkeleton(), metadata (+6 more)

### Community 42 - "Agent Deals & Cards"
Cohesion: 0.11
Nodes (18): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTable(), UsersTableProps, SPRING_BOUNCE, ElayaChatShell() (+10 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.09
Nodes (25): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton(), CampaignsPage(), parseFilters() (+17 more)
...
Cohesion: 0.05
Nodes (53): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+45 more)
...
Cohesion: 0.19
Nodes (14): DOMAIN_ICONS, persistDomainCookie(), readDomainCookie(), AddWidgetMenu(), MQ, useMediaQuery(), DOMAIN_ITEMS, DomainSelector() (+6 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.09
Nodes (29): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, chevronStyle, EditAuthorizationForm(), initialState, labelStyle, Props (+21 more)
...
Cohesion: 0.16
Nodes (18): ConversationIdSchema, markConversationAsRead(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType(), mediaExtFromMime() (+10 more)
...
Cohesion: 0.08
Nodes (53): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getAgentTasksSummaryAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction() (+45 more)
...
Cohesion: 0.09
Nodes (25): DEFAULT_COLUMN_ORDER, isValidLeadColumnId(), LEAD_COLUMN_MAP, LEAD_COLUMNS, LeadColumnDef, LeadColumnId, LEAD_STATUS_BADGE, getDefaults() (+17 more)
...
Cohesion: 0.14
Nodes (13): getConversationsAction(), getMessagesAction(), initiateWhatsAppConversationAction(), dateSeparatorLabel(), LeadWhatsAppCardProps, WhatsAppConversation, WhatsAppMessage, ConversationListProps (+5 more)
...
Cohesion: 0.12
Nodes (16): setNotificationPrefAction(), categoriesForRole(), CATEGORY_BY_KEY, NOTIFICATION_CATEGORY_ENUM, NOTIFICATION_CATEGORY_KEYS, NotificationCategory, NotificationCategoryKey, NotificationChannel (+8 more)
...
Cohesion: 0.04
Nodes (97): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+89 more)
...
Cohesion: 0.10
Nodes (33): AccountReportSection(), AdSpendUploadModal(), BudgetSectionHeader(), SectionHeaderDatum(), BudgetTable(), BudgetTableRow, COLUMNS, BudgetWorkspace() (+25 more)
...
Cohesion: 0.14
Nodes (17): deleteNote(), upsertNote(), RootPage(), GET(), inputBase, NoteFormModal(), NoteFormModalProps, NotesManager() (+9 more)
...
Cohesion: 0.13
Nodes (16): ElayaFeedbackCard(), ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem, NavLink() (+8 more)
...
Cohesion: 0.09
Nodes (24): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), AdCreativeFormModal(), AdCreativeFormModalProps, chevronStyle, inputBase, selectBase (+16 more)
...
Cohesion: 0.08
Nodes (44): getAgentPulseAction(), getManagerRosterAction(), DashboardDateFilterProps, getRoster(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync(), AgentActivityFilter (+36 more)
...
Cohesion: 0.12
Nodes (11): FIELD_CHROME, MobileTextArea(), SearchPill(), ActionSheetItem, NewRequestSheet(), SOFT_OUT, Dialog(), DialogProps (+3 more)
...
Cohesion: 0.12
Nodes (18): getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), APP_DOMAIN_ENUM, AddSuggestionModal(), AddSuggestionModalProps (+10 more)
...
Cohesion: 0.13
Nodes (16): ProfileAvatarSection(), Props, AssigneePickerModal(), ROLE_BADGE_COLORS, AVATAR_COLOUR_PAIRS, AvatarProps, AvatarSize, FONT_SIZE (+8 more)
...
Cohesion: 0.05
Nodes (55): assertLeadFieldEditAccess(), BulkUpdateResult, exportLeadsAction(), ExportPayload, LeadEditContext, revalidateLeadDossier(), updateLeadCity(), updateLeadDomain() (+47 more)
...
Cohesion: 0.08
Nodes (26): SUBSCRIPTION_STATUS_CONFIG, PortalAnchorPosition, usePortalAnchor(), UsePortalAnchorOptions, AddEditSubscriptionModal, AddSubscriptionButton(), LogTopupModal, RecordPaymentModal (+18 more)
...
Cohesion: 0.05
Nodes (38): addLeadNote(), updatePersonalDetails(), getShopEnquiryTypeLabel(), LeadDossierPage(), CardHeader(), Props, DynamicFormResponses(), Props (+30 more)

### Community 119 - "Community 119"
Cohesion: 0.09
Nodes (27): deleteTrainingAsset(), TRAINING_ROLES, upsertTrainingAsset(), parseActionInput(), ElayaTrainingManager(), ElayaTrainingManagerProps, chevronStyle, inputBase (+19 more)
...
Cohesion: 0.09
Nodes (32): BarChart(), BarChartProps, BarChartSeries, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens (+24 more)
...
Cohesion: 0.03
Nodes (105): anthropicAdapter, BridgeBody, POST(), buildPersonaPromptBlock(), canAccessLead(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction() (+97 more)
...
Cohesion: 0.14
Nodes (18): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, LeadExportItem, MonthlyReportRow, currentMonthIso(), FORMAT_TABS (+10 more)

### Community 134 - "Community 134"
Cohesion: 0.13
Nodes (19): ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), Props, ElayaMessageBubble(), ElayaUiMessage, ElayaStatusText() (+11 more)
...
Cohesion: 0.08
Nodes (30): CampaignMetricsStripSkeleton(), CampaignDetailPage(), CampaignLeadsAsync(), CampaignMetricsAsync(), LeadInfoCardAsync(), Props, LeadsPagination(), LeadsPaginationProps (+22 more)
...
Cohesion: 0.17
Nodes (17): CURRENCY_SYMBOLS, SubscriptionCurrency, Props, ERROR_TEXT_STYLE, FIELD_LABEL_STYLE, HELP_TEXT_STYLE, INPUT_STYLE, todayIso() (+9 more)
...
Cohesion: 0.12
Nodes (28): GiaDomain, DomainFetchResult, useDomainRoomData(), DetailAppBar(), GreetingBlock(), HomeAppBar(), ProgressCard(), DomainSwiper() (+20 more)

### Community 177 - "Community 177"
Cohesion: 0.09
Nodes (25): EASE_OUT_SOFT, FollowUpEnginePage(), metadata, GroupTaskWorkspacePage(), STAGGER, WorkspaceSkeleton(), LeadRevivalPage(), metadata (+17 more)
...
Cohesion: 0.04
Nodes (56): actionBtnStyle, CARD_HOVER, actionBtnStyle, AssetCard(), CARD_HOVER, KIND_ICON, safeHost(), DROPDOWN_VARIANTS (+48 more)

### Community 203 - "Community 203"
Cohesion: 0.06
Nodes (41): APP_DOMAINS, useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher, LeadVolumeSummary, MultiDomainVolumeSummary, ProfileAuditLog (+33 more)
...
Cohesion: 0.08
Nodes (39): createUser(), inviteUser(), mapProfileError(), toggleUserActive(), updateProfile(), updateProfileAvatar(), updateUserAuthorization(), parseGiaDomainParam() (+31 more)
...
Cohesion: 0.05
Nodes (65): createLeadTaskAction(), actorFromProfile(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteTaskAction(), getTaskRemarksAction() (+57 more)
...
Cohesion: 0.10
Nodes (21): ElayaPersonaSettings(), FormNotice(), FormNoticeProps, TONES, IconSelector(), InstallPrompt(), ProfilePage(), FormStatus (+13 more)
...
Cohesion: 0.09
Nodes (28): getPersonalTasksAction(), EASE_SPRING, PersonalTaskRow, CreatePersonalTaskModal(), buildTaskDots(), CalendarTaskRow, CalendarTaskRowProps, DateSection (+20 more)

### Community 236 - "Community 236"
Cohesion: 0.24
Nodes (13): searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, parseWhatsAppPeriodFromSearchParams(), WhatsAppPeriodRange, ConversationList() (+5 more)
...
Cohesion: 0.05
Nodes (38): loginAction(), requestPasswordResetAction(), CampaignFilters(), CampaignFiltersProps, GIA_DOMAIN_FILTER_ITEMS, ForgotPasswordForm(), metadata, Agent (+30 more)
...
Cohesion: 0.03
Nodes (76): getDomainHealthMetricsAction(), CALL_OUTCOME_DEF, DealType, getDomainIcon(), MODAL_VARIANTS, FIRST_TOUCH_BUCKETS, FirstTouchBucket, FirstTouchBucketId (+68 more)
...
Cohesion: 0.15
Nodes (16): Any, count_user_messages_today(), get_latest_proposed_action(), get_model_context_messages(), get_or_create_active_conversation(), get_owned_conversation(), insert_assistant_message(), insert_user_message() (+8 more)
...
Cohesion: 0.06
Nodes (45): CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS, SHOP_ENQUIRY_TYPES (+37 more)
...
Cohesion: 0.47
Nodes (4): ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, canAccessRoute(), RouteProfile
...
Cohesion: 0.10
Nodes (14): INVOICE_ACCEPT_MIME, attachedStyle, InvoiceFieldProps, InvoiceLink(), triggerStyle, chip, Detail, iconBtn (+6 more)
...
Cohesion: 0.08
Nodes (26): LeadDealCard(), LeadDealCardProps, BulkEditLeadsModal, LeadsSelectionToolbar(), LeadsSelectionToolbarProps, ACTIVE, TaskRow(), DueDateChip() (+18 more)
...
Cohesion: 0.14
Nodes (15): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, BudgetPage() (+7 more)
...
Cohesion: 0.36
Nodes (5): HookList(), HookListProps, Props, ConversationHook, caseMatchesQuery()
...
Cohesion: 0.15
Nodes (14): AddDealButton(), NewDealModal, Props, CATEGORY_DOMAIN, DealsFilters(), DealsFiltersProps, DealsSkeleton(), DealsPage() (+6 more)
...
Cohesion: 0.50
Nodes (4): getHelpdeskFullLibrary(), HelpdeskPage(), Props, getHelpdeskLibrary()
...
Cohesion: 0.18
Nodes (12): loginSchema, RequireProfileResult, updatePasswordAction(), verifyResetOtpAction(), ForgotPasswordInput, forgotPasswordSchema, LoginInput, loginSchema (+4 more)

### Community 468 - "Community 468"
Cohesion: 0.08
Nodes (43): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), bulkUpdateLeads(), updateLeadStatus(), cancelSlaTimersForLead(), DEAL_CATEGORY_DEF (+35 more)
...
Cohesion: 0.15
Nodes (13): EMPTY, PaletteDealHit, PaletteLeadHit, paletteSearchAction(), PaletteSearchResult, PaletteTaskHit, metadata, MobileAgentTasksPage() (+5 more)

### Community 473 - "Community 473"
Cohesion: 0.16
Nodes (4): PasswordStrengthBar(), metadata, UpdatePasswordPage(), UpdatePasswordForm()
...
## Knowledge Gaps
- **4346 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4341 more)
...
- **Why does `createAdminClient()` connect `Auth & Lead Actions` to `SLA Business Hours`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Ad Creative UI Components`, `Community 147`, `Shared Types & Props`, `Agent Performance Shell`, `Notification Categories & Push`, `Agent Performance Metrics`, `Service Interests & Cases`, `Deal Type Definitions`, `Agent Detail & Performance`, `WhatsApp Page Documentation`, `Agent Deals & Cards`, `Lead Sources & Activity`, `Dashboard Widget Data Hooks`, `Community 177`, `Motion & Date Utilities`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Community 65`, `Community 67`, `Community 70`, `Agent Usage & Presence`, `Community 206`, `Notification Bell & Hooks`, `Community 210`, `Error Log Table`, `Community 468`, `Ad Creatives & Campaign Pages`, `Community 471`, `Themes & Notifications`, `Community 94`, `Community 365`, `Community 110`, `Profiles Data Model`, `Community 119`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Lead Edit & Search` to `Call Outcome Charts`, `SLA Business Hours`, `Auth & Lead Actions`, `Community 262`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Page Skeletons & Flags`, `Ad Creative UI Components`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Community 403`, `Community 147`, `Community 276`, `Agent Performance Shell`, `Agent Performance Metrics`, `Community 405`, `Community 409`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Community 160`, `Deal Type Definitions`, `Audio Recorder & Notes`, `Ad Creatives Page Docs`, `Lead Sources & Activity`, `Deals Page Documentation`, `Dashboard Widget Data Hooks`, `Upload & Add Modals`, `Motion & Date Utilities`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Date Range Presets`, `Community 458`, `Community 202`, `Community 203`, `Community 206`, `Community 210`, `Community 468`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 97`, `Community 360`, `Community 123`, `Community 107`, `Community 365`, `Community 110`, `Community 235`, `Tasks Page Docs`, `Community 375`, `Community 251`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `requireProfile()` connect `Themes & Notifications` to `Auth & Lead Actions`, `Community 261`, `Ad Spend & Campaign Mapping`, `Auth Roles & Cache Actions`, `Lead Edit & Search`, `Ad Creative UI Components`, `Agent Performance Metrics`, `Community 276`, `Agent Performance Shell`, `Notification Categories & Push`, `Shared Types & Props`, `Service Interests & Cases`, `Deal Type Definitions`, `WhatsApp Page Documentation`, `Dashboard Widget Data Hooks`, `Community 177`, `Motion & Date Utilities`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Community 206`, `Notification Bell & Hooks`, `Community 210`, `Error Log Table`, `Community 468`, `Community 467`, `Ad Creatives & Campaign Pages`, `Community 471`, `Community 94`, `Community 97`, `Community 235`, `Community 236`, `Community 110`, `Profiles Data Model`, `Community 119`, `Gia Lead Lifecycle Docs`?**
...
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.0028694404591104736 - nodes in this community are weakly interconnected._
