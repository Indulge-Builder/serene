...
## Corpus Check
- 1082 files · ~5,762,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8304 nodes · 16568 edges · 480 communities (445 shown, 35 thin omitted)
...
Cohesion: 0.07
Nodes (30): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, dateSeparatorLabel(), LeadWhatsAppCard() (+22 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.06
Nodes (55): addLeadCallNote(), addLeadNote(), assignLead(), bulkUpdateLeads(), createManualLead(), cancelSlaTimersForLead(), canAccessLead(), leadDisplayName() (+47 more)
...
Cohesion: 0.08
Nodes (23): SubscriptionStatus, ContentProps, getMulti(), getStr(), SubscriptionsPage(), addDaysISO(), cardStyle, dueRow (+15 more)
...
Cohesion: 0.04
Nodes (75): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), SHOP_ENQUIRY_TYPES, REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS (+67 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.13
Nodes (18): AgentDetailAsync(), CallerRole, OversightAgentPage(), isAppDomain(), AppDomainCallerRole, OversightTeamPage(), TeamDetailAsync(), AgentBreakdownGrid() (+10 more)
...
Cohesion: 0.10
Nodes (28): isRateLimited, LEAD_SOURCES_SET, logRawPayload(), POST(), sanitizeRawPayload(), verifyMetaSignature(), parseWebhookPayload(), JsonValue (+20 more)
...
Cohesion: 0.04
Nodes (93): getGroupSubtasksAction(), compareDomainDisplayOrder(), ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, AddDealButton(), NewDealModal, Props, WorkspaceAsync() (+85 more)
...
Cohesion: 0.07
Nodes (46): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), deleteNote() (+38 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.10
Nodes (26): isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, WHATSAPP_API_BASE, WHATSAPP_API_VERSION, WHATSAPP_CONVERSATION_STATUS, WHATSAPP_DIRECTION (+18 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.17
Nodes (12): LeadDossierPage(), LeadDealCardAsync(), Props, LeadTasksAsync(), Props, LeadTasksCardSkeleton(), StatusActionPanel(), getLeadDeal() (+4 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.12
Nodes (24): SubscriptionType, getSpendingOverview(), groupBy(), lastTwelveMonths(), MONTH_NAMES, monthBounds(), SpendingOverviewFilters, SubscriptionFilters (+16 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.13
Nodes (17): goingColdCutoff(), ColdLeadJoinRow, FiredTimerJoinRow, getProfileFullName(), getSlaTimerForLeadAndRule(), getTaskWithAssignee(), getTaskWithGiaContext(), hasLeadActivityAfter() (+9 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.05
Nodes (53): categoriesForRole(), CATEGORY_BY_KEY, NOTIFICATION_CATEGORY_KEYS, NotificationCategory, NotificationCategoryKey, NotificationChannel, usePushSubscription(), _add() (+45 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.09
Nodes (32): armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, describePolicy(), fireSlaBreachHandler(), formatSlaTimestamp(), istDateKey() (+24 more)

### Community 22 - "Notification Categories & Push"
Cohesion: 0.16
Nodes (17): CampaignAdPanel(), CampaignMetricsStripSkeleton(), CampaignDetailPage(), CampaignMetricsAsync(), getCampaignAgentDistribution(), getCampaignDetailMetrics(), CampaignDetailMetrics, AdSpendParseError (+9 more)
...
Cohesion: 0.13
Nodes (18): UsersTable(), PageControls(), NotesManager(), NotesPage(), getMyNotes(), getAllProfiles(), getCurrentProfile, getSuggestionsForInbox() (+10 more)
...
Cohesion: 0.06
Nodes (66): actorFromProfile(), addTaskRemarkAction(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteTaskAction(), getCompletedTasksAction() (+58 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.07
Nodes (25): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, BudgetPage() (+17 more)
...
Cohesion: 0.08
Nodes (44): CampaignFilters(), CampaignFiltersProps, DateRangePreset, DEF, matchDateRangePreset(), mondayOf(), resolveDateRangePreset(), serialize() (+36 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.03
Nodes (90): getAssignableUsersAction(), AddRechargeModal(), fieldLabelStyle, inputStyle, Props, todayIso(), Props, DEAL_CATEGORY_DEF (+82 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.06
Nodes (42): AdCreativeFormModal(), chevronStyle, inputBase, selectBase, actionBtnStyle, CARD_HOVER, actionBtnStyle, AssetCard() (+34 more)
...
Cohesion: 0.07
Nodes (41): DealType, JOURNEY_STATUSES, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, RESOLUTION_STATUSES, Props, DealRow, LeadRow (+33 more)
...
Cohesion: 0.08
Nodes (32): getDomainHealthMetricsAction(), getRoster(), AgentPerformanceAsync(), PerformancePage(), DomainTargetRow, getDomainTargets(), AgentActivityFilter, AgentCallPageItem (+24 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.12
Nodes (17): Props, CurrencyAmount(), DepartmentPills(), DEPT_PILL, PILL_BASE, SubscriptionStatusPill(), TypePill(), ActionType (+9 more)
...
Cohesion: 0.09
Nodes (34): findOwnersInDomain(), getBudget(), getCampaigns(), getColdLeads(), getDomainHealth(), getEscalations(), getGiaTasks(), getGroupTasksFor() (+26 more)
...
Cohesion: 0.08
Nodes (29): anthropicAdapter, LlmChatMessage, LlmCompleteRequest, LlmCompleteResult, LlmProviderAdapter, LlmStopReason, LlmUsage, adapterFor() (+21 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.06
Nodes (48): createUser(), inviteUser(), mapProfileError(), signOutUser(), toggleUserActive(), updateProfile(), updateProfileAvatar(), updateUserAuthorization() (+40 more)
...
Cohesion: 0.07
Nodes (29): maskString(), PiiMaskingDepth, ALL_TOOLS, ElayaReadToolName, ElayaTool, ElayaToolExecution, findTeammate, FOUNDER_UP (+21 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.17
Nodes (17): cancelSlaTimersForLeadInternal(), logSlaScheduleRejections(), refreshActivitySlaTimers(), resolveAgentShift(), scheduleSlaTimersForLead(), getAgentRoutingConfigAdmin(), classifyFirstTouchPairs(), cancelSlaTimersForLeadInDb() (+9 more)
...
Cohesion: 0.07
Nodes (56): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction() (+48 more)
...
Cohesion: 0.08
Nodes (21): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS (+13 more)

### Community 65 - "Community 65"
Cohesion: 0.21
Nodes (18): getManagerRosterAction(), getAgentPulse(), ManagerPerformanceAsync(), Props, getAgentRosterPerformance(), getAgentTodayPulse(), getAgentTodayPulseForUser(), getPeriodDateRange() (+10 more)
...
Cohesion: 0.14
Nodes (26): BridgeBody, POST(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction(), runElayaTurn(), AFFIRMATIVE_PHRASES, AFFIRMATIVE_TOKENS (+18 more)
...
Cohesion: 0.16
Nodes (16): SCHEMA_ERROR_COPY, transcribeAudioAction(), CustomerTurnInput, resolveCustomerPrincipal(), handleCustomerReply(), mediaTypeForKind(), recordBotMessage(), resolveInboundText() (+8 more)
...
Cohesion: 0.35
Nodes (13): formatIstNow(), IST_MONTHS, IST_WEEKDAYS, istToUtc(), normalizeDueAtToIstInstant(), toIst(), advanceToNextBusinessStart(), businessMinutesBetween() (+5 more)
...
Cohesion: 0.12
Nodes (13): LEAD_STATUS_BADGE, EscalatedLeadsSection(), GoingColdSection(), OverdueTasksSection(), RECIPIENT_META, secondaryCell, tertiaryCell, EscalationsPage() (+5 more)
...
Cohesion: 0.08
Nodes (38): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+30 more)
...
Cohesion: 0.09
Nodes (38): requireProfile(), addSubscriptionPaymentAction(), addSubscriptionTopupAction(), archiveSubscriptionAction(), canManageSubscriptions(), createSubscriptionAction(), getSubscriptionDetailAction(), getSubscriptionMonthlyReportAction() (+30 more)

### Community 93 - "Revival Service & Policies"
Cohesion: 0.07
Nodes (31): PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), FilterChip(), MobileSegmented(), MobileStepper(), MobileToggle() (+23 more)

### Community 94 - "Community 94"
Cohesion: 0.04
Nodes (74): AgentSelfMetrics, getAgentPulseAction(), AccountReportSection(), AdSpendUploadModal(), Props, BudgetEmptyState(), BudgetSectionHeader(), SectionHeaderDatum() (+66 more)
...
Cohesion: 0.20
Nodes (6): CardHeader(), Props, DynamicFormResponses(), Props, LeadNotesInput(), Props
...
Cohesion: 0.05
Nodes (78): EASE_IN_EXPO, EASE_IN_OUT, EASE_OUT_EXPO, FADE_VARIANTS, MODAL_VARIANTS, SPRING_CONFIG, useDebounce(), LeadDealCard() (+70 more)
...
Cohesion: 0.07
Nodes (41): assertLeadFieldEditAccess(), BulkUpdateResult, exportLeadsAction(), ExportPayload, LeadEditContext, recordDeal(), revalidateLeadDossier(), updateLeadCity() (+33 more)
...
Cohesion: 0.12
Nodes (27): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), metadata, MobileBudgetPage() (+19 more)
...
Cohesion: 0.09
Nodes (20): ClientAppLayout(), DOMAIN_ICONS, ADMIN_ROOMS, DOMAIN_PASTEL_TOKENS, DOMAIN_VERTICALS, DomainVertical, getMobileRooms(), MOBILE_ROOMS_BY_ROLE (+12 more)
...
Cohesion: 0.06
Nodes (48): BarChart(), BarChartProps, BarChartSeries, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens (+40 more)
...
Cohesion: 0.12
Nodes (21): collectMedia(), CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), buildElayaTimeContext(), CustomerPrincipal, ElayaPersona (+13 more)
...
Cohesion: 0.08
Nodes (33): createSlaPolicyAction(), generateUserPolicyCode(), RESERVED_CODE_PREFIXES, updateSlaPolicyAction(), LEAD_STATUSES, isCadenceCode(), createSlaPolicy(), updateSlaPolicy() (+25 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (28): ELAYA_STARTER_PROMPTS, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), ElayaChatShell(), Props, CAPABILITIES (+20 more)
...
Cohesion: 0.08
Nodes (24): useLeadColumnPreferences(), CampaignLeadsAsync(), ExportButton(), ExportButtonProps, ExportModal(), LeadsPagination(), LeadsPaginationProps, BulkEditLeadsModal (+16 more)
...
Cohesion: 0.13
Nodes (26): DOMAIN_ICONS, GIA_DOMAIN_ICONS, GiaDomain, DomainFetchResult, useDomainRoomData(), ProgressCard(), DomainSwiper(), EVENT_PRESENTATION (+18 more)

### Community 177 - "Community 177"
Cohesion: 0.19
Nodes (10): NewUserClient(), EASE_OUT_SOFT, FollowUpEnginePage(), metadata, NewUserPage(), getAllSlaPolicies(), SettingsPage(), BackButton() (+2 more)
...
Cohesion: 0.07
Nodes (31): chevronStyle, EditAuthorizationForm(), initialState, labelStyle, Props, selectStyle, EditProfileForm(), FieldProps (+23 more)
...
Cohesion: 0.06
Nodes (41): getAgentTasksSummaryAction(), getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), APP_DOMAIN_ENUM, DASHBOARD_PIPELINE_ROLES (+33 more)
...
Cohesion: 0.04
Nodes (90): getTaskRemarksAction(), ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, TASK_STATUS_DEF (+82 more)
...
Cohesion: 0.16
Nodes (15): getAgentUsageAction(), recordPresenceAction(), HeartbeatInsert, insertUsageHeartbeats(), istDateString(), LivePresence, pruneOldHeartbeats(), recordPresence() (+7 more)
...
Cohesion: 0.17
Nodes (16): AgentTaskRpcRow, BreakdownRpcRow, CLOSED_STATUSES, deriveMetrics(), emptyMetrics(), getAgentTasksOversight(), OPEN_STATUSES, OverviewRpcRow (+8 more)

### Community 235 - "Community 235"
Cohesion: 0.12
Nodes (9): chip, Detail, iconBtn, Props, rowMain, rowNote, rowStyle, rowSub (+1 more)
...
Cohesion: 0.10
Nodes (25): COLUMNS, labelForStoredAccount(), RechargeHistoryTable(), AccountKeyOrUnattributed, accountLabel(), AD_ACCOUNT_KEY_VALUES, AD_ACCOUNT_KEYS, AD_ACCOUNT_MAP (+17 more)
...
Cohesion: 0.06
Nodes (38): FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal(), AgentDetailPanel(), CallOutcomeBar (+30 more)
...
Cohesion: 0.07
Nodes (37): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), getElayaChatSeedAction(), updateElayaPersonaAction(), ADMIN_ROLES, createRechargeAction(), CreateRechargeResult (+29 more)
...
Cohesion: 0.24
Nodes (8): DashboardLayout(), ElayaWidget(), AppBootScreen(), IconInitializer(), ThemeInitializer(), INTERACTION_EVENTS, UsagePresence(), canAccessRoute()
...
Cohesion: 0.14
Nodes (15): EMPTY, PaletteDealHit, PaletteLeadHit, paletteSearchAction(), PaletteSearchResult, PaletteTaskHit, getPersonalTasksAction(), metadata (+7 more)
...
Cohesion: 0.15
Nodes (15): DASHBOARD_WIDGETS, DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), AddWidgetMenu(), PortalAnchorPosition, usePortalAnchor(), UsePortalAnchorOptions, AddEditSubscriptionModal (+7 more)
...
Cohesion: 0.38
Nodes (5): OversightSkeleton(), OversightPage(), TeamOverviewAsync(), TeamOverviewGrid(), getTeamTaskOverview()
...
Cohesion: 0.11
Nodes (24): CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton(), CampaignsPage(), parseFilters(), parseGiaDomainParam(), DealsAsync(), DealsAsyncProps (+16 more)
...
Cohesion: 0.05
Nodes (59): createLeadTaskAction(), updatePersonalDetails(), setNotificationPrefAction(), getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), deleteGroupTaskAction(), ConversationIdSchema (+51 more)
...
Cohesion: 0.14
Nodes (13): Props, AgentLeadsPredicateDrillModal(), DrillPredicate, Props, Props, DomainDrillKind, DomainLeadsDrillModal(), KIND_LABEL (+5 more)
...
Cohesion: 0.06
Nodes (48): SPRING_BOUNCE, DashboardDateFilter(), DashboardDateFilterProps, PRESETS, ElayaFeedbackCard(), MQ, useMediaQuery(), UseNotificationsReturn (+40 more)

## Knowledge Gaps
- **4390 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4385 more)
...
- **Why does `createAdminClient()` connect `Ad Spend & Campaign Mapping` to `Auth & Lead Actions`, `SLA Business Hours`, `Community 133`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Dashboard Data Actions`, `Community 402`, `Agent Performance Metrics`, `Agent Performance Shell`, `Community 405`, `Notification Categories & Push`, `Service Interests & Cases`, `Campaign & Domain Filters`, `Agent Detail & Performance`, `Elaya Actions Service`, `Agent Deals & Cards`, `Community 300`, `Deals Page Documentation`, `Upload & Add Modals`, `Motion & Date Utilities`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Agent Usage & Presence`, `Community 206`, `Community 464`, `Community 213`, `Ad Creatives & Campaign Pages`, `Themes & Notifications`, `Community 228`, `Community 234`, `Community 365`, `Community 110`, `Tasks Page Docs`, `Task Flow Sequences`, `Community 375`, `Community 251`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `getCurrentProfile` connect `Service Interests & Cases` to `Task Actions & Mutations`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Ad Creative UI Components`, `Budget & Spend UI`, `Community 402`, `Shared Types & Props`, `Community 405`, `Notification Categories & Push`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Agent Detail & Performance`, `Agent Deals & Cards`, `Community 300`, `Dashboard Widget Data Hooks`, `Community 177`, `Motion & Date Utilities`, `Performance Scorecards & Drills`, `Community 70`, `Community 202`, `Community 460`, `Community 206`, `Community 464`, `Community 81`, `Community 467`, `Community 213`, `Themes & Notifications`, `Community 369`, `Tasks Page Docs`, `Community 375`, `Community 123`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Lead Edit & Search` to `Call Outcome Charts`, `SLA Business Hours`, `Auth & Lead Actions`, `Task Actions & Mutations`, `Community 262`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Dashboard Data Actions`, `Community 402`, `Community 147`, `Community 276`, `Community 405`, `Agent Performance Metrics`, `Task Summary & SLA Policies`, `Community 409`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Community 160`, `Deal Type Definitions`, `Chart Components`, `Elaya Actions Service`, `Agent Deals & Cards`, `Lead Sources & Activity`, `Community 300`, `Deals Page Documentation`, `Community 176`, `Motion & Date Utilities`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Community 65`, `Community 202`, `Community 206`, `Community 81`, `Community 210`, `Community 213`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 94`, `Community 479`, `Community 234`, `Community 107`, `Community 110`, `Community 370`, `Tasks Page Docs`, `Community 123`?**
