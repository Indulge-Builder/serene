# Graph Report - serene  (2026-09-12)

## Corpus Check
- 1130 files · ~5,838,046 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8690 nodes · 17514 edges · 510 communities (472 shown, 38 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 139 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7b1ae776`
...
1. `Serene — Changelog` - 762 edges
2. `createAdminClient()` - 265 edges
3. `Serene — Design DNA` - 160 edges
4. `requireProfile()` - 153 edges
5. `AppDomain` - 130 edges
6. `createClient()` - 124 edges
7. `getCurrentProfile` - 98 edges
8. `formatDate()` - 81 edges
9. `UserRole` - 73 edges
10. `EASE_OUT_EXPO` - 69 edges
...
Cohesion: 0.09
Nodes (32): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), recordDeal(), updateLeadStatus(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF (+24 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.11
Nodes (27): findOwnersInDomain(), getBudget(), getCampaigns(), getColdLeads(), getDomainHealth(), getEscalations(), getGiaTasks(), getGroupTasksFor() (+19 more)
...
Cohesion: 0.10
Nodes (35): POST(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction(), runElayaTurn(), getLeadNotes(), maybeUpdateLearnedMemory(), summarizeLearnedMemory() (+27 more)
...
Cohesion: 0.17
Nodes (22): SIA_ALERT_TIER1_PROFILE_IDS, filterRecipientsByPref(), isChannelEnabled(), assertGupshupConfigured(), isGupshupDelivered(), logNotification(), NotificationLogEntry, sendCustomerWelcomeTemplate() (+14 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.09
Nodes (31): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, brainBaseUrl(), isPythonBrainConfigured(), openPythonBrainStream() (+23 more)
...
Cohesion: 0.06
Nodes (72): useCreateTriggerModal(), WorkspaceAsyncProps, Props, Props, Props, CompletedTaskCursor, CompletedTaskRaw, CompletedTaskRow (+64 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.07
Nodes (41): CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), LeadSource, selectAdapter(), isRateLimited, LEAD_SOURCES_SET, logRawPayload(), POST() (+33 more)
...
Cohesion: 0.06
Nodes (84): actorFromProfile(), requireProfile(), deleteTrainingAsset(), upsertTrainingAsset(), paletteSearchAction(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction() (+76 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.13
Nodes (24): getConversationsAction(), getMessagesAction(), searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, getUnreadCount() (+16 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.19
Nodes (12): isNotificationCategoryKey(), DEFAULT_ON, getMyNotificationPrefs(), getNotificationPrefs, resolveChannels(), ResolvedChannels, CreateNotificationPayload, dispatchPush() (+4 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.04
Nodes (67): AdSpendUploadModal(), BudgetWorkspace(), AgentDistributionBar(), AgentDistributionBarProps, SEGMENT_COLORS, CampaignCard(), CampaignCardProps, DOT_COLOR (+59 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.09
Nodes (29): ElayaTrainingManager(), NewUserClient(), EASE_OUT_SOFT, ElayaTrainingPage(), FollowUpEnginePage(), metadata, LeadRevivalPage(), metadata (+21 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.06
Nodes (33): categoriesForRole(), CATEGORY_BY_KEY, NOTIFICATION_CATEGORY_KEYS, NotificationCategory, NotificationCategoryKey, NotificationChannel, CreateLeadTaskModal, TERMINAL (+25 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.09
Nodes (45): ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, describePolicy(), fireSlaBreachHandler(), formatSlaTimestamp(), istDateKey(), logSlaActivity() (+37 more)
...
Cohesion: 0.06
Nodes (48): actionBtnStyle, CARD_HOVER, actionBtnStyle, AssetCard(), CARD_HOVER, KIND_ICON, safeHost(), chevronStyle (+40 more)
...
Cohesion: 0.06
Nodes (46): deleteGroupTaskAction(), getCompletedTasksAction(), getGroupSubtasksAction(), getPersonalTasksAction(), getPersonalTaskTagsAction(), updateChecklistAction(), updateTaskAction(), updateTaskStatusAction() (+38 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.09
Nodes (18): AgentPerformanceShell(), FounderPerfActionsContext, FounderPerfActionsContextValue, FounderPerfActionsProvider(), DomainOverviewPanel, FounderPerformanceShell(), Props, Tab (+10 more)
...
Cohesion: 0.05
Nodes (47): getAssignableUsersAction(), CampaignFiltersProps, ALL_DOMAINS_ICON, APP_DOMAINS, DOMAIN_ICONS, GIA_DOMAIN_FILTER_ITEMS, parseGiaDomainParam(), readDomainCookie() (+39 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.16
Nodes (7): COL_WIDTHS, LeadsTableSkeleton(), FilterBarSkeletonProps, PageHeaderSkeletonProps, ShimmerProps, SkeletonCardProps, VendorsTableSkeleton()

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.19
Nodes (13): ElayaTrainingManagerProps, chevronStyle, inputBase, selectBase, TrainingAssetFormModal(), TrainingAssetFormModalProps, TRAINING_ASSET_KIND_DEF, TRAINING_BUCKET (+5 more)
...
Cohesion: 0.15
Nodes (29): ELAYA_DAILY_LINES, getElayaTimeGreeting(), pickElayaDailyLine(), metadata, MobileElayaPage(), resolveStaffPrincipal(), ElayaChatScreen(), countUserMessagesToday() (+21 more)
...
Cohesion: 0.14
Nodes (17): ELAYA_STARTER_PROMPTS, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), Props, CAPABILITIES, ElayaIdentityCard() (+9 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.07
Nodes (30): DealType, MODAL_VARIANTS, CardBody(), cardStyle, DealCard(), DealCardProps, SourcePill(), useWonCelebration() (+22 more)
...
Cohesion: 0.05
Nodes (53): PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_DEPARTMENT_OPTIONS, SUBSCRIPTION_STATUS_CONFIG, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionCurrency (+45 more)
...
Cohesion: 0.09
Nodes (37): getAgentPulse(), getRoster(), AgentPerformanceAsync(), AgentActivityFilter, AgentCallPageItem, AgentCallsPage, AgentCoreJson, AgentRosterRpcRow (+29 more)
...
Cohesion: 0.11
Nodes (22): collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), CustomerPrincipal, ElayaPersona (+14 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.04
Nodes (67): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, createUser(), inviteUser(), mapProfileError(), signOutUser(), toggleUserActive() (+59 more)
...
Cohesion: 0.13
Nodes (6): ElayaLoading(), FilterBarSkeleton(), PageHeaderSkeleton(), Shimmer(), SkeletonCard(), skeletonStagger()
...
Cohesion: 0.05
Nodes (93): addLeadCallNote(), assignLead(), bulkUpdateLeads(), createManualLead(), armCadenceForOutcome(), cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), logSlaScheduleRejections() (+85 more)
...
Cohesion: 0.07
Nodes (55): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction() (+47 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.09
Nodes (27): anthropicAdapter, LlmChatMessage, LlmCompleteRequest, LlmCompleteResult, LlmProviderAdapter, LlmStopReason, LlmUsage, adapterFor() (+19 more)
...
Cohesion: 0.08
Nodes (20): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), LEAD_SOURCE_DEF, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS, SHOP_ENQUIRY_TYPES (+12 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (29): createSlaPolicyAction(), generateUserPolicyCode(), RESERVED_CODE_PREFIXES, updateSlaPolicyAction(), goingColdCutoff(), isCadenceCode(), ColdLeadJoinRow, createSlaPolicy() (+21 more)
...
Cohesion: 0.18
Nodes (11): UsersTable(), ElayaChatShell(), ElayaPage(), PageControls(), PageControlsProps, OversightPage(), TeamOverviewAsync(), TeamOverviewGrid() (+3 more)
...
Cohesion: 0.04
Nodes (111): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+103 more)
...
Cohesion: 0.32
Nodes (6): LeadNotesSection(), OUTCOME_BADGE, Props, LeadNotesSectionAsync(), Props, getLeadNotesFull()
...
Cohesion: 0.09
Nodes (30): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_TRIGGER_STATUSES (+22 more)
...
Cohesion: 0.06
Nodes (44): deleteNote(), upsertNote(), getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), addLeadNote() (+36 more)
...
Cohesion: 0.07
Nodes (43): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+35 more)
...
Cohesion: 0.13
Nodes (17): PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), DEMO_CHAT, DEMO_CHAT_SUGGESTIONS, DEMO_REQUESTS, DEMO_VERTICALS (+9 more)
...
Cohesion: 0.09
Nodes (27): CapabilityStance, EngagementOutcome, VendorCategorySource, VendorSource, parseIntent(), readVendorRequest(), VendorSearchIntent, AdminClient (+19 more)
...
Cohesion: 0.07
Nodes (42): assertLeadFieldEditAccess(), BulkUpdateResult, exportLeadsAction(), ExportPayload, LeadEditContext, revalidateLeadDossier(), updateLeadCity(), updateLeadDomain() (+34 more)
...
Cohesion: 0.07
Nodes (47): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), metadata, MobileActivityPage() (+39 more)

### Community 117 - "Task Flow Sequences"
Cohesion: 0.09
Nodes (19): getRequestCategoryLabel(), getServiceLabel(), titleCase(), FindVendorPage(), getVendorCities(), RankedVendor, AMBIGUOUS_CITIES, CATEGORY_WORDS (+11 more)

### Community 118 - "Profiles Data Model"
Cohesion: 0.13
Nodes (12): LeadDossierPage(), DynamicFormResponses(), Props, LeadTasksAsync(), Props, LeadTasksCardSkeleton(), RevivalDossierAction(), ReviveLeadButton() (+4 more)
...
Cohesion: 0.22
Nodes (8): MetaApiResponse, MetaContact, MetaStatusUpdate, MetaWebhookChange, MetaWebhookEntry, MetaWebhookValue, SendMessageInput, TemplateComponent
...
Cohesion: 0.07
Nodes (35): CALL_OUTCOME_DEF, JOURNEY_STATUSES, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, LEAD_STATUSES, RESOLUTION_STATUSES, LeadsFiltersProps, OUTCOME_ITEMS (+27 more)
...
Cohesion: 0.06
Nodes (49): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignAdPanel(), CampaignMetricsStripSkeleton(), buildLeadListKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS (+41 more)
...
Cohesion: 0.14
Nodes (22): getVendor(), rankVendors(), VendorPage(), fmt(), host, line(), main(), emptyScoreInputs() (+14 more)
...
Cohesion: 0.10
Nodes (34): GiaDomain, persistDomainCookie(), DomainFetchResult, useDomainRoomData(), DetailAppBar(), GreetingBlock(), HomeAppBar(), IconKnob() (+26 more)

### Community 177 - "Community 177"
Cohesion: 0.14
Nodes (12): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, ActiveModal, ButtonVariant, JUNK_REASON_ITEMS, LOST_REASON_ITEMS, microLabelStyle (+4 more)
...
Cohesion: 0.06
Nodes (37): TASK_CATEGORY, WidgetProps, useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher, useWidgetDensityTier(), DashboardAgentStatusBreakdown (+29 more)

### Community 204 - "Community 204"
Cohesion: 0.20
Nodes (11): generateMetadata(), generateViewport(), inter, playfairDisplay, RootLayout(), isAppearanceKey(), isThemeKey(), DashboardLayout() (+3 more)
...
Cohesion: 0.05
Nodes (44): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, TRAINING_ROLES, updateElayaPersonaAction() (+36 more)
...
Cohesion: 0.03
Nodes (99): getTaskRemarksAction(), GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, TASK_STATUS_DEF, TASK_TYPE_DEF (+91 more)
...
Cohesion: 0.13
Nodes (19): getAgentUsageAction(), recordPresenceAction(), INTERACTION_EVENTS, UsagePresence(), getAgentUsage(), HeartbeatInsert, insertUsageHeartbeats(), istDateString() (+11 more)
...
Cohesion: 0.11
Nodes (17): countVendors(), getVendorScoreInputs(), listVendors(), VendorListFilters, VendorListItem, Pagination(), PaginationProps, AddVendorButton() (+9 more)
...
Cohesion: 0.09
Nodes (16): INVOICE_ACCEPT_MIME, attachedStyle, InvoiceFieldProps, InvoiceLink(), triggerStyle, chip, Detail, iconBtn (+8 more)
...
Cohesion: 0.09
Nodes (33): AccountReportSection(), BudgetSectionHeader(), SectionHeaderDatum(), BudgetTable(), BudgetTableRow, COLUMNS, Props, COLUMNS (+25 more)
...
Cohesion: 0.11
Nodes (19): dateSeparatorLabel(), LeadWhatsAppCardProps, ProfileAvatarSection(), Props, createClient(), WhatsAppMessage, MessageBar, MessageBarProps (+11 more)
...
Cohesion: 0.11
Nodes (19): CAPABILITY_STANCE_DEF, ENGAGEMENT_OUTCOME_DEF, PREFERENCE_STANCE_DEF, REQUEST_CATEGORY_DEF, RequestCategory, ScoreComponent, SERVICES_BY_REQUEST_CATEGORY, VENDOR_CATEGORY_DEF (+11 more)

### Community 262 - "Community 262"
Cohesion: 0.10
Nodes (22): AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, Props, useMountOnFirstOpen(), AddSuggestionButton(), AddSuggestionModal (+14 more)
...
Cohesion: 0.05
Nodes (42): FIRST_TOUCH_BUCKETS, FirstTouchBucket, FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal(), AgentDetailPanel(), CallOutcomeBar, DetailSlice (+34 more)
...
Cohesion: 0.38
Nodes (4): ElayaWidget(), AppBootScreen(), IconInitializer(), Props

### Community 370 - "Community 370"
Cohesion: 0.13
Nodes (13): PaletteSearchResult, ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, ACTION_ITEMS, CommandPalette(), CommandPaletteProps, EMPTY_RESULTS, GOTO_PAGES (+5 more)
...
Cohesion: 0.20
Nodes (11): CampaignFilters(), CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton(), CampaignsPage(), parseFilters(), EscalationsPage(), CampaignFilters (+3 more)
...
Cohesion: 0.13
Nodes (20): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, ExportButtonProps, MonthlyReportRow, currentMonthIso(), FORMAT_TABS (+12 more)

### Community 405 - "Community 405"
Cohesion: 0.16
Nodes (15): AddDealButton(), NewDealModal, Props, DealsAsync(), DealsAsyncProps, DealsSkeleton(), DealsPage(), parseFilters() (+7 more)
...
Cohesion: 0.11
Nodes (24): getServiceCategoryLabel(), CaseCard(), CaseCardProps, CaseListRow(), CaseListRowProps, CATEGORY_ICONS, getCategoryIcon(), CategoryPill() (+16 more)
...
Cohesion: 0.10
Nodes (24): buildPersonaPromptBlock(), DEPTH_DEF, ELAYA_DEPTH_PROMPT, ELAYA_LANGUAGE_PROMPT, ELAYA_LENGTH_PROMPT, ELAYA_PERSONA_DEFAULTS, ELAYA_TONE_PROMPT, ElayaDepthPref (+16 more)
...
Cohesion: 0.08
Nodes (24): loginSchema, RequireProfileResult, getAgentTasksSummaryAction(), BridgeBody, getAgentTasksSummary(), MutationActor, WRITE_TOOL_REGISTRY, Profile (+16 more)
...
Cohesion: 0.21
Nodes (11): getElayaChatSeedAction(), ElayaFeedbackCard(), ElayaChatShell, EmbeddedElayaChat(), loadElayaChatShell(), Props, ElayaChatSeed, useSuggestionFeedback() (+3 more)
...
Cohesion: 0.10
Nodes (20): getDomainHealthMetricsAction(), DOMAIN_LINE_COLORS, DOMAIN_ICONS, getDomainIcon(), GIA_DOMAIN_ICONS, DOMAIN_LABELS, DomainDealsDrillModal(), DomainDrillKind (+12 more)

### Community 480 - "Community 480"
Cohesion: 0.12
Nodes (25): getPasswordReveals(), getSpendingOverview(), getSubscriptionDetail(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES (+17 more)
...
Cohesion: 0.21
Nodes (13): ConversationIdSchema, markConversationAsRead(), SendMessageSchema, sendWhatsAppMediaMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType(), signMediaPath(), markConversationRead() (+5 more)
...
Cohesion: 0.22
Nodes (12): Props, CampaignDetailPage(), AdSpendParseError, AdSpendUploadRow, ParsedAdSpend, parseMetaSpendFile(), REQUIRED_HEADERS, sumNullable() (+4 more)
...
Cohesion: 0.04
Nodes (66): compareDomainDisplayOrder(), DROPDOWN_VARIANTS, DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), getVendorCategoryLabel(), AddWidgetMenu(), DashboardDateFilter(), PRESETS (+58 more)

### Community 491 - "Community 491"
Cohesion: 0.18
Nodes (9): PreferenceStance, REVIEW_DIMENSION_LABELS, VendorAgentPreferenceWithAgent, VendorDetail, StarRating(), STANCE_STYLE, VendorPreferenceControl(), VendorScoreCard() (+1 more)

### Community 492 - "Community 492"
Cohesion: 0.11
Nodes (18): CardHeader(), Props, LeadActivitiesAsync(), Props, formatTimestamp(), LeadActivityLog(), Props, buildStatusTimestamps() (+10 more)

### Community 493 - "Community 493"
Cohesion: 0.29
Nodes (12): REVIEW_DIMENSIONS, ReviewDimension, SCORE_WEIGHTS, clamp01(), computeVendorScore(), plural(), recencySignal(), reviewAverages() (+4 more)

### Community 494 - "Community 494"
Cohesion: 0.23
Nodes (9): CondensingPageHeader(), CondensingPageHeaderProps, AddTaskButton(), AddTaskButtonProps, TasksPage(), TasksCreateContext, TasksCreateContextValue, TasksCreateProvider() (+1 more)
...
Cohesion: 0.26
Nodes (9): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, BudgetPage() (+1 more)
...
Cohesion: 0.25
Nodes (8): getShopEnquiryTypeLabel(), EnquiryRow(), formatPrice(), ProductEnquiryCard(), Props, ProductEnquiryCardAsync(), getLeadProductEnquiries(), LeadProductEnquiry
...
Cohesion: 0.33
Nodes (5): Dialog(), DialogProps, MAX_WIDTH, lockBodyScroll(), scrollToBottom()
...
## Knowledge Gaps
- **4534 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4529 more)
...
- **Why does `createAdminClient()` connect `Escalations & SLA Service` to `Auth & Lead Actions`, `Task Constants & UI`, `Ad Spend & Campaign Mapping`, `Auth Roles & Cache Actions`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Page Skeletons & Flags`, `Dashboard Data Actions`, `Budget & Spend UI`, `Community 147`, `Agent Performance Metrics`, `Agent Performance Shell`, `Community 405`, `Campaign & Domain Filters`, `Community 160`, `Audio Recorder & Notes`, `Agent Detail & Performance`, `Deals Page Documentation`, `Community 176`, `Upload & Add Modals`, `Motion & Date Utilities`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Community 65`, `Community 67`, `Community 68`, `Community 70`, `Community 206`, `Notification Bell & Hooks`, `Community 81`, `Community 467`, `Community 213`, `Ad Creatives & Campaign Pages`, `Themes & Notifications`, `Community 97`, `Community 484`, `Community 228`, `Community 488`, `Community 234`, `Community 110`, `Tasks Page Docs`, `Community 251`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Serene — Changelog` connect `Changelog Entries` to `Group Task Security Fix`, `OS Tasks Schema Migration`, `Deals Table Promotion`, `Tasks Page Fixes`, `Leads Server-Side Search Pagination`, `Toast & Notification Inbox System`, `Tech Debt Register`, `Trigger.dev Reminder Race Condition`, `Task System DB Optimization`, `Community 290`, `Phase 0 Foundation`, `Phase 1 Profiles & Users`, `Phase 2 User Management`, `Phase 3 Lead Ingestion`, `Phase 4 Lead Dossier`, `Phase 5 Profile & Themes`, `Phase 6 Modal Primitives`, `Task Groups RLS Security Fix`, `Task Messages RLS Security Fix`, `Task Action Security Fix`, `Lead List & Dashboard Auto-Poll`, `Webhook WhatsApp Notification Fix`, `Parallel Founder Notification Fix`, `Leads Table Column Picker`, `Tasks Service & Action Layer`, `Ad Spend & Budget Foundation`, `Community 474`, `Community 478`, `Community 227`, `Lead Phase Hardening`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Lead Edit & Search` to `Call Outcome Charts`, `Auth & Lead Actions`, `Task Constants & UI`, `Community 133`, `Community 262`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Page Skeletons & Flags`, `Task Summary & SLA Policies`, `Community 147`, `Community 276`, `Community 405`, `Community 409`, `Service Interests & Cases`, `Settings Page Documentation`, `Chart Components`, `Elaya Actions Service`, `Agent Deals & Cards`, `Deals Page Documentation`, `Community 176`, `Upload & Add Modals`, `Motion & Date Utilities`, `Community 177`, `Escalations & SLA Service`, `Performance Scorecards & Drills`, `Date Range Presets`, `Community 65`, `Community 68`, `Community 458`, `Community 81`, `Community 210`, `Community 467`, `Community 213`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 479`, `Community 480`, `Community 234`, `Community 490`, `Community 492`, `Community 110`, `Community 496`, `Community 370`, `Tasks Page Docs`, `Community 373`, `Community 504`, `Community 123`?**
