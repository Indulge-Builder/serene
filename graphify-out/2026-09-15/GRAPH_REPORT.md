# Graph Report - serene  (2026-09-15)

## Corpus Check
- 1241 files · ~5,959,237 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9622 nodes · 20513 edges · 540 communities (496 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 164 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a9aa35b4`
...
- `adaptWebsite()` --calls--> `pick()`  [INFERRED]
  src/lib/leads/adapters.ts → scripts/seed-vendors-demo.ts
- `parseIntent()` --calls--> `pick()`  [INFERRED]
  src/lib/services/vendor-search-intent.ts → scripts/seed-vendors-demo.ts
...
Cohesion: 0.06
Nodes (57): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+49 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.08
Nodes (44): BridgeBody, POST(), buildPersonaPromptBlock(), canAccessLead(), statusLabel(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction() (+36 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.06
Nodes (48): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), recordDeal(), updateLeadStatus(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF (+40 more)
...
Cohesion: 0.09
Nodes (26): FACT_POLARITIES, FactPolarity, RELATION_KINDS, getLeadNotes(), maskPii(), maskString(), main(), TestLead (+18 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.08
Nodes (45): initiateWhatsAppConversationAction(), isNotificationCategoryKey(), SIA_ALERT_TIER1_PROFILE_IDS, resolveCustomerPrincipal(), handleCustomerReply(), maybeSendCustomerWelcome(), mediaTypeForKind(), recordBotMessage() (+37 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.39
Nodes (6): isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, periodOptionRow(), WhatsAppConversationPeriodFilter()

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.08
Nodes (39): FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), isRateLimited, LEAD_SOURCES_SET, logRawPayload(), POST() (+31 more)
...
Cohesion: 0.11
Nodes (32): getPersonalTaskTagsAction(), AddDealButton(), NewDealModal, Props, getGiaTasks(), WorkspaceAsyncProps, Props, Props (+24 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.14
Nodes (17): ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, getExistingSpendKeys(), AdSpendParseError, AdSpendUploadRow, ParsedAdSpend, parseMetaSpendFile() (+9 more)
...
Cohesion: 0.06
Nodes (72): BTN, TicketBoardPage(), AddClientButton(), ClientsTable(), ClientsAsync(), ClientsPage(), parseFilters(), ClientTier (+64 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.05
Nodes (66): addTaskRemarkAction(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteGroupTaskAction(), deleteTaskAction(), getPersonalTasksAction() (+58 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.07
Nodes (39): CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), selectAdapter(), RecordEnquiryResult, recordProductEnquiry(), createLeadFromWhatsApp(), EnquiryOutcome, extractServiceInterests() (+31 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.04
Nodes (60): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, refreshBooksOverviewAction(), refreshClientFinanceAction() (+52 more)
...
Cohesion: 0.06
Nodes (30): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, cardStyle, DealCard(), DealCardProps, useWonCelebration(), DealsAsync() (+22 more)
...
Cohesion: 0.11
Nodes (25): AddRechargeModal(), fieldLabelStyle, inputStyle, Props, todayIso(), COLUMNS, labelForStoredAccount(), RechargeHistoryTable() (+17 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.10
Nodes (33): CampaignFilters(), CampaignFiltersProps, ClientsFilters(), HEALTH_ITEMS, UNLINKED_ITEMS, GIA_DOMAIN_FILTER_ITEMS, SUBSCRIPTION_DEPARTMENT_OPTIONS, CATEGORY_DOMAIN (+25 more)
...
Cohesion: 0.06
Nodes (33): ElayaActionPayload, ElayaActionTarget, ElayaActionType, ElayaLeadTarget, ElayaTaskTarget, ElayaTicketTarget, insertExecutedAction(), insertProposedAction() (+25 more)
...
Cohesion: 0.04
Nodes (79): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTableProps, AdCreativeFormModal, APP_DOMAINS, EASE_IN_EXPO (+71 more)
...
Cohesion: 0.11
Nodes (39): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, resolveStaffPrincipal(), brainBaseUrl(), isPythonBrainConfigured() (+31 more)
...
Cohesion: 0.10
Nodes (25): ELAYA_STARTER_PROMPTS, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), ElayaChatShell(), Props, CAPABILITIES (+17 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.21
Nodes (12): metadata, MobileActivityPage(), metadata, MobileBudgetPage(), getMobileDomains(), ActivityRoom(), getActivityFeed(), getMobileBudgetData() (+4 more)
...
Cohesion: 0.06
Nodes (39): BarChartSeries, useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher, BudgetGaugeSummary, LeadVolumeSummary, MultiDomainVolumeSummary (+31 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.08
Nodes (22): getAgentTasksSummaryAction(), useWidgetDensityTier(), BenchmarkLine, CardConfig, computeDelta(), CoreFourGrid(), formatPct(), makeBenchmarkLine() (+14 more)
...
Cohesion: 0.08
Nodes (36): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+28 more)
...
Cohesion: 0.22
Nodes (12): CALLS, main(), MEDIA, MINUTES, POLL, pollLoop(), sleep(), THREADS_ONLY (+4 more)
...
Cohesion: 0.14
Nodes (3): BooksSkeleton(), PageHeaderSkeleton(), SkeletonCard()
...
Cohesion: 0.15
Nodes (13): getRequestCategoryLabel(), getServiceLabel(), titleCase(), getVendorCities(), FindVendorPanel(), AMBIGUOUS_CITIES, CATEGORY_WORDS, host (+5 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.08
Nodes (33): CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, EngagementOutcome, PREFERENCE_STANCE_DEF, PreferenceStance, REQUEST_CATEGORY_DEF, REVIEW_DIMENSION_LABELS (+25 more)
...
Cohesion: 0.11
Nodes (35): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction(), getLeadVolumeForDomainAction() (+27 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.08
Nodes (49): getDomainHealthMetricsAction(), getManagerRosterAction(), getRoster(), parseFilters(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync(), PerformancePage() (+41 more)
...
Cohesion: 0.04
Nodes (71): buildLeadListKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS, REDIS_TTL, SIA_ALERT_KINDS, ROUTING_POOL_ROLES, findOwnersInDomain(), findTeammates() (+63 more)

### Community 65 - "Community 65"
Cohesion: 0.10
Nodes (18): LeadDossierPage(), DynamicFormResponses(), Props, LeadDealCardAsync(), Props, LeadNotesInput(), LeadNotesSection(), LeadNotesSectionAsync() (+10 more)
...
Cohesion: 0.05
Nodes (42): ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, ACTIVE, AgentTaskList() (+34 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (29): PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_STATUS_CONFIG, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionCurrency, SubscriptionShape (+21 more)
...
Cohesion: 0.05
Nodes (49): getConversationsAction(), getMessagesAction(), AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions (+41 more)
...
Cohesion: 0.11
Nodes (35): addFactCore(), addHealthAdjustCore(), addObservationCore(), addPersonCore(), ClientMutationResult, ClientUpdate, createClientCore(), deletePersonCore() (+27 more)
...
Cohesion: 0.13
Nodes (17): DOMAIN_ICONS, getDomainIcon(), GIA_DOMAIN_ICONS, ALL_DOMAINS_ICON, DOMAIN_ICONS, parseGiaDomainParam(), persistDomainCookie(), readDomainCookie() (+9 more)
...
Cohesion: 0.09
Nodes (22): JOURNEY_STATUSES, LEAD_STATUS_BADGE, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, RESOLUTION_STATUSES, RECIPIENT_META, secondaryCell, tertiaryCell (+14 more)
...
Cohesion: 0.07
Nodes (57): canTransition(), checklistForCategory(), SENTINEL_WARN_BEFORE_MIN, TICKET_ACTIVE_STATUSES, TICKET_SLA_STOPPED_STATUSES, addTicketNoteCore(), assignTicketCore(), createTicketCore() (+49 more)
...
Cohesion: 0.07
Nodes (47): clampWidgetHeight(), DASHBOARD_WIDGETS, DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId(), MANAGER_GRID (+39 more)
...
Cohesion: 0.08
Nodes (23): PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), DEMO_CONCIERGE, DEMO_REQUESTS, DEMO_THREAD, DEMO_VERTICALS (+15 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (36): BudgetFilterBar(), TABS, DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), AddWidgetMenu(), MQ, useMediaQuery(), PortalAnchorPosition (+28 more)
...
Cohesion: 0.06
Nodes (30): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS (+22 more)
...
Cohesion: 0.08
Nodes (34): getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), getServiceCategoryLabel(), SERVICE_CATEGORY_DEF, ServiceCategory (+26 more)
...
Cohesion: 0.05
Nodes (53): assertLeadFieldEditAccess(), BulkUpdateResult, exportLeadsAction(), ExportPayload, LeadEditContext, revalidateLeadDossier(), updateLeadCity(), updateLeadDomain() (+45 more)
...
Cohesion: 0.09
Nodes (26): getCompletedTasksAction(), ElayaTrainingManager(), metadata, MobileAgentTasksPage(), RootPage(), GET(), ElayaTrainingPage(), UserDetailPage() (+18 more)

### Community 117 - "Task Flow Sequences"
Cohesion: 0.12
Nodes (23): AgentDistributionBar(), AgentDistributionBarProps, SEGMENT_COLORS, CampaignCard(), CampaignCardProps, DOT_COLOR, MotionLink, StatusDatum() (+15 more)
...
Cohesion: 0.18
Nodes (9): signOutUser(), getMobileRooms(), DEMO_PERSONA, MobileDrawer(), SOFT_OUT, MobileSession, MobileSessionContext, useMobileSession() (+1 more)
...
Cohesion: 0.07
Nodes (30): ALL_TOOLS, ElayaReadToolName, ElayaTool, ElayaToolExecution, findTeammate, findVendors, FOUNDER_UP, getBudget (+22 more)
...
Cohesion: 0.10
Nodes (29): BarChart(), BarChartProps, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens, FALLBACK (+21 more)
...
Cohesion: 0.12
Nodes (22): collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), buildElayaTimeContext(), CustomerPrincipal (+14 more)

### Community 134 - "Community 134"
Cohesion: 0.10
Nodes (39): getTicket(), getTicketField(), listContactsUpdatedSince(), listConversations(), listTicketsUpdatedSince(), BackfillState, CHOICE_FIELD_TYPES, ContactsState (+31 more)
...
Cohesion: 0.16
Nodes (17): SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, useNotificationSound(), NotificationsContext, NotificationsContextValue, NotificationsProvider(), NotificationsProviderProps (+9 more)
...
Cohesion: 0.05
Nodes (68): BooksBankAccounts(), BODY, BooksAsync(), BooksPage(), canSee(), SHELL, RefreshBooksButton(), TONES (+60 more)
...
Cohesion: 0.11
Nodes (33): VendorPage(), fmt(), host, line(), main(), callAdminRpc(), parseIntent(), readVendorRequest() (+25 more)
...
Cohesion: 0.20
Nodes (20): GiaDomain, DomainFetchResult, useDomainRoomData(), ProgressCard(), DomainSwiper(), BudgetRoom(), DashboardRoom(), ComingSoonCard() (+12 more)

### Community 177 - "Community 177"
Cohesion: 0.18
Nodes (5): ClientZohoSkeleton(), ElayaLoading(), ErrorLogTableSkeleton(), Shimmer(), skeletonStagger()
...
Cohesion: 0.04
Nodes (58): AdCreativeFormModal(), AdCreativeFormModalProps, chevronStyle, inputBase, selectBase, actionBtnStyle, AdCreativesManagerProps, CARD_HOVER (+50 more)
...
Cohesion: 0.08
Nodes (65): actorFromProfile(), requireProfile(), addClientFactAction(), addClientObservationAction(), addClientPersonAction(), adjustClientHealthAction(), createClientAction(), deleteClientPersonAction() (+57 more)
...
Cohesion: 0.12
Nodes (20): AppearanceKey, applyAppearanceToDom(), DEF, persistAppearanceCookie(), resolvesDark(), systemPrefersDark(), defineEnum(), EnumDef (+12 more)
...
Cohesion: 0.08
Nodes (35): AgentDetailAsync(), CallerRole, OversightAgentPage(), isAppDomain(), AppDomainCallerRole, OversightTeamPage(), TeamDetailAsync(), AgentBreakdownGrid() (+27 more)

### Community 235 - "Community 235"
Cohesion: 0.12
Nodes (18): deleteTicketSlaPolicyAction(), revalidate(), ROLES, updateTicketSettingsAction(), upsertTicketSlaPolicyAction(), TICKET_SUB_CATEGORIES, Draft, NEW (+10 more)
...
Cohesion: 0.07
Nodes (45): UsersTable(), BudgetPage(), SearchParams, ClientAppLayout(), DealsSkeleton(), DealsPage(), parseFilters(), ElayaPage() (+37 more)
...
Cohesion: 0.07
Nodes (46): FreshdeskOverviewSkeleton(), FreshdeskTable(), canSee(), FreshdeskPage(), OverviewAsync(), TicketsAsync(), SyncNowButton(), applyTicketFilters() (+38 more)

### Community 259 - "Community 259"
Cohesion: 0.07
Nodes (41): ConversationIdSchema, markConversationAsRead(), searchConversationsAction(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType() (+33 more)
...
Cohesion: 0.05
Nodes (49): CALL_OUTCOME_DEF, FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal(), AgentDetailPanel() (+41 more)
...
Cohesion: 0.09
Nodes (32): createUser(), inviteUser(), mapProfileError(), updateProfile(), updateProfileAvatar(), updateUserAuthorization(), EditProfileForm(), FieldProps (+24 more)
...
Cohesion: 0.04
Nodes (54): KIND_LABEL, ICONS, FIELD, Props, RELATIONS, CELL, ClientRow, HEAD (+46 more)
...
Cohesion: 0.07
Nodes (40): getAssignableUsersAction(), RefreshClientFinanceButton(), BulkEditLeadsModalProps, fieldLabel, STATUS_ITEMS, OUTCOME_ITEMS, Props, Props (+32 more)
...
Cohesion: 0.14
Nodes (20): CURRENCY_SYMBOLS, INVOICE_ACCEPT_MIME, Props, ERROR_TEXT_STYLE, FIELD_LABEL_STYLE, HELP_TEXT_STYLE, INPUT_STYLE, todayIso() (+12 more)
...
Cohesion: 0.06
Nodes (28): EASE_SPRING, addDaysISO(), cardStyle, dueRow, pad2(), resetBtn, SubOccurrence, SubscriptionCalendar() (+20 more)

### Community 375 - "Community 375"
Cohesion: 0.14
Nodes (24): addLeadNote(), assignLead(), bulkUpdateLeads(), createLeadTaskAction(), createManualLead(), leadDisplayName(), emitActivityEvent(), EmitActivityEventInput (+16 more)
...
Cohesion: 0.29
Nodes (12): SCORE_WEIGHTS, VendorScore, VendorScoreInputs, clamp01(), computeVendorScore(), plural(), recencySignal(), reviewAverages() (+4 more)
...
Cohesion: 0.16
Nodes (11): getVendorCategories(), VendorListFilters, VendorListItem, canSeeVendors(), parseFilters(), VendorsPage(), CELL, HEAD (+3 more)
...
Cohesion: 0.43
Nodes (5): reviveLeadAction(), RevivalDossierAction(), ReviveLeadButton(), ReviveLeadButtonProps, getOpenCandidateForLead()

### Community 404 - "Community 404"
Cohesion: 0.05
Nodes (49): chevronStyle, EditAuthorizationForm(), initialState, labelStyle, Props, selectStyle, fdPriorityLabel(), fdSourceLabel() (+41 more)

### Community 405 - "Community 405"
Cohesion: 0.13
Nodes (19): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, LeadExportItem, LeadNoteWithAuthor, MonthlyReportRow, currentMonthIso() (+11 more)
...
Cohesion: 0.07
Nodes (31): ClientActivityCard(), ClientFactsCard(), ClientHealthCard(), ClientObservationCard(), ClientPeopleCard(), ClientRequestsCard(), ClientAnticipationsCard(), ClientAppCard() (+23 more)
...
Cohesion: 0.10
Nodes (16): loginAction(), loginSchema, requestPasswordResetAction(), RequireProfileResult, ForgotPasswordForm(), metadata, LoginForm(), metadata (+8 more)
...
Cohesion: 0.08
Nodes (35): getElayaChatSeedAction(), updateElayaPersonaAction(), ELAYA_DAILY_LINES, getElayaTimeGreeting(), DEPTH_DEF, ELAYA_DEPTH_PROMPT, ELAYA_LANGUAGE_PROMPT, ELAYA_LENGTH_PROMPT (+27 more)

### Community 458 - "Community 458"
Cohesion: 0.45
Nodes (11): istToUtc(), normalizeDueAtToIstInstant(), toIst(), advanceToNextBusinessStart(), AgentShiftOverride, businessMinutesBetween(), isOffDay(), isWithinBusinessHours() (+3 more)
...
Cohesion: 0.10
Nodes (20): ElayaFeedbackCard(), ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem, NavLink() (+12 more)
...
Cohesion: 0.10
Nodes (21): SPRING_TAB, ContentProps, getMulti(), getStr(), SubscriptionsPage(), SubscriptionsTable(), SubscriptionViewTabs(), VIEWS (+13 more)
...
Cohesion: 0.09
Nodes (28): dismissRevivalCandidateAction(), updateRevivalPolicyAction(), REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_TRIGGER_STATUSES, REVIVAL_VERDICTS (+20 more)

### Community 476 - "Community 476"
Cohesion: 0.14
Nodes (17): AccountReportSection(), BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetSectionHeader(), SectionHeaderDatum() (+9 more)
...
Cohesion: 0.10
Nodes (19): useLeadColumnPreferences(), ExportButton(), ExportButtonProps, ExportFormat, ExportModal(), ExportModalProps, BulkEditLeadsModal, LeadsSelectionToolbar() (+11 more)
...
Cohesion: 0.03
Nodes (95): listBoardTicketsAction(), ticketQueendom(), FRESHDESK_CATEGORY_TO_TICKET, resolveTicketStatusLabels(), TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BOARD_STATUSES, TICKET_BRIEF_FIELD_LABELS (+87 more)
...
Cohesion: 0.19
Nodes (14): DealType, MODAL_VARIANTS, DealRow, DealDrillRow(), DealDrillRowItem, dealTypeLabel(), ROW_STYLE, DrillModalShell() (+6 more)

### Community 490 - "Community 490"
Cohesion: 0.18
Nodes (18): useCreateTriggerModal(), GroupTasksTab(), Tab, TasksFilters(), TasksFiltersProps, TasksShell(), domainsInGroupRows(), EMPTY_GROUP_TASK_FILTERS (+10 more)
...
Cohesion: 0.04
Nodes (79): BODY, BooksOverviewStrip(), GRID, SHELL, AdSpendUploadModal(), Props, ChartSkeleton(), ChartSkeletonProps (+71 more)
...
Cohesion: 0.09
Nodes (26): anyTicket, APPLY, creationRule, main(), SITE, siteArgIdx, updateRule, apiKey() (+18 more)

### Community 495 - "Community 495"
Cohesion: 0.10
Nodes (16): AgentSelfMetrics, getAgentPulseAction(), getAgentRecentLeadActivityAction(), AgentActivityTrendChart, AgentPerformanceShell(), CallOutcomeBar, CoreFourGrid, PipelineLine() (+8 more)

### Community 496 - "Community 496"
Cohesion: 0.11
Nodes (20): getGroupSubtasksAction(), getTaskRemarksAction(), WorkspaceAsync(), CompletedTaskCursor, CompletedTaskRaw, CompletedTaskRow, CompletedTasksResult, DomainTaskAgentSummary (+12 more)
...
Cohesion: 0.13
Nodes (16): CampaignAdPanel(), CampaignMetricsStripSkeleton(), CampaignLeadsAsync(), LeadsPagination(), LeadsPaginationProps, LeadsTableAsync(), LeadsTableAsyncProps, COL_WIDTHS (+8 more)
...
Cohesion: 0.09
Nodes (24): LEAD_STATUSES, buildSituations(), CreateRuleDraft, CreateRuleForm(), HOURS_MODE_OPTIONS, RECIPIENT_LABELS, RECIPIENT_OPTIONS, RECIPIENT_VERB (+16 more)

### Community 502 - "Community 502"
Cohesion: 0.10
Nodes (15): TASK_PRIORITY, AssigneePickerModal(), GroupTaskWithMeta, CreateGroupTaskModal, DueDateChip(), getAccentForRow(), getIconForRow(), GroupRow (+7 more)
...
Cohesion: 0.12
Nodes (16): TASK_STATUS_DEF, TASK_TYPE_DEF, CreateLeadTaskModalProps, LeadTasksAsync(), Props, CreateLeadTaskModal, LeadTasksCard(), LeadTasksCardProps (+8 more)
...
Cohesion: 0.21
Nodes (18): useTaskCompletionToggle(), PersonalTaskRow, buildTaskDots(), CalendarTaskRow, CalendarTaskRowProps, DateSection, getDueDateColor(), groupTasksByDate() (+10 more)
...
Cohesion: 0.21
Nodes (14): getBudgetGaugeWidgetAction(), BudgetAsync(), Props, BudgetEmptyState(), DASHBOARD_GREETINGS, pickDashboardGreeting(), DashboardPage(), VALID_PRESETS (+6 more)
...
Cohesion: 0.20
Nodes (11): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton(), CampaignsPage(), parseFilters() (+3 more)
...
Cohesion: 0.15
Nodes (10): ADMIN_ROOMS, DOMAIN_PASTEL_TOKENS, DOMAIN_VERTICALS, DomainVertical, MOBILE_ROOMS_BY_ROLE, MobileRoom, MobileRoomKey, MobileRoomSet (+2 more)

### Community 522 - "Community 522"
Cohesion: 0.17
Nodes (11): getVendorCategoryLabel(), RequestCategory, SERVICES_BY_REQUEST_CATEGORY, vendorCategoryOptions(), VendorService, Dialog(), DialogProps, MAX_WIDTH (+3 more)

### Community 523 - "Community 523"
Cohesion: 0.28
Nodes (5): TicketsTableSkeleton(), FilterBarSkeletonProps, PageHeaderSkeletonProps, ShimmerProps, SkeletonCardProps

### Community 526 - "Community 526"
Cohesion: 0.15
Nodes (9): VendorStatus, Props, VendorContact, ITALIC, resolvePoc(), STATUS_STYLE, VendorIdentityCard(), VendorNotesCard() (+1 more)
...
Cohesion: 0.19
Nodes (11): getSpendingOverview(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES, monthBounds(), PasswordReveal (+3 more)
...
Cohesion: 0.24
Nodes (9): EVENT_PRESENTATION, eventDetail(), FeedState, statusWord(), ActivityFeedCursor, ActivityFeedResult, ActivityEventRow, ActivityEventType (+1 more)

### Community 531 - "Community 531"
Cohesion: 0.23
Nodes (10): AgentStatusBreakdown, CampaignStatusMix, buildMobileGreeting(), getMobileDashboardData(), MobileBudgetCampaign, MobileBudgetData, MobileDashboardData, MobileGreeting (+2 more)
...
Cohesion: 0.25
Nodes (7): FilterChip(), MobileSegmented(), MobileStepper(), MobileToggle(), SettingRow(), ProfileScreen(), metadata
...
## Knowledge Gaps
- **4779 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4774 more)
...
- **Why does `createAdminClient()` connect `Agent Performance Shell` to `Community 512`, `Community 258`, `Community 259`, `Task Constants & UI`, `Auth & Lead Actions`, `Community 134`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Lead Mutations & Notifications`, `WhatsApp Constants & Config`, `Community 133`, `Lead Edit & Search`, `Page Skeletons & Flags`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Budget & Spend UI`, `Community 530`, `Agent Performance Metrics`, `Community 401`, `Community 533`, `Task Summary & SLA Policies`, `Community 403`, `Shared Types & Props`, `Community 409`, `Service Interests & Cases`, `Campaign & Domain Filters`, `Chart Components`, `Community 160`, `Agent Detail & Performance`, `Elaya Actions Service`, `Community 300`, `Deals Page Documentation`, `Upload & Add Modals`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Toast & Domain Utilities`, `Community 457`, `Community 205`, `Agent Usage & Presence`, `Ad Creatives & Campaign Pages`, `Community 475`, `Themes & Notifications`, `Community 482`, `Community 228`, `Community 234`, `Community 110`, `Community 494`, `Community 496`, `Tasks Page Docs`, `Community 375`, `Community 251`, `Community 510`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `getCurrentProfile` connect `Community 251` to `Community 512`, `Community 258`, `Lead Mutations & Notifications`, `Community 259`, `Community 526`, `Ad Creative UI Components`, `Budget & Spend UI`, `Community 400`, `Community 147`, `Community 404`, `Community 531`, `Community 409`, `Community 537`, `Community 160`, `Agent Detail & Performance`, `Elaya Actions Service`, `Community 442`, `Elaya Principal & Tools`, `Community 65`, `Community 457`, `Community 204`, `Community 205`, `Community 206`, `Community 460`, `Community 210`, `Community 471`, `Community 228`, `Community 234`, `Community 498`, `Tasks Page Docs`, `Community 510`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `requireProfile()` connect `Community 205` to `Lead Mutations & Notifications`, `Community 259`, `Task Constants & UI`, `Dashboard Widget Registry`, `Lead Edit & Search`, `Page Skeletons & Flags`, `Community 527`, `Dashboard Data Actions`, `Budget & Spend UI`, `Agent Performance Metrics`, `Community 403`, `Agent Performance Shell`, `Community 533`, `Shared Types & Props`, `Lead Sources & Activity`, `Community 300`, `Deals Page Documentation`, `Community 442`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Community 70`, `Community 457`, `Agent Usage & Presence`, `Community 475`, `Themes & Notifications`, `Community 482`, `Campaign Metrics & Leads UI`, `Community 228`, `Community 235`, `Community 365`, `Community 110`, `Community 495`, `Community 496`, `Community 500`, `Tasks Page Docs`, `Community 375`, `Community 251`, `Community 510`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4888 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.0026666666666666666 - nodes in this community are weakly interconnected._
