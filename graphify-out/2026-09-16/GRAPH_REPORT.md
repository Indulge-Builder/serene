...
## Corpus Check
- 1255 files · ~5,968,838 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9686 nodes · 20799 edges · 523 communities (480 shown, 43 thin omitted)
...
1. `Serene — Changelog` - 787 edges
2. `createAdminClient()` - 305 edges
...
Cohesion: 0.09
Nodes (40): getVendorDetailAction(), searchVendorsAction(), VendorPage(), fmt(), host, line(), main(), callAdminRpc() (+32 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.09
Nodes (30): collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), CustomerPrincipal, ElayaPersona (+22 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.05
Nodes (95): addLeadCallNote(), assignLead(), bulkUpdateLeads(), createManualLead(), cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), logSlaScheduleRejections(), refreshActivitySlaTimers() (+87 more)
...
Cohesion: 0.15
Nodes (13): FACT_POLARITIES, FactPolarity, RELATION_KINDS, maskPii(), maskString(), FACETS, KNOWN_KEYS, ObservationReading (+5 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.07
Nodes (34): Props, DealType, DOMAIN_LABELS, MODAL_VARIANTS, Props, WonDealModal(), AgentDealsDrillModal(), DealRow (+26 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.16
Nodes (17): LeadWhatsAppCard(), LeadWhatsAppCardAsync(), Props, applyLastMessagePeriodFilter(), attachUnreadCounts(), getConversationByLeadId(), getConversations(), getMessages() (+9 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.18
Nodes (20): SIA_ALERT_TIER1_PROFILE_IDS, filterRecipientsByPref(), isChannelEnabled(), assertGupshupConfigured(), isGupshupDelivered(), logNotification(), NotificationLogEntry, sendCustomerWelcomeTemplate() (+12 more)
...
Cohesion: 0.04
Nodes (92): getGroupSubtasksAction(), getPersonalTaskTagsAction(), getTaskRemarksAction(), AddDealButton(), NewDealModal, Props, getGiaTasks(), useCreateTriggerModal() (+84 more)
...
Cohesion: 0.07
Nodes (37): AccountReportSection(), Props, BudgetEmptyState(), BudgetSectionHeader(), SectionHeaderDatum(), BudgetTable(), BudgetTableRow, COLUMNS (+29 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.05
Nodes (95): actorFromProfile(), requireProfile(), refreshBooksOverviewAction(), refreshClientFinanceAction(), RefreshClientFinanceSchema, addClientFactAction(), addClientObservationAction(), addClientPersonAction() (+87 more)
...
Cohesion: 0.05
Nodes (57): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, loginSchema, RequireProfileResult, getAgentTasksSummaryAction(), addLeadNote(), createLeadTaskAction() (+49 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.11
Nodes (26): BridgeBody, FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), isRateLimited, LEAD_SOURCES_SET, logRawPayload() (+18 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.09
Nodes (37): armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, describePolicy(), fireSlaBreachHandler(), formatSlaTimestamp(), istDateKey() (+29 more)
...
Cohesion: 0.12
Nodes (33): AsyncAnthropic, StaffPrincipal, Any, CompleteRequest, CompleteResult, CompleteRequest, CompleteResult, The turn loop — the port of brain.ts's tool-calling core.  One turn: specialist (+25 more)
...
Cohesion: 0.09
Nodes (46): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction() (+38 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.07
Nodes (46): CampaignFilters(), CampaignFiltersProps, ClientsFilters(), HEALTH_ITEMS, UNLINKED_ITEMS, DateRangePreset, DEF, matchDateRangePreset() (+38 more)
...
Cohesion: 0.05
Nodes (49): canAccessLead(), canSeeClientFinance(), leadDisplayName(), statusLabel(), EmitActivityEventInput, ElayaActionPayload, ElayaActionTarget, ElayaActionType (+41 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.05
Nodes (34): compareDomainDisplayOrder(), FLIP_UP_TRANSFORM_TEMPLATE(), loadCsv(), AgentSettingsTable(), AgentSettingsTableProps, DAY_DISPLAY_ORDER, DAY_LABELS, DEFAULT_WORK_DAYS (+26 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.14
Nodes (19): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), REVIVAL_TRIGGER_STATUSES, countAutoRevivesToday(), findSilentLeadsForStatus(), getActiveRevivalPolicies(), getOpenCandidateForLead() (+11 more)
...
Cohesion: 0.11
Nodes (40): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, ELAYA_DAILY_LINES, getElayaTimeGreeting(), pickElayaDailyLine() (+32 more)
...
Cohesion: 0.09
Nodes (30): createSlaPolicyAction(), generateUserPolicyCode(), RESERVED_CODE_PREFIXES, updateSlaPolicyAction(), goingColdCutoff(), getColdLeads(), EscalationsAsync(), getLeadsForExport() (+22 more)
...
Cohesion: 0.05
Nodes (51): clampWidgetHeight(), DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId(), MANAGER_GRID, resolveWidgetDensity() (+43 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.07
Nodes (39): TICKET_ACTIVE_STATUSES, TICKET_SLA_STOPPED_STATUSES, FreshdeskTicketPage(), freshdeskTicketUrl(), getFreshdeskTicketDetail(), callAdminRpcAll(), SENTINEL_ACTOR, elapsedMin() (+31 more)
...
Cohesion: 0.11
Nodes (29): AddClientButton(), ClientsTable(), ClientsAsync(), ClientsPage(), parseFilters(), ClientTier, computeHealthScore(), buildHealth() (+21 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.07
Nodes (55): CallerRole, OversightAgentPage(), BudgetPage(), SearchParams, CampaignListSkeleton(), CampaignsPage(), parseFilters(), isAppDomain() (+47 more)
...
Cohesion: 0.13
Nodes (16): BenchmarkLine, CardConfig, computeDelta(), CoreFourGrid(), formatPct(), makeBenchmarkLine(), Props, CoreFourMetrics (+8 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.10
Nodes (28): createUser(), inviteUser(), isSeatTaken(), mapProfileError(), toggleUserActive(), updateProfile(), updateUserAuthorization(), SiaRole (+20 more)
...
Cohesion: 0.15
Nodes (12): AppearanceSelector(), Props, IconSelector(), BeforeInstallPromptEvent, InstallPrompt(), Platform, swapInstallIcon(), ProfilePage() (+4 more)
...
Cohesion: 0.08
Nodes (21): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder() (+13 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.08
Nodes (41): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+33 more)
...
Cohesion: 0.04
Nodes (67): getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), EMPTY, PaletteDealHit, PaletteLeadHit (+59 more)

### Community 65 - "Community 65"
Cohesion: 0.05
Nodes (41): getShopEnquiryTypeLabel(), LeadDossierPage(), DynamicFormResponses(), Props, LeadDealCard(), LeadDealCardAsync(), Props, LeadNotesInput() (+33 more)

### Community 66 - "Community 66"
Cohesion: 0.13
Nodes (24): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), recordDeal(), updateLeadStatus(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF (+16 more)

### Community 67 - "Community 67"
Cohesion: 0.04
Nodes (68): PaletteSearchResult, ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS (+60 more)
...
Cohesion: 0.07
Nodes (48): FRESHDESK_ROLES, runFreshdeskSyncNow(), SyncNowResult, SCHEMA_ERROR_COPY, transcribeAudioAction(), addFactCore(), addHealthAdjustCore(), addObservationCore() (+40 more)
...
Cohesion: 0.08
Nodes (30): getAgentPulse(), getRoster(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync(), AgentActivityFilter, AgentCallPageItem, AgentCallsPage (+22 more)
...
Cohesion: 0.10
Nodes (22): getAgentUsageAction(), recordPresenceAction(), ClientAppLayout(), INTERACTION_EVENTS, UsagePresence(), MobileSession, MobileSessionContext, MobileSessionProvider() (+14 more)
...
Cohesion: 0.09
Nodes (26): useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher, LeadVolumeSummary, MultiDomainVolumeSummary, DashboardAgentStatusBreakdown, DashboardCampaignStatusMix (+18 more)
...
Cohesion: 0.04
Nodes (65): addSubscriptionPaymentAction(), addSubscriptionTopupAction(), archiveSubscriptionAction(), canManageSubscriptions(), createSubscriptionAction(), getSubscriptionDetailAction(), getSubscriptionMonthlyReportAction(), listActiveSubscriptionsAction() (+57 more)

### Community 93 - "Revival Service & Policies"
Cohesion: 0.13
Nodes (16): PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), DEMO_CHAT, DEMO_CHAT_SUGGESTIONS, DEMO_REQUESTS, DemoChatMessage (+8 more)

### Community 94 - "Community 94"
Cohesion: 0.17
Nodes (10): TICKET_SUB_CATEGORIES, Draft, NEW, NUM, PolicyCard(), scopeLine(), SELECT, Step (+2 more)
...
Cohesion: 0.18
Nodes (13): CategoryPill(), CategoryPillProps, ActiveCategory, CaseDetailModal, HelpdeskSearch(), HelpdeskSearchProps, parseCategory(), HookList() (+5 more)
...
Cohesion: 0.08
Nodes (40): assertLeadFieldEditAccess(), BulkUpdateResult, exportLeadsAction(), ExportPayload, LeadEditContext, revalidateLeadDossier(), updateLeadCity(), updateLeadDomain() (+32 more)
...
Cohesion: 0.19
Nodes (8): signOutUser(), getMobileRooms(), DEMO_PERSONA, DEMO_VERTICALS, MobileDrawer(), SOFT_OUT, useMobileSession(), MobileTabBar()
...
Cohesion: 0.05
Nodes (60): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignListAsync(), CampaignListAsyncProps, CampaignMetricsStripSkeleton(), LEAD_ASSIGNABLE_ROLES, ROUTING_POOL_ROLES (+52 more)
...
Cohesion: 0.06
Nodes (44): BarChart(), BarChartProps, BarChartSeries, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartSkeleton() (+36 more)
...
Cohesion: 0.12
Nodes (30): POST(), buildPersonaPromptBlock(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction(), runElayaTurn(), AFFIRMATIVE_PHRASES, AFFIRMATIVE_TOKENS (+22 more)

### Community 134 - "Community 134"
Cohesion: 0.10
Nodes (47): budgetHasRoom(), listAgents(), listConversations(), listGroups(), listSlaPolicies(), listTicketFields(), listTicketsUpdatedSince(), getNameMaps() (+39 more)
...
Cohesion: 0.14
Nodes (19): EASE_SPRING, SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, useNotificationSound(), NotificationsContext, NotificationsContextValue, NotificationsProvider() (+11 more)
...
Cohesion: 0.05
Nodes (73): BooksSkeleton(), BODY, BooksAsync(), BooksPage(), canSee(), SHELL, RefreshBooksButton(), TONES (+65 more)
...
Cohesion: 0.04
Nodes (57): rankVendorsAction(), CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, EngagementOutcome, getRequestCategoryLabel(), getServiceLabel(), getVendorCategoryLabel() (+49 more)
...
Cohesion: 0.06
Nodes (69): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), getDomainHealthMetricsAction(), metadata (+61 more)
...
Cohesion: 0.04
Nodes (60): actionBtnStyle, CARD_HOVER, actionBtnStyle, AssetCard(), CARD_HOVER, ElayaTrainingManagerProps, KIND_ICON, safeHost() (+52 more)

### Community 204 - "Community 204"
Cohesion: 0.12
Nodes (17): HealthPill(), healthTone(), TICKET_STATUSES, Props, TicketChecklistCard(), BODY, SHELL, TicketHelpPanel() (+9 more)

### Community 205 - "Community 205"
Cohesion: 0.07
Nodes (37): FRESHDESK_CATEGORY_TO_TICKET, resolveTicketStatusLabels(), SENTINEL_WARN_BEFORE_MIN, TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BOARD_STATUSES, TICKET_BRIEF_FIELDS, TICKET_CHECKLIST_TEMPLATES (+29 more)

### Community 206 - "Community 206"
Cohesion: 0.17
Nodes (19): ConversationIdSchema, markConversationAsRead(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction(), resolveOutboundMediaType(), sendGupshupMediaMessage() (+11 more)
...
Cohesion: 0.12
Nodes (23): EASE_OUT_SOFT, ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, FOUNDER_NAV_PREFIXES, WORKBENCH_BLOCKED_PREFIXES, WORKBENCH_DOMAINS, FindVendorPage(), metadata (+15 more)
...
Cohesion: 0.09
Nodes (30): AgentDetailAsync(), AppDomainCallerRole, TeamDetailAsync(), AgentBreakdownGrid(), describeMeta(), EVENT_META, OversightAgentRail(), OversightTeamRail() (+22 more)

### Community 235 - "Community 235"
Cohesion: 0.12
Nodes (19): getConversationsAction(), getMessagesAction(), LeadWhatsAppCardProps, MetaApiResponse, MetaContact, MetaMediaObject, MetaStatusUpdate, MetaWebhookChange (+11 more)
...
Cohesion: 0.16
Nodes (25): BTN, TicketBoardPage(), ClientFinancePage(), ClientPage(), TicketPage(), logClientAccess(), ElayaTicketSummary, getTicketDetail() (+17 more)
...
Cohesion: 0.08
Nodes (40): FreshdeskOverview(), FreshdeskOverviewSkeleton(), SyncLine(), TILE_GRID, FreshdeskPage(), OverviewAsync(), parseFilters(), TicketsAsync() (+32 more)
...
Cohesion: 0.05
Nodes (53): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, TRAINING_ROLES, updateElayaPersonaAction() (+45 more)

### Community 262 - "Community 262"
Cohesion: 0.08
Nodes (30): AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, useMountOnFirstOpen(), AddSuggestionButton(), AddSuggestionModal, Props (+22 more)
...
Cohesion: 0.05
Nodes (46): FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), AgentDetailPanel(), CallOutcomeBar, DetailSlice (+38 more)
...
Cohesion: 0.04
Nodes (56): CreateUserForm(), CreateUserFormProps, CreateUserMode, FieldProps, FieldsProps, FooterProps, formStyle, initialState (+48 more)
...
Cohesion: 0.16
Nodes (13): getElayaChatSeedAction(), EASE_IN_EXPO, ElayaWidget(), ElayaChatShell, EmbeddedElayaChat(), loadElayaChatShell(), Props, ElayaChatSeed (+5 more)
...
Cohesion: 0.11
Nodes (23): Any, count_user_messages_today(), DuplicateMessage, get_latest_proposed_action(), get_model_context_messages(), get_notes_for_elaya(), get_or_create_active_conversation(), get_owned_conversation() (+15 more)
...
Cohesion: 0.02
Nodes (128): requestPasswordResetAction(), getAssignableUsersAction(), AdCreativeFormModal(), chevronStyle, inputBase, selectBase, EditProfileForm(), FieldProps (+120 more)
...
Cohesion: 0.18
Nodes (9): getVendorCities(), AMBIGUOUS_CITIES, CATEGORY_WORDS, host, main(), Parsed, parseRequest(), PHRASES (+1 more)
...
Cohesion: 0.07
Nodes (42): PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_DEPARTMENT_OPTIONS, SUBSCRIPTION_STATUS_CONFIG, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionShape (+34 more)

### Community 375 - "Community 375"
Cohesion: 0.15
Nodes (16): ELAYA_STARTER_PROMPTS, ElayaChatShell(), Props, CAPABILITIES, ElayaIdentityCard(), Props, ElayaMessageBubble(), ElayaUiMessage (+8 more)
...
Cohesion: 0.15
Nodes (10): VendorListFilters, VendorListItem, AddVendorButton(), parseFilters(), VendorsPage(), CELL, HEAD, NUM (+2 more)

### Community 401 - "Community 401"
Cohesion: 0.09
Nodes (29): FD_EXT_BY_MIME, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, FD_WAITING_STATUSES, fdPriorityLabel() (+21 more)
...
Cohesion: 0.35
Nodes (12): getPreviousPeriodDateRange(), resolvePerformanceDateParams(), rangeFromUrlParams(), resolvePresetToRange(), getISTMondayStart(), getISTMonthStart(), getISTPrevMonthRange(), IST_MONTHS (+4 more)

### Community 404 - "Community 404"
Cohesion: 0.16
Nodes (6): updateProfileAvatar(), AuthCallbackClient(), Phase, metadata, Props, createClient()
...
Cohesion: 0.13
Nodes (11): chat(), ChatRequest, POST /v1/elaya/chat — the Python brain's chat endpoint (SSE).  WIRE-COMPATIBLE w, Settings — environment-driven, never hardcoded.  Secrets arrive as environment v, Settings, healthz(), Serene backend — the Python service (master-plan Step 2 skeleton).  This is the, Liveness — the load balancer and ECS health checks hit this. (+3 more)
...
Cohesion: 0.06
Nodes (54): CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS, SHOP_ENQUIRY_TYPES (+46 more)
...
Cohesion: 0.16
Nodes (14): fdAttachmentExt(), fdAttachmentKind(), CHIP, FreshdeskAttachments(), TicketThread(), copyMedia(), extractInlineImages(), safeName() (+6 more)
...
Cohesion: 0.31
Nodes (7): INLINE_MARKERS, linkifyText(), renderInline(), renderWaText(), MediaPlaceholder(), MessageBubble(), MessageBubbleProps
...
Cohesion: 0.06
Nodes (45): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, DashboardDateFilter() (+37 more)

### Community 473 - "Community 473"
Cohesion: 0.04
Nodes (68): ClientActivityCard(), KIND_LABEL, ClientFactsCard(), ICONS, BODY, ClientFinanceView(), daysLeft(), MONEY_KINDS (+60 more)
...
Cohesion: 0.07
Nodes (34): TICKET_BRIEF_FIELD_LABELS, TICKET_BRIEF_FIELDS_BY_CATEGORY, TICKET_CATEGORIES, TicketActorKind, TicketBriefField, TicketCategory, TicketChecklistItem, TicketLinkKind (+26 more)
...
Cohesion: 0.29
Nodes (3): initiateWhatsAppConversationAction(), MessageBar, MessageBarProps
...
Cohesion: 0.05
Nodes (48): AgentSelfMetrics, getAgentPulseAction(), BODY, BooksBankAccounts(), BooksOverviewStrip(), GRID, SHELL, AdSpendUploadModal() (+40 more)
...
Cohesion: 0.03
Nodes (69): JOURNEY_STATUSES, LEAD_STATUS_BADGE, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, RESOLUTION_STATUSES, EscalatedLeadsSection(), GoingColdSection(), OverdueTasksSection() (+61 more)
...
Cohesion: 0.22
Nodes (14): searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, parseWhatsAppPeriodFromSearchParams(), WhatsAppPeriodRange, ConversationList() (+6 more)

### Community 520 - "Community 520"
Cohesion: 0.08
Nodes (27): DASHBOARD_WIDGETS, DROPDOWN_VARIANTS_UP, AddWidgetMenu(), PortalAnchorPosition, usePortalAnchor(), UsePortalAnchorOptions, AddEditSubscriptionModal, AddSubscriptionButton() (+19 more)
...
## Knowledge Gaps
- **4795 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4790 more)
...
- **Why does `createAdminClient()` connect `Task Constants & UI` to `Community 258`, `Auth & Lead Actions`, `Lead Mutations & Notifications`, `Community 261`, `Community 133`, `Community 134`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Budget & Spend UI`, `Community 402`, `Agent Performance Metrics`, `Shared Types & Props`, `Agent Performance Shell`, `Community 409`, `Campaign & Domain Filters`, `Chart Components`, `Audio Recorder & Notes`, `Agent Detail & Performance`, `WhatsApp Page Documentation`, `Elaya Actions Service`, `Lead Sources & Activity`, `Deals Page Documentation`, `Dashboard Widget Data Hooks`, `Community 176`, `Motion & Date Utilities`, `Escalations & SLA Service`, `Community 442`, `Toast & Domain Utilities`, `Community 66`, `Community 458`, `Community 203`, `Agent Usage & Presence`, `Community 206`, `Notification Bell & Hooks`, `Community 81`, `Lead Column Preferences`, `Ad Creatives & Campaign Pages`, `Themes & Notifications`, `Community 482`, `Community 490`, `Community 234`, `Community 110`, `Community 498`, `Community 251`, `Gia Lead Lifecycle Docs`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `requireProfile()` connect `Budget & Spend UI` to `Lead Mutations & Notifications`, `Task Constants & UI`, `Community 261`, `Community 519`, `Lead Edit & Search`, `Dashboard Data Actions`, `Agent Performance Metrics`, `Community 404`, `Campaign & Domain Filters`, `Community 160`, `Audio Recorder & Notes`, `WhatsApp Page Documentation`, `Elaya Actions Service`, `Dashboard Widget Data Hooks`, `Community 304`, `Community 176`, `Motion & Date Utilities`, `Elaya Principal & Tools`, `Toast & Domain Utilities`, `Community 66`, `Agent Usage & Presence`, `Community 206`, `Community 81`, `Themes & Notifications`, `Community 490`, `Community 235`, `Community 492`, `Community 365`, `Community 110`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `getCurrentProfile` connect `Dashboard Widget Data Hooks` to `Community 258`, `Lead Mutations & Notifications`, `Task Constants & UI`, `Auth Roles & Cache Actions`, `Community 400`, `Budget & Spend UI`, `Agent Performance Metrics`, `Community 147`, `Campaign & Domain Filters`, `Agent Detail & Performance`, `Lead Sources & Activity`, `Community 300`, `Deals Page Documentation`, `Community 176`, `Anthropic LLM Adapter`, `Community 65`, `Community 460`, `Community 204`, `Community 81`, `Community 210`, `Community 473`, `Community 228`, `Community 234`, `Community 236`, `Community 496`, `Community 498`, `Community 499`, `Community 373`, `Community 251`, `Gia Lead Lifecycle Docs`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4904 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.002638522427440633 - nodes in this community are weakly interconnected._
