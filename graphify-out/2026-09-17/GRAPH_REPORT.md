# Graph Report - serene  (2026-09-17)

## Corpus Check
- 1266 files · ~5,985,687 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9738 nodes · 21038 edges · 538 communities (494 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20a2d26e`
...
1. `Serene — Changelog` - 795 edges
2. `createAdminClient()` - 306 edges
3. `requireProfile()` - 173 edges
4. `Serene — Design DNA` - 160 edges
5. `giaDb()` - 145 edges
6. `createClient()` - 136 edges
7. `AppDomain` - 133 edges
...
Cohesion: 0.09
Nodes (30): buildPersonaPromptBlock(), collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), buildElayaSystemPrompt() (+22 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.06
Nodes (44): assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteGroupTaskAction(), getGroupSubtasksAction(), getPersonalTaskTagsAction(), getTaskRemarksAction() (+36 more)
...
Cohesion: 0.10
Nodes (21): ROW_VARIANTS, AssigneeSlim, TaskRemarkWithAuthor, ALL_PRIORITIES, ALL_STATUSES, IconButton(), iconButtonStyles(), IconButtonVariant (+13 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.08
Nodes (39): listBoardTicketsAction(), listQueendomStaffAction(), BTN, TicketBoardPage(), resolveTicketStatusLabels(), TICKET_ACTIVE_STATUSES, TICKET_SETTING_KEYS, TicketPage() (+31 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.08
Nodes (35): isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, WHATSAPP_API_BASE, WHATSAPP_API_VERSION, WHATSAPP_CONVERSATION_STATUS, WHATSAPP_DIRECTION (+27 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.08
Nodes (45): SCHEMA_ERROR_COPY, transcribeAudioAction(), isNotificationCategoryKey(), SIA_ALERT_TIER1_PROFILE_IDS, resolveCustomerPrincipal(), handleCustomerReply(), mediaTypeForKind(), recordBotMessage() (+37 more)
...
Cohesion: 0.09
Nodes (34): useCreateTriggerModal(), CondensingPageHeader(), CondensingPageHeaderProps, GiaTask, PersonalTasksResult, TaskGroupRow, AddTaskButton(), AddTaskButtonProps (+26 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.07
Nodes (31): ALL_TOOLS, ElayaReadToolName, ElayaTool, ElayaToolExecution, findTeammate, findVendors, FOUNDER_UP, getBudget (+23 more)
...
Cohesion: 0.05
Nodes (107): actorFromProfile(), requireProfile(), deleteNote(), upsertNote(), deleteTrainingAsset(), upsertTrainingAsset(), addMemberFactAction(), addMemberObservationAction() (+99 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.07
Nodes (28): TICKET_BRIEF_FIELD_LABELS, TICKET_BRIEF_FIELDS_BY_CATEGORY, TICKET_PRIORITIES, TICKET_SUB_CATEGORIES, TicketBriefField, TicketCategory, extractJson(), Draft (+20 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.07
Nodes (47): addTicketNoteAction(), assignTicketAction(), createTicketAction(), createTicketTaskAction(), draftTicketAction(), gateTicket(), getTicketHelpAction(), linkTicketMessagesAction() (+39 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.11
Nodes (29): ConversationIdSchema, getConversationsAction(), getMessagesAction(), initiateWhatsAppConversationAction(), searchConversationsAction(), SendMessageSchema, sendWhatsAppMediaMessage(), signWhatsAppMediaAction() (+21 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.04
Nodes (86): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, loginSchema, RequireProfileResult, setNotificationPrefAction(), createUser(), getAssignableUsersAction() (+78 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.07
Nodes (40): BridgeBody, LEGACY_TOOL_NAMES, POST(), FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), isRateLimited (+32 more)
...
Cohesion: 0.08
Nodes (28): anyTicket, APPLY, creationRule, main(), SITE, siteArgIdx, updateRule, apiKey() (+20 more)
...
Cohesion: 0.04
Nodes (77): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getAgentTasksSummaryAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction() (+69 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.09
Nodes (39): CampaignFilters(), CampaignFiltersProps, matchDateRangePreset(), GIA_DOMAIN_FILTER_ITEMS, SUBSCRIPTION_DEPARTMENT_OPTIONS, CATEGORY_DOMAIN, DealsFilters(), DealsFiltersProps (+31 more)
...
Cohesion: 0.05
Nodes (52): CALL_OUTCOME_DEF, canAccessLead(), leadDisplayName(), statusLabel(), resolvePendingAction(), getTicketFor(), StaffPrincipal, ElayaActionPayload (+44 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.09
Nodes (20): compareDomainDisplayOrder(), AgentSettingsTableProps, DAY_DISPLAY_ORDER, DAY_LABELS, DEFAULT_WORK_DAYS, POOL_FILTER_ITEMS, ShiftState, WorkDayPickerProps (+12 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.10
Nodes (29): CURRENCY_SYMBOLS, INVOICE_ACCEPT_MIME, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionCurrency (+21 more)
...
Cohesion: 0.13
Nodes (35): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, ELAYA_DAILY_LINES, getElayaTimeGreeting(), pickElayaDailyLine() (+27 more)
...
Cohesion: 0.04
Nodes (94): getSiaGroupInfoAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid(), isIsoTimestamp() (+86 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.14
Nodes (25): computeHealthScore(), MemberTier, MemberPage(), AddMemberButton(), MembersTable(), MembersAsync(), MembersPage(), parseFilters() (+17 more)
...
Cohesion: 0.04
Nodes (73): BarChartSeries, clampWidgetHeight(), DASHBOARD_WIDGETS, DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId() (+65 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.08
Nodes (34): SENTINEL_WARN_BEFORE_MIN, TICKET_SLA_STOPPED_STATUSES, CreateNotificationPayload, SENTINEL_ACTOR, elapsedMin(), hours(), iso(), LinkedText (+26 more)
...
Cohesion: 0.16
Nodes (17): BooksAsync(), canSeeMemberFinance(), MemberFinancePage(), Props, ZohoAsync(), MemberZohoSkeleton(), assertRoom(), env() (+9 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.18
Nodes (16): parseGiaDomainParam(), persistDomainCookie(), readDomainCookie(), DealsPage(), parseFilters(), DOMAIN_ITEMS, DomainSelector(), LeadsFilters() (+8 more)
...
Cohesion: 0.22
Nodes (25): canTransition(), checklistForCategory(), addTicketNoteCore(), assignTicketCore(), createTicketCore(), createTicketTaskCore(), deleteTicketSlaPolicyCore(), dueStamps() (+17 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.12
Nodes (25): CreateLeadTaskModalProps, LeadTasksCardProps, TaskAssigneeContext, TaskGiaContext, CreateGroupTaskModal(), INPUT_BASE, SubtaskDraft, SubtaskRow() (+17 more)
...
Cohesion: 0.10
Nodes (25): anthropicAdapter, ElayaTurnEvent, ElayaTurnResult, AFFIRMATIVE_PHRASES, AFFIRMATIVE_TOKENS, classifyConfirmation(), ConfirmationVerdict, FILLER_TOKENS (+17 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.10
Nodes (14): CreateUserForm(), CreateUserFormProps, CreateUserMode, FieldProps, FieldsProps, FooterProps, formStyle, initialState (+6 more)
...
Cohesion: 0.07
Nodes (25): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, LeadNotesInput(), Props (+17 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.04
Nodes (66): ActivityCursorSchema, AgentSelfMetrics, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction() (+58 more)
...
Cohesion: 0.10
Nodes (21): DEFAULT_COLUMN_ORDER, isValidLeadColumnId(), LEAD_COLUMN_MAP, LEAD_COLUMNS, LeadColumnDef, LeadColumnId, EASE_SPRING, getDefaults() (+13 more)

### Community 64 - "Toast & Domain Utilities"
Cohesion: 0.04
Nodes (65): EMPTY, PaletteDealHit, PaletteLeadHit, PaletteTaskHit, getPersonalTasksAction(), DealsAsync(), DealsAsyncProps, DealsSkeleton() (+57 more)

### Community 65 - "Community 65"
Cohesion: 0.04
Nodes (63): exportLeadsAction(), AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignMetricsStripSkeleton(), goingColdCutoff(), buildLeadListKey(), DASHBOARD_PIPELINE_ROLES (+55 more)

### Community 66 - "Community 66"
Cohesion: 0.10
Nodes (18): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, CalledModal(), OUTCOME_ITEMS, Props, ActiveModal, ButtonVariant (+10 more)

### Community 67 - "Community 67"
Cohesion: 0.06
Nodes (41): GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, useTaskCompletionToggle(), CreateLeadTaskModal (+33 more)
...
Cohesion: 0.12
Nodes (16): SPRING_TAB, SubscriptionViewTabs(), VIEWS, TabsContent(), TabsContentProps, TabsContext, TabsContextValue, TabSelector() (+8 more)
...
Cohesion: 0.04
Nodes (75): refreshBooksOverviewAction(), refreshMemberFinanceAction(), RefreshMemberFinanceSchema, TRAINING_ROLES, FRESHDESK_ROLES, runFreshdeskSyncNow(), SyncNowResult, getHelpdeskLibraryAction() (+67 more)
...
Cohesion: 0.07
Nodes (54): getManagerRosterAction(), DASHBOARD_GREETINGS, pickDashboardGreeting(), DashboardPage(), VALID_PRESETS, getAgentPulse(), getRoster(), ManagerPerformanceAsync() (+46 more)
...
Cohesion: 0.09
Nodes (26): getAgentUsageAction(), recordPresenceAction(), ChartSkeleton(), ChartSkeletonProps, INTERACTION_EVENTS, UsagePresence(), HeartbeatInsert, insertUsageHeartbeats() (+18 more)

### Community 82 - "Lead Column Preferences"
Cohesion: 0.12
Nodes (22): REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_VERDICTS, RevivalTriggerStatus, getLeadNotes(), main() (+14 more)
...
Cohesion: 0.09
Nodes (23): LeadWhatsAppCardProps, Row(), getTypeIcon(), getTypeIconColor(), NotificationItem(), SiaControlModal(), MemberRow(), dueCell() (+15 more)
...
Cohesion: 0.06
Nodes (43): SUBSCRIPTION_STATUS_CONFIG, SubscriptionStatus, SubscriptionType, Props, CurrencyAmount(), DepartmentPills(), DEPT_PILL, PILL_BASE (+35 more)
...
Cohesion: 0.05
Nodes (35): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS (+27 more)
...
Cohesion: 0.06
Nodes (49): AdSpendUploadButton(), AdSpendUploadModal, getServiceCategoryLabel(), SERVICE_CATEGORY_DEF, ServiceCategory, ServiceInterest, Props, useMountOnFirstOpen() (+41 more)
...
Cohesion: 0.04
Nodes (94): addLeadNote(), assertLeadFieldEditAccess(), assignLead(), bulkUpdateLeads(), BulkUpdateResult, createLeadTaskAction(), createManualLead(), ExportPayload (+86 more)
...
Cohesion: 0.15
Nodes (13): DROPDOWN_VARIANTS, DashboardCanvas(), DashboardCanvasProps, ResponsiveGridLayout, RGL_BREAKPOINTS, RGL_COLS, DashboardDateFilter(), DashboardDateFilterProps (+5 more)
...
Cohesion: 0.14
Nodes (11): ClientAppLayout(), getMobileRooms(), DEMO_PERSONA, MobileDrawer(), SOFT_OUT, MobileSession, MobileSessionContext, MobileSessionProvider() (+3 more)
...
Cohesion: 0.07
Nodes (39): getDomainHealthMetricsAction(), BarChart(), BarChartProps, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens (+31 more)
...
Cohesion: 0.14
Nodes (13): useNotificationSound(), IconSelector(), BeforeInstallPromptEvent, InstallPrompt(), Platform, swapInstallIcon(), ProfilePage(), ProfileAvatarSection() (+5 more)
...
Cohesion: 0.14
Nodes (20): runElayaTurn(), maybeUpdateLearnedMemory(), summarizeLearnedMemory(), maskPii(), maskString(), adapterFor(), resolveLlmForJob(), NotesManager() (+12 more)

### Community 134 - "Community 134"
Cohesion: 0.09
Nodes (45): budgetHasRoom(), getTicketField(), listAgents(), listContactsUpdatedSince(), listConversations(), listGroups(), listSlaPolicies(), listTicketFields() (+37 more)
...
Cohesion: 0.18
Nodes (14): SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, NotificationsContext, NotificationsContextValue, NotificationsProvider(), NotificationsProviderProps, useNotificationsContext() (+6 more)
...
Cohesion: 0.13
Nodes (18): mono, InvoiceListFilter, Params, ZbBudget, ZbBudgetExhausted, ZbRequestError, ZbToken, ZbAgingInterval (+10 more)
...
Cohesion: 0.09
Nodes (27): CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, EngagementOutcome, PREFERENCE_STANCE_DEF, PreferenceStance, REQUEST_CATEGORY_DEF, REVIEW_DIMENSION_LABELS (+19 more)
...
Cohesion: 0.11
Nodes (32): GiaDomain, DomainFetchResult, useDomainRoomData(), DetailAppBar(), GreetingBlock(), HomeAppBar(), ProgressCard(), DomainSwiper() (+24 more)
...
Cohesion: 0.07
Nodes (35): actionBtnStyle, CARD_HOVER, actionBtnStyle, AssetCard(), CARD_HOVER, KIND_ICON, safeHost(), EASE_IN_EXPO (+27 more)

### Community 204 - "Community 204"
Cohesion: 0.03
Nodes (81): getSiaGroupsAction(), getShopEnquiryTypeLabel(), ANTICIPATION_KINDS, CLIENT_EVENT_KINDS, CLIENT_FACETS, CLIENT_TIERS, ESSENTIAL_FACETS, FACT_KEY_LABELS (+73 more)

### Community 205 - "Community 205"
Cohesion: 0.06
Nodes (47): FRESHDESK_CATEGORY_TO_TICKET, TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BOARD_STATUSES, TICKET_BRIEF_FIELDS, TICKET_CATEGORIES, TICKET_CHECKLIST_TEMPLATES, TICKET_EVENT_TYPES (+39 more)
...
Cohesion: 0.20
Nodes (13): ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), brainBaseUrl(), openPythonBrainStream(), PythonBrainOpenStream, PythonBrainRejection (+5 more)
...
Cohesion: 0.06
Nodes (53): UsersTable(), AddRechargeButton(), AddRechargeModal, BudgetPage(), SearchParams, EASE_OUT_SOFT, ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP (+45 more)
...
Cohesion: 0.07
Nodes (42): AgentDetailAsync(), CallerRole, OversightAgentPage(), ALL_DOMAINS_ICON, DOMAIN_ICONS, isAppDomain(), AppDomainCallerRole, OversightTeamPage() (+34 more)

### Community 235 - "Community 235"
Cohesion: 0.15
Nodes (11): DEAL_CATEGORY_DEF, DEAL_DURATION_DEF, DEAL_TYPE_DEF, DealShape, DealShapeInput, dealTypeForDomain(), DomainDealConfig, defineEnum() (+3 more)
...
Cohesion: 0.05
Nodes (45): BulkEditLeadsModalProps, fieldLabel, STATUS_ITEMS, ReviveLeadButtonProps, _add(), _create(), DEFAULT_DURATIONS, _emit() (+37 more)
...
Cohesion: 0.10
Nodes (40): FreshdeskTable(), FreshdeskPage(), OverviewAsync(), parseFilters(), TicketsAsync(), SyncNowButton(), applyTicketFilters(), FdFilterVocab (+32 more)

### Community 259 - "Community 259"
Cohesion: 0.22
Nodes (11): chevronStyle, inputBase, selectBase, TrainingAssetFormModal(), TrainingAssetFormModalProps, TRAINING_ASSET_KIND_DEF, TRAINING_BUCKET, TRAINING_UPLOAD_HINTS (+3 more)
...
Cohesion: 0.16
Nodes (15): getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), markReadSchema, resolveSuggestionAction(), submitSuggestionAction(), getUnreadNotifications(), markAllNotificationsRead() (+7 more)

### Community 262 - "Community 262"
Cohesion: 0.24
Nodes (7): DEF, IconKey, persistAppIconCookie(), AppBootScreen(), IconInitializer(), Props, Props
...
Cohesion: 0.05
Nodes (44): getAgentLeadsByPredicateAction(), APP_DOMAINS, FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentDetailPanel(), CallOutcomeBar (+36 more)
...
Cohesion: 0.07
Nodes (28): chevronStyle, decode(), encode(), labelStyle, Pick, Props, RoleDomainDefaults, RoleDomainFields() (+20 more)
...
Cohesion: 0.18
Nodes (16): getElayaChatSeedAction(), Props, CAPABILITIES, ElayaIdentityCard(), Props, ElayaMessageBubble(), ElayaUiMessage, ElayaWidget() (+8 more)
...
Cohesion: 0.13
Nodes (18): getPasswordReveals(), getSpendingOverview(), getSubscriptionDetail(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES (+10 more)
...
Cohesion: 0.07
Nodes (20): updatePasswordAction(), verifyResetOtpAction(), FormNotice(), FormNoticeProps, TONES, FormStatus, PasswordChangeForm(), PasswordFieldProps (+12 more)
...
Cohesion: 0.09
Nodes (17): Agent, dealCategoriesOf(), dealTypeOf(), NewDealModal(), Props, Step, Calendar(), CalendarProps (+9 more)

### Community 375 - "Community 375"
Cohesion: 0.11
Nodes (13): ELAYA_STARTER_PROMPTS, ElayaStatusText(), Fab(), IconKnob(), MobileButtonProps, DEMO_CHAT, DEMO_CHAT_SUGGESTIONS, DemoChatMessage (+5 more)
...
Cohesion: 0.12
Nodes (16): CompositeTypes, Constants, DatabaseWithoutInternals, Deal, DefaultSchema, Enums, LeadActivity, LeadNote (+8 more)
...
Cohesion: 0.09
Nodes (30): categoriesForRole(), CATEGORY_BY_KEY, NOTIFICATION_CATEGORY_ENUM, NOTIFICATION_CATEGORY_KEYS, NotificationCategory, NotificationCategoryKey, NotificationChannel, AddDealButton() (+22 more)
...
Cohesion: 0.08
Nodes (16): AdCreativeFormModal(), chevronStyle, inputBase, selectBase, AuthCallbackClient(), Phase, metadata, dateSeparatorLabel() (+8 more)

### Community 405 - "Community 405"
Cohesion: 0.09
Nodes (28): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, ExportButton(), ExportButtonProps, ExportFormat, ExportModal() (+20 more)
...
Cohesion: 0.06
Nodes (73): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), updateLeadStatus(), dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction() (+65 more)
...
Cohesion: 0.21
Nodes (11): SUGGESTION_CATEGORY_DEF, SUGGESTION_STATUS_DEF, SuggestionCategory, SuggestionStatus, CreateSuggestionPayload, signPaths(), SuggestionInboxRow, FILTER_TABS (+3 more)
...
Cohesion: 0.08
Nodes (37): FD_EXT_BY_MIME, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, FD_WAITING_STATUSES, fdAttachmentKind() (+29 more)
...
Cohesion: 0.08
Nodes (23): GroupTaskWorkspacePage(), WorkspaceAsync(), STAGGER, WorkspaceSkeleton(), LeadTasksAsync(), Props, CompletedTaskCursor, CompletedTaskRaw (+15 more)
...
Cohesion: 0.08
Nodes (32): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, BudgetWorkspace() (+24 more)

### Community 473 - "Community 473"
Cohesion: 0.27
Nodes (8): ToastItem, ToastType, getTypeConfig(), StandardToastItem(), ToastItem(), ToastItemProps, TypeConfig, ToastProvider()
...
Cohesion: 0.22
Nodes (9): ZohoCreditNotesTable(), ZohoLink(), zohoBooksWebUrl(), BODY, MemberZohoCards(), SHELL, TABLE_BODY, RefreshMemberFinanceButton() (+1 more)

### Community 480 - "Community 480"
Cohesion: 0.12
Nodes (16): 1. Why, in one paragraph, 2.1 `gia` (22 tables, names unchanged), 2.2 `member` (12 tables + slices, prefix dropped), 2. Target layout, 3. What the move gives us for free, and what it breaks, 4. Compatibility views: considered, not recommended, 5. Rehearsal before production (mandatory), 6.1 Window (+8 more)
...
Cohesion: 0.10
Nodes (17): LEAD_STATUS_BADGE, EscalatedLeadsSection(), GoingColdSection(), OverdueTasksSection(), RECIPIENT_META, secondaryCell, tertiaryCell, EscalationsSkeleton() (+9 more)
...
Cohesion: 0.25
Nodes (8): BooksSkeleton(), BODY, BooksPage(), canSee(), SHELL, RefreshBooksButton(), ZohoInvoicesTable(), ZohoPaymentsTable()

### Community 491 - "Community 491"
Cohesion: 0.33
Nodes (6): CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton(), CampaignsPage(), parseFilters(), CampaignFilters

### Community 492 - "Community 492"
Cohesion: 0.06
Nodes (47): BODY, BooksBankAccounts(), BooksOverviewStrip(), GRID, SHELL, AccountReportSection(), AdSpendUploadModal(), BudgetSectionHeader() (+39 more)
...
Cohesion: 0.10
Nodes (20): ElayaFeedbackCard(), PageControlsProps, ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem (+12 more)
...
Cohesion: 0.36
Nodes (5): ElayaTrainingManager(), ElayaTrainingManagerProps, ElayaTrainingPage(), getAllTrainingAssets(), TrainingAssetRow

### Community 501 - "Community 501"
Cohesion: 0.07
Nodes (33): JOURNEY_STATUSES, LEAD_STATUS_COLORS, LEAD_STATUS_LABELS, LEAD_STATUSES, RESOLUTION_STATUSES, buildStatusTimestamps(), CORE_STAGES, formatLocalDate() (+25 more)

### Community 502 - "Community 502"
Cohesion: 0.07
Nodes (36): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, updateElayaPersonaAction(), updatePersonalDetails() (+28 more)
...
Cohesion: 0.14
Nodes (10): VendorStatus, Props, VendorContact, ITALIC, resolvePoc(), STATUS_STYLE, VendorIdentityCard(), VendorInvoicesCard() (+2 more)
...
Cohesion: 0.14
Nodes (12): emptyStyle, QueendomRosterCard(), seatLabelStyle, chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTableProps (+4 more)
...
Cohesion: 0.17
Nodes (9): PaletteSearchResult, ACTION_ITEMS, CommandPalette(), CommandPaletteProps, EMPTY_RESULTS, GOTO_PAGES, hairline, kbdChipStyle (+1 more)

### Community 520 - "Community 520"
Cohesion: 0.09
Nodes (25): DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), getVendorCategoryLabel(), PortalAnchorPosition, usePortalAnchor(), UsePortalAnchorOptions, AddEditSubscriptionModal, AddSubscriptionButton() (+17 more)
...
Cohesion: 0.33
Nodes (6): TicketChangesTimeline(), TicketThread(), FreshdeskTicketPage(), signFreshdeskAttachments(), getFreshdeskTicketDetail(), Props
...
## Knowledge Gaps
- **4825 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4820 more)
...
- **Why does `createAdminClient()` connect `Community 409` to `Community 258`, `Auth & Lead Actions`, `Task Constants & UI`, `Community 133`, `Community 134`, `Community 261`, `Dashboard Widget Registry`, `Lead Mutations & Notifications`, `WhatsApp Constants & Config`, `Community 524`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Agent Performance Metrics`, `Shared Types & Props`, `Agent Performance Shell`, `Community 401`, `Campaign & Domain Filters`, `Chart Components`, `Agent Detail & Performance`, `WhatsApp Page Documentation`, `Elaya Actions Service`, `Lead Sources & Activity`, `Community 176`, `Upload & Add Modals`, `Community 442`, `Toast & Domain Utilities`, `Community 65`, `Community 460`, `Agent Usage & Presence`, `Notification Bell & Hooks`, `Community 81`, `Lead Column Preferences`, `Themes & Notifications`, `Community 228`, `Community 234`, `Community 110`, `Community 500`, `Community 502`, `Community 511`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Community 402` to `Call Outcome Charts`, `Auth & Lead Actions`, `Community 519`, `WhatsApp Constants & Config`, `Community 394`, `Lead Edit & Search`, `Community 401`, `Agent Performance Metrics`, `Community 276`, `Community 405`, `Agent Performance Shell`, `Community 409`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Chart Components`, `Deal Type Definitions`, `Audio Recorder & Notes`, `Agent Deals & Cards`, `Community 300`, `Dashboard Widget Data Hooks`, `Community 176`, `Motion & Date Utilities`, `Elaya Principal & Tools`, `Date Range Presets`, `Toast & Domain Utilities`, `Community 65`, `Community 66`, `Community 67`, `Community 203`, `Community 204`, `Agent Usage & Presence`, `Community 460`, `Notification Bell & Hooks`, `Community 464`, `Community 81`, `Ad Creatives & Campaign Pages`, `Community 471`, `Community 94`, `Community 97`, `Community 482`, `Community 228`, `Campaign Metrics & Leads UI`, `Community 361`, `Community 234`, `Community 491`, `Community 492`, `Community 123`, `Community 110`, `Community 373`, `Community 501`, `Community 251`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `getCurrentProfile` connect `Community 228` to `Community 258`, `Lead Mutations & Notifications`, `Task Constants & UI`, `Community 133`, `Community 262`, `SLA Business Hours`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Community 524`, `Lead Edit & Search`, `Dashboard Data Actions`, `Community 400`, `Community 401`, `Agent Performance Metrics`, `Community 533`, `Agent Detail & Performance`, `Elaya Actions Service`, `Deals Page Documentation`, `Dashboard Widget Data Hooks`, `Anthropic LLM Adapter`, `Toast & Domain Utilities`, `Community 65`, `Community 460`, `Community 204`, `Community 205`, `Notification Bell & Hooks`, `Community 81`, `Community 210`, `Community 471`, `Community 482`, `Campaign Metrics & Leads UI`, `Community 361`, `Community 234`, `Community 490`, `Community 491`, `Community 369`, `Community 500`, `Community 507`, `Community 123`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4934 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.0026109660574412533 - nodes in this community are weakly interconnected._
