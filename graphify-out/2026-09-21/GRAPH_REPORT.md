...
## Corpus Check
- 1343 files · ~6,107,376 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10336 nodes · 22825 edges · 548 communities (499 shown, 49 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 199 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4bb3a025`
...
## Communities (548 total, 49 thin omitted)
...
Cohesion: 0.08
Nodes (48): armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, describePolicy(), fireSlaBreachHandler(), formatSlaTimestamp(), istDateKey() (+40 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.12
Nodes (27): createGroupTaskAction(), updateChecklistAction(), updateTaskAction(), emitTaskEvent(), EmitTaskEventInput, resolveTaskDomain(), canMutateTask(), createGroupTaskCore() (+19 more)

### Community 5 - "Task Actions & Mutations"
Cohesion: 0.10
Nodes (36): createWalkInDeal(), addLeadCallNote(), addLeadNote(), bulkUpdateLeads(), cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), logSlaScheduleRejections(), refreshActivitySlaTimers() (+28 more)
...
Cohesion: 0.05
Nodes (90): requireProfile(), addReviewAction(), addVendorNoteAction(), closeEngagementAction(), createVendorAction(), deleteCapabilityAction(), getVendorDetailAction(), logEngagementAction() (+82 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.08
Nodes (26): getConversationsAction(), getMessagesAction(), dateSeparatorLabel(), LeadWhatsAppCardProps, Attachment, createClient(), WhatsAppConversation, WhatsAppMessage (+18 more)
...
Cohesion: 0.11
Nodes (26): maybeSendCustomerWelcome(), tryHandleElayaWhatsAppMessage(), getActiveProfileByPhone(), getMediaDownloadUrl(), verifyMetaSignature(), getOrCreateConversation(), insertInboundMessage(), parseWebhookPayload() (+18 more)
...
Cohesion: 0.09
Nodes (32): AgentDetailAsync(), CallerRole, OversightAgentPage(), isAppDomain(), AppDomainCallerRole, TeamDetailAsync(), AgentBreakdownGrid(), AgentOversightMetricsRow() (+24 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.06
Nodes (47): PROFILER_COST_PER_MTOK, PROFILER_MEMBER_STATUSES, DAYS, GROUPS, main(), PER_GROUP, buildWindows(), cleanName() (+39 more)
...
Cohesion: 0.06
Nodes (68): getVendor(), rankVendors(), resolveMergedVendor(), FindVendorPage(), VendorPage(), fmt(), host, line() (+60 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.03
Nodes (115): listBoardTicketsAction(), BTN, TicketBoardPage(), CLIENT_STATUSES, IntakeDismissReason, FRESHDESK_CATEGORY_TO_TICKET, resolveTicketStatusLabels(), TICKET_ACTOR_KINDS (+107 more)
...
Cohesion: 0.08
Nodes (47): getManagerRosterAction(), getAgentPulse(), getRoster(), parseFilters(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync(), AgentActivityFilter (+39 more)
...
Cohesion: 0.10
Nodes (28): clampWidgetHeight(), DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId(), MANAGER_GRID, resolveWidgetDensity() (+20 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.06
Nodes (52): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), goingColdCutoff(), REVIVAL_TRIGGER_STATUSES, Client, getGiaLinksForTasks(), getTaskIdsForLead() (+44 more)
...
Cohesion: 0.02
Nodes (172): getAssignableUsersAction(), assertAssigneeActive(), createPersonalTaskAction(), createSubtaskAction(), deleteTaskAction(), getCompletedTasksAction(), getGroupSubtasksAction(), getPersonalTaskTagsAction() (+164 more)
...
Cohesion: 0.11
Nodes (32): buildPersonaPromptBlock(), ElayaTurnEvent, ElayaTurnResult, runElayaTurn(), AFFIRMATIVE_PHRASES, AFFIRMATIVE_TOKENS, classifyConfirmation(), ConfirmationVerdict (+24 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.10
Nodes (39): getSiaHealthAction(), getSiaPairingStatusAction(), GROUP_KINDS, isIsoTimestamp(), requestSiaRepairAction(), requestSiaRestartAction(), SIA_ROLES, SiaPairingStatus (+31 more)
...
Cohesion: 0.10
Nodes (18): Fab(), MobileButtonProps, PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), DEMO_PERSONA, DEMO_REQUESTS (+10 more)
...
Cohesion: 0.09
Nodes (47): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, getElayaTimeGreeting(), pickElayaDailyLine(), ElayaStreamHandlers (+39 more)
...
Cohesion: 0.12
Nodes (23): searchMembersAction(), AddMemberFactInput, AddMemberFactSchema, AddMemberObservationInput, AddMemberObservationSchema, AddMemberPersonInput, AddMemberPersonSchema, CreateMemberInput (+15 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.11
Nodes (37): computeHealthScore(), MemberTier, MemberPage(), AddMemberButton(), MembersAsync(), MembersPage(), parseFilters(), NewUserPage() (+29 more)
...
Cohesion: 0.07
Nodes (25): WIDGET_MAP, WIDGET_SIZE_LABELS, WidgetColSpan, WidgetSize, DashboardCanvas(), DashboardCanvasProps, ResponsiveGridLayout, RGL_BREAKPOINTS (+17 more)
...
Cohesion: 0.10
Nodes (19): compareDomainDisplayOrder(), FollowUpEnginePage(), getAgentRosterByDomain(), getAllSlaPolicies(), AgentSettingsTable(), AgentSettingsTableProps, DAY_DISPLAY_ORDER, DAY_LABELS (+11 more)
...
Cohesion: 0.05
Nodes (31): BODY, GRID, SHELL, TASK_CATEGORY, BODY, daysLeft(), MemberFinanceView(), MONEY_KINDS (+23 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.13
Nodes (20): DealType, LEAD_STATUS_COLORS, MODAL_VARIANTS, Props, DealRow, Props, LeadRow, DealDrillRow() (+12 more)
...
Cohesion: 0.11
Nodes (22): collectMedia(), CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), CustomerPrincipal, ElayaPersona, LlmToolDefinition (+14 more)
...
Cohesion: 0.06
Nodes (40): MCP_CHANNEL, MCP_RATE_LIMIT, MCP_RESOURCE_URIS, MCP_ROLES, MCP_SERVER_INFO, McpIdentity, readClientId(), verifyMcpBearer() (+32 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.06
Nodes (37): FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal(), AgentDetailPanel(), CallOutcomeBar (+29 more)
...
Cohesion: 0.04
Nodes (95): getSiaGroupsAction(), fdStatusLabel(), canAccessLead(), activityKnown(), canAskAboutVendors(), clip(), describeDatabaseFor(), exportRowsFor() (+87 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (34): JOURNEY_STATUSES, LEAD_STATUS_LABELS, LEAD_STATUSES, RESOLUTION_STATUSES, LeadActivitiesAsync(), Props, formatTimestamp(), LeadActivityLog() (+26 more)

### Community 66 - "Community 66"
Cohesion: 0.11
Nodes (21): CAPABILITY_STANCE_DEF, ENGAGEMENT_OUTCOME_DEF, getVendorCategoryLabel(), INDULGE_OWN_ENTITIES, PREFERENCE_STANCE_DEF, REQUEST_CATEGORY_DEF, RequestCategory, SERVICES_BY_REQUEST_CATEGORY (+13 more)

### Community 67 - "Community 67"
Cohesion: 0.13
Nodes (21): notifyDealCreated(), CustomerTurnInput, resolveCustomerPrincipal(), BriefingOutcome, BriefingSlot, inr(), plainBriefing(), runBriefingSweep() (+13 more)

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (25): DASHBOARD_WIDGETS, AddWidgetMenu(), PortalAnchorPosition, usePortalAnchor(), UsePortalAnchorOptions, AddEditSubscriptionModal, AddSubscriptionButton(), LogTopupModal (+17 more)
...
Cohesion: 0.05
Nodes (46): TASK_STATUS_DEF, TASK_TYPE_DEF, AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions (+38 more)
...
Cohesion: 0.08
Nodes (30): INTAKE_ACK_WORDS, INTAKE_DISMISS_REASONS, INTAKE_KINDS, INTAKE_MEMBER_STATUSES, INTAKE_TONES, IntakeKind, TICKET_TERMINAL_STATUSES, isProviderSide() (+22 more)
...
Cohesion: 0.06
Nodes (46): statusLabel(), resolvePendingAction(), ElayaActionPayload, ElayaActionTarget, ElayaActionType, ElayaLeadTarget, ElayaTaskTarget, ElayaTicketTarget (+38 more)
...
Cohesion: 0.03
Nodes (142): Props, ANTICIPATION_KINDS, CLIENT_EVENT_KINDS, CLIENT_FACETS, CLIENT_TIERS, ESSENTIAL_FACETS, FACT_KEY_LABELS, FACT_SOURCES (+134 more)
...
Cohesion: 0.17
Nodes (18): REVIEW_DIMENSION_LABELS, REVIEW_DIMENSIONS, ReviewDimension, SCORE_WEIGHTS, ScoreComponent, HINT, VendorReviewForm(), VendorScore (+10 more)
...
Cohesion: 0.09
Nodes (27): FD_EXT_BY_MIME, FD_MOMENT_FIELDS, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, FD_WAITING_STATUSES (+19 more)
...
Cohesion: 0.10
Nodes (24): getServiceCategoryLabel(), SERVICE_CATEGORY_DEF, ServiceCategory, ServiceInterest, AddSuggestionModalProps, CaseCard(), CaseListRow(), CaseListRowProps (+16 more)

### Community 93 - "Revival Service & Policies"
Cohesion: 0.06
Nodes (51): listAgentsForDealDomain(), AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), CampaignAdPanel(), CampaignListAsync(), CampaignListAsyncProps, CampaignMetricsStripSkeleton() (+43 more)
...
Cohesion: 0.22
Nodes (13): getElayaChatSeedAction(), ElayaChatShell(), Props, ElayaMessageBubble(), ElayaUiMessage, ElayaChatShell, EmbeddedElayaChat(), loadElayaChatShell() (+5 more)
...
Cohesion: 0.08
Nodes (40): assertLeadFieldEditAccess(), BulkUpdateResult, createLeadTaskAction(), ExportPayload, LeadEditContext, revalidateLeadDossier(), updateLeadCity(), updateLeadDomain() (+32 more)
...
Cohesion: 0.07
Nodes (41): ActivityCursorSchema, AgentSelfMetrics, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction() (+33 more)
...
Cohesion: 0.08
Nodes (50): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getAgentTasksSummaryAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction() (+42 more)
...
Cohesion: 0.18
Nodes (9): getServiceLabel(), AMBIGUOUS_CITIES, CATEGORY_WORDS, host, main(), Parsed, parseRequest(), PHRASES (+1 more)
...
Cohesion: 0.06
Nodes (47): deleteNote(), upsertNote(), updatePersonalDetails(), answerOAuthConsentAction(), consentSchema, revokeConnectedAppAction(), signOutUser(), addTaskRemarkAction() (+39 more)
...
Cohesion: 0.10
Nodes (24): fdComparable(), listConversations(), BackfillState, CHOICE_FIELD_TYPES, ContactsState, customStr(), diffTicket(), FdCycleSummary (+16 more)
...
Cohesion: 0.20
Nodes (14): adaptGoogle(), adaptMeta(), adaptShopApp(), adaptWebsite(), LeadSource, META_COLUMN_KEYS, NormalizedLeadPayload, normalizePhone() (+6 more)
...
Cohesion: 0.12
Nodes (34): createZbBudget(), getArAgingSummary(), getContact(), getInvoiceDashboard(), getOrganization(), getProfitAndLoss(), InvoiceListFilter, listBankAccounts() (+26 more)
...
Cohesion: 0.03
Nodes (89): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), refreshBooksOverviewAction(), refreshMemberFinanceAction(), RefreshMemberFinanceSchema, recordDeal(), deleteTrainingAsset() (+81 more)

### Community 177 - "Community 177"
Cohesion: 0.11
Nodes (9): ElayaLoading(), ErrorLogTableSkeleton(), EscalationsSkeleton(), COL_WIDTHS, MemberZohoSkeleton(), ProfileLoading(), SectionCardSkeleton(), Shimmer() (+1 more)
...
Cohesion: 0.05
Nodes (69): ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, getSiaGroupInfoAction(), getSiaMediaAction(), getSiaMessagesAction(), isGroupJid(), requireSiaViewer() (+61 more)
...
Cohesion: 0.05
Nodes (68): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTableProps, EASE_IN_OUT, SPRING_CONFIG, SiaGroupKind (+60 more)

### Community 203 - "Community 203"
Cohesion: 0.10
Nodes (16): CurrencyAmount(), SubscriptionStatusPill(), addDaysISO(), cardStyle, dueRow, pad2(), resetBtn, SubOccurrence (+8 more)
...
Cohesion: 0.06
Nodes (34): AdCreativeFormModal(), AdCreativeFormModalProps, chevronStyle, inputBase, selectBase, actionBtnStyle, AdCreativesManagerProps, CARD_HOVER (+26 more)

### Community 206 - "Community 206"
Cohesion: 0.04
Nodes (70): useBudgetTab(), BudgetFilterBar(), TABS, DROPDOWN_VARIANTS_UP, EASE_IN_EXPO, EASE_SPRING, FADE_VARIANTS, ROW_VARIANTS (+62 more)
...
Cohesion: 0.14
Nodes (18): FRESHDESK_ROLES, runFreshdeskSyncNow(), SyncNowResult, anyTicket, APPLY, creationRule, main(), SITE (+10 more)
...
Cohesion: 0.08
Nodes (33): exportLeadsAction(), ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, ExportButtonProps, ExportFormat, ExportModal() (+25 more)
...
Cohesion: 0.19
Nodes (8): PreferenceStance, VendorAgentPreferenceWithAgent, VendorDetail, StarRating(), STANCE_STYLE, VendorPreferenceControl(), VendorScoreCard(), VendorScoreRing()

### Community 228 - "Community 228"
Cohesion: 0.16
Nodes (10): toolStatusLabel(), ElayaStatusText(), IconKnob(), DEMO_CHAT, DEMO_CHAT_SUGGESTIONS, DemoChatMessage, ElayaChatScreenProps, Block (+2 more)
...
Cohesion: 0.04
Nodes (72): ElayaTrainingManager(), QueendomRosterCard(), UsersTable(), BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), BudgetPage() (+64 more)
...
Cohesion: 0.06
Nodes (55): BooksOverviewStrip(), AccountReportSection(), AdSpendUploadModal(), BudgetAsync(), Props, BudgetEmptyState(), BudgetSectionHeader(), SectionHeaderDatum() (+47 more)
...
Cohesion: 0.33
Nodes (5): FreshdeskOverview(), FreshdeskOverviewSkeleton(), SyncLine(), TILE_GRID, FdOverview

### Community 259 - "Community 259"
Cohesion: 0.13
Nodes (14): SpendingOverview, ContentProps, getMulti(), getStr(), SubscriptionsPage(), BarChart, cardStyle, SpendDonut (+6 more)
...
Cohesion: 0.14
Nodes (19): INVOICE_ACCEPT_MIME, Props, ERROR_TEXT_STYLE, FIELD_LABEL_STYLE, HELP_TEXT_STYLE, INPUT_STYLE, todayIso(), attachedStyle (+11 more)

### Community 262 - "Community 262"
Cohesion: 0.06
Nodes (82): actorFromProfile(), addMemberFactAction(), addMemberObservationAction(), addMemberPersonAction(), adjustMemberHealthAction(), createMemberAction(), deleteMemberPersonAction(), gate() (+74 more)
...
Cohesion: 0.06
Nodes (48): CampaignFilters(), CampaignFiltersProps, GIA_DOMAIN_FILTER_ITEMS, SUBSCRIPTION_DEPARTMENT_OPTIONS, CATEGORY_DOMAIN, DealsFilters(), DealsFiltersProps, FreshdeskFilters() (+40 more)
...
Cohesion: 0.03
Nodes (84): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, createUser(), inviteUser(), isSeatTaken(), mapProfileError(), toggleUserActive() (+76 more)
...
Cohesion: 0.14
Nodes (14): 2026-05-28 — OS Tasks: service + action layer, 2026-05-28 — Task Modal + Chat Panel (Prompt 3), 2026-05-28 — Tasks Page (Personal + Group tabs), Contracts established, Contracts established, Modified files, New files, New files (+6 more)
...
Cohesion: 0.09
Nodes (32): getAgentUsageAction(), recordPresenceAction(), ClientAppLayout(), WorkspaceAsyncProps, MobileSession, MobileSessionContext, MobileSessionProvider(), getGroupTasks (+24 more)
...
Cohesion: 0.05
Nodes (78): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), metadata, MobileActivityPage() (+70 more)
...
Cohesion: 0.16
Nodes (16): BridgeBody, LEGACY_TOOL_NAMES, POST(), FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), BRIDGED_READ_TOOL_NAMES (+8 more)
...
Cohesion: 0.13
Nodes (13): FLIP_UP_TRANSFORM_TEMPLATE(), loadCsv(), DEFAULT_STATE, displayLabel(), HOURS, MINUTES, parse(), TimePicker() (+5 more)

### Community 401 - "Community 401"
Cohesion: 0.07
Nodes (27): CreateUserForm(), CreateUserMode, iconStyle, MODE_TABS, NewUserClient(), SPRING_TAB, FormStatus, PasswordChangeForm() (+19 more)

### Community 402 - "Community 402"
Cohesion: 0.13
Nodes (17): buildSituations(), CreateRuleDraft, CreateRuleForm(), HOURS_MODE_OPTIONS, RECIPIENT_LABELS, RECIPIENT_OPTIONS, RECIPIENT_VERB, SituationCard (+9 more)
...
Cohesion: 0.13
Nodes (11): LEAD_STATUS_BADGE, RECIPIENT_META, secondaryCell, tertiaryCell, EscalatedLeadRow, GoingColdLeadRow, OverdueTaskEscalationRow, SlaRecipientRole (+3 more)
...
Cohesion: 0.15
Nodes (14): CURRENCY_SYMBOLS, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_STATUS_CONFIG, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionCurrency (+6 more)
...
Cohesion: 0.19
Nodes (14): LeadWhatsAppCard(), LeadWhatsAppCardAsync(), Props, applyLastMessagePeriodFilter(), attachUnreadCounts(), getConversationByLeadId(), getConversations(), getLeadWhatsAppThreadForElaya() (+6 more)
...
Cohesion: 0.10
Nodes (25): searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, WHATSAPP_API_BASE, WHATSAPP_API_VERSION, WHATSAPP_CONVERSATION_STATUS (+17 more)
...
Cohesion: 0.06
Nodes (31): recordDeal(), JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, LeadDossierPage(), CalledModal(), DynamicFormResponses(), Props (+23 more)
...
Cohesion: 0.09
Nodes (16): getDomainInterests(), getLeadSourceLabel(), getMetaMediumLabel(), DROPDOWN_VARIANTS, SourcePill(), describeActivity(), Agent, InterestsInlineField() (+8 more)

### Community 468 - "Community 468"
Cohesion: 0.22
Nodes (11): fdAttachmentExt(), fdAttachmentKind(), CHIP, FreshdeskAttachments(), copyMedia(), extractInlineImages(), safeName(), storeFreshdeskFile() (+3 more)
...
Cohesion: 0.07
Nodes (36): FormNotice(), FormNoticeProps, TONES, FieldProps, initialState, ProfileDetailsForm(), Props, stripCountryCode() (+28 more)

### Community 473 - "Community 473"
Cohesion: 0.15
Nodes (16): getPasswordReveals(), getSpendingOverview(), getSubscriptionDetail(), getSubscriptionMonthlyReport(), getSubscriptions(), getSubscriptionsWith(), groupBy(), lastTwelveMonths() (+8 more)

### Community 474 - "Community 474"
Cohesion: 0.15
Nodes (16): AppearanceKey, applyAppearanceToDom(), DEF, persistAppearanceCookie(), resolvesDark(), systemPrefersDark(), CALL_OUTCOME_DEF, defineEnum() (+8 more)
...
Cohesion: 0.14
Nodes (17): markAllReadAction(), markNotificationReadAction(), useNotifications(), useNotificationSound(), NotificationsContext, NotificationsProvider(), NotificationsProviderProps, useNotificationsContext() (+9 more)
...
Cohesion: 0.09
Nodes (25): loadTicketRow(), suggestTicketVendorsAction(), useDebounce(), TicketVendorOption, SiaWorkspace(), BODY, SHELL, TicketVendorCard() (+17 more)
...
Cohesion: 0.17
Nodes (7): getRequestCategoryLabel(), RankedVendor, AMBIGUOUS_CITIES, CATEGORY_WORDS, FindVendorPanel(), Parsed, SERVICE_WORDS

### Community 492 - "Community 492"
Cohesion: 0.51
Nodes (8): generateMetadata(), buildManifest(), manifest(), iconSrc(), isIconKey(), isAppearanceKey(), DashboardLayout(), GET()

### Community 493 - "Community 493"
Cohesion: 0.23
Nodes (12): BooksAsync(), getBooksFor(), assertRoom(), env(), getToken(), isZohoConfigured(), refreshToken(), refreshTokenNow() (+4 more)

### Community 494 - "Community 494"
Cohesion: 0.07
Nodes (30): FdAutomationRule, FdAutomationType, FdBudget, FdBudgetExhausted, FdRequestError, FdResponse, getTicket(), getTicketField() (+22 more)

### Community 495 - "Community 495"
Cohesion: 0.11
Nodes (15): DETAILS_FIELD, inputStyle, JSONB_FIELD_KEYS, JSONB_GRID_FIELDS, labelStyle, PersonalDetailsCard(), Props, readValueStyle() (+7 more)

### Community 496 - "Community 496"
Cohesion: 0.07
Nodes (34): DEAL_CATEGORY_DEF, DEAL_DURATION_DEF, DEAL_TYPE_DEF, DealCategory, DealDuration, DealShape, DealShapeInput, dealTypeForDomain() (+26 more)
...
Cohesion: 0.22
Nodes (9): EMPTY, PaletteDealHit, PaletteLeadHit, paletteSearchAction(), PaletteSearchResult, PaletteTaskHit, getPersonalTasksAction(), getPersonalTasks() (+1 more)

### Community 504 - "Community 504"
Cohesion: 0.21
Nodes (6): MembersTableSkeleton(), TicketsTableSkeleton(), FilterBarSkeletonProps, PageHeaderSkeletonProps, ShimmerProps, SkeletonCardProps
...
Cohesion: 0.24
Nodes (6): ElayaWidget(), AppBootScreen(), IconInitializer(), INTERACTION_EVENTS, UsagePresence(), ToastProvider()
...
Cohesion: 0.08
Nodes (24): getDomainHealthMetricsAction(), upsertDomainTargetAction(), Props, Props, DomainDealsDrillModal(), Props, DomainDrillKind, DomainLeadsDrillModal() (+16 more)
...
Cohesion: 0.15
Nodes (13): REDIS_TTL, getHelpdeskCases(), getHelpdeskHooks(), ServiceInterestCard(), Props, ServiceInterestCardAsync(), redis, ConversationHookRow (+5 more)
...
Cohesion: 0.22
Nodes (7): LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS, SHOP_ENQUIRY_TYPES, ShopEnquiryType
...
Cohesion: 0.15
Nodes (29): FD_SYNC_KEYS, CALLS, main(), MEDIA, MINUTES, POLL, pollLoop(), sleep() (+21 more)

### Community 534 - "Community 534"
Cohesion: 0.08
Nodes (28): CardBody(), cardStyle, DealCard(), DealCardProps, useWonCelebration(), DealsAsync(), DealsAsyncProps, DealsSummary (+20 more)

### Community 536 - "Community 536"
Cohesion: 0.10
Nodes (19): CapabilityStance, EngagementOutcome, VendorCategorySource, VendorIdentityStatus, VendorSource, VendorAgentPreferenceRow, VendorAgentUsage, VendorCapabilityRow (+11 more)
...
Cohesion: 0.17
Nodes (10): DEF, IconKey, persistAppIconCookie(), Props, IconSelector(), Props, BeforeInstallPromptEvent, InstallPrompt() (+2 more)
...
Cohesion: 0.21
Nodes (8): generateViewport(), inter, playfairDisplay, RootLayout(), isThemeKey(), loadFeatures(), MotionProvider(), ServiceWorkerRegistration()
...
Cohesion: 0.07
Nodes (53): EASE_OUT_SOFT, ALWAYS_ALLOWED_PREFIXES, DOMAIN_NAV_HIDDEN, DOMAIN_ROUTE_MAP, FOUNDER_NAV_PREFIXES, WORKBENCH_BLOCKED_PREFIXES, WORKBENCH_DOMAINS, metadata (+45 more)

## Knowledge Gaps
- **5052 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+5047 more)
...
- **Why does `createAdminClient()` connect `Community 179` to `SLA Business Hours`, `Auth & Lead Actions`, `Task Actions & Mutations`, `Task Constants & UI`, `Community 262`, `Ad Spend & Campaign Mapping`, `Community 134`, `Community 394`, `WhatsApp Constants & Config`, `Lead Edit & Search`, `Page Skeletons & Flags`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Community 533`, `Community 534`, `Agent Performance Shell`, `Service Interests & Cases`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Audio Recorder & Notes`, `Agent Detail & Performance`, `Elaya Actions Service`, `Lead Sources & Activity`, `Community 300`, `Dashboard Widget Data Hooks`, `Community 176`, `Community 566`, `Anthropic LLM Adapter`, `Community 442`, `Performance Scorecards & Drills`, `Toast & Domain Utilities`, `Community 67`, `Community 458`, `Agent Usage & Presence`, `Notification Bell & Hooks`, `Community 468`, `Community 471`, `Community 473`, `Revival Service & Policies`, `Community 478`, `Community 488`, `Community 234`, `Community 107`, `Community 363`, `Community 110`, `Community 373`, `Profiles Data Model`, `Gia Lead Lifecycle Docs`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `requireProfile()` connect `Ad Spend & Campaign Mapping` to `Lead Mutations & Notifications`, `SLA Business Hours`, `Task Constants & UI`, `Task Actions & Mutations`, `Community 262`, `Community 519`, `Dashboard Widget Registry`, `Ad Creative UI Components`, `Task Summary & SLA Policies`, `Agent Performance Shell`, `Service Interests & Cases`, `Settings Page Documentation`, `Community 549`, `WhatsApp Page Documentation`, `Lead Sources & Activity`, `Community 300`, `Community 176`, `Community 179`, `Toast & Domain Utilities`, `Community 460`, `Community 210`, `Community 213`, `Revival Service & Policies`, `Community 479`, `Community 97`, `Community 234`, `Community 107`, `Community 363`, `Community 110`, `Community 370`, `Tasks Page Docs`, `Community 373`, `Profiles Data Model`, `Community 502`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `UserRole` connect `Community 363` to `Lead Mutations & Notifications`, `Task Actions & Mutations`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Lead Edit & Search`, `Community 276`, `Shared Types & Props`, `Community 534`, `Service Interests & Cases`, `Chart Components`, `Community 549`, `Agent Deals & Cards`, `Community 300`, `Dashboard Widget Data Hooks`, `Community 176`, `Community 179`, `Community 566`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Community 68`, `Community 70`, `Community 206`, `Notification Bell & Hooks`, `Community 213`, `Revival Service & Policies`, `Community 488`, `Community 234`, `Community 496`, `Community 498`, `Community 500`, `Community 373`, `Profiles Data Model`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _5165 weakly-connected nodes found - possible documentation gaps or missing edges._
