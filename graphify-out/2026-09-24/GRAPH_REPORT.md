# Graph Report - serene  (2026-09-24)

## Corpus Check
- 2018 files · ~6,711,810 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14839 nodes · 33614 edges · 647 communities (578 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 325 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1b820faa`
...
1. `Serene — Changelog` - 859 edges
2. `createAdminClient()` - 385 edges
3. `useTheme()` - 327 edges
4. `requireProfile()` - 190 edges
5. `Serene — Design DNA` - 160 edges
6. `giaDb()` - 151 edges
7. `Button` - 150 edges
8. `createClient()` - 147 edges
9. `AccessTokenPayload` - 144 edges
10. `AppDomain` - 136 edges

## Surprising Connections (you probably didn't know these)
- `ShopSpotlightsDialog()` --calls--> `useMediaQuery()`  [INFERRED]
  indulge-app-example/admin-panel/src/features/content/ShopSpotlightsDialog.tsx → src/hooks/useMediaQuery.ts
- `ImagePickerDialog()` --calls--> `useMediaQuery()`  [INFERRED]
  indulge-app-example/admin-panel/src/features/notifications/ImagePickerDialog.tsx → src/hooks/useMediaQuery.ts
- `MemberPickerDialog()` --calls--> `useMediaQuery()`  [INFERRED]
  indulge-app-example/admin-panel/src/features/notifications/MemberPickerDialog.tsx → src/hooks/useMediaQuery.ts
- `ProductPickerDialog()` --calls--> `useMediaQuery()`  [INFERRED]
  indulge-app-example/admin-panel/src/features/notifications/ProductPickerDialog.tsx → src/hooks/useMediaQuery.ts
- `DrillDialog()` --calls--> `useMediaQuery()`  [INFERRED]
  indulge-app-example/admin-panel/src/features/overview/DrillDialog.tsx → src/hooks/useMediaQuery.ts
...
Cohesion: 0.04
Nodes (90): addLeadCallNote(), armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), describePolicy() (+82 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.03
Nodes (153): AnimatedCircle, playedRings, ProgressRing(), Props, AlertAction, AlertActionKind, AlertDialog(), AmbientImage() (+145 more)

### Community 5 - "Task Actions & Mutations"
Cohesion: 0.10
Nodes (26): ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, ExportButton(), ExportButtonProps, BulkEditLeadsModal, LeadsSelectionToolbar() (+18 more)
...
Cohesion: 0.05
Nodes (74): mergeError(), VENDOR_STATUS_ROLES, VendorSource, writeFinding(), addReviewCore(), addVendorNoteCore(), AdminClient, CapabilityProvenance (+66 more)
...
Cohesion: 0.16
Nodes (16): FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), verifyMetaSignature(), parseWebhookPayload(), MetaMediaObject, createRateLimiter() (+8 more)
...
Cohesion: 0.11
Nodes (25): AgentDetailAsync(), AppDomainCallerRole, TeamDetailAsync(), AgentBreakdownGrid(), TeamOverviewAsync(), AgentTaskRpcRow, BreakdownRpcRow, CLOSED_STATUSES (+17 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.04
Nodes (79): DONE, PROFILER_COST_PER_MTOK, PROFILER_MEMBER_STATUSES, INTAKE_ACK_WORDS, INTAKE_DISMISS_REASONS, INTAKE_KINDS, INTAKE_MEMBER_STATUSES, INTAKE_TONES (+71 more)
...
Cohesion: 0.02
Nodes (138): CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, getRequestCategoryLabel(), getServiceLabel(), INDULGE_OWN_ENTITIES, PREFERENCE_STANCE_DEF, PreferenceStance (+130 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.03
Nodes (103): listBoardTicketsAction(), FRESHDESK_CATEGORY_TO_TICKET, resolveTicketStatusLabels(), TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BOARD_STATUSES, TICKET_BRIEF_FIELD_LABELS, TICKET_BRIEF_FIELDS (+95 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.07
Nodes (65): addTaskRemarkAction(), initiateWhatsAppConversationAction(), isNotificationCategoryKey(), require, createLeadTaskCore(), reviveLeadCore(), addHealthSignalCore(), HealthSignalInput (+57 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.04
Nodes (85): ActivityCursorSchema, AgentSelfMetrics, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction() (+77 more)
...
Cohesion: 0.02
Nodes (88): demoPhones(), Coupon, COUPON_SCOPES, COUPON_TYPES, CouponDocument, CouponSchema, CouponScope, CouponType (+80 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.04
Nodes (84): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), recordDeal(), updateLeadStatus(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF (+76 more)
...
Cohesion: 0.02
Nodes (197): assertAssigneeActive(), createPersonalTaskAction(), createSubtaskAction(), deleteGroupTaskAction(), deleteTaskAction(), getCompletedTasksAction(), getGroupSubtasksAction(), getPersonalTasksAction() (+189 more)
...
Cohesion: 0.11
Nodes (35): AsyncAnthropic, StaffPrincipal, Any, CompleteRequest, CompleteResult, CompleteRequest, CompleteResult, _cap() (+27 more)
...
Cohesion: 0.03
Nodes (71): inviteUser(), isSeatTaken(), mapProfileError(), updateProfile(), updateProfileAvatar(), updateUserAuthorization(), CreateUserForm(), CreateUserFormProps (+63 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.04
Nodes (112): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+104 more)
...
Cohesion: 0.03
Nodes (57): ELAYA_VERIFIED_METRICS, ElayaMetric, verifiedMetricsBlock(), hideTestLeads(), ALL_TOOLS, describeDatabase, ElayaReadToolName, ElayaTool (+49 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.11
Nodes (13): FilterChip(), MobileSegmented(), MobileStepper(), MobileToggle(), SettingRow(), DEMO_PERSONA, FIELD_CHROME, MobileTextArea() (+5 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.03
Nodes (84): resolveMediaUrl(), connectApi, ConnectCard, ConnectFeed, ConnectMatchRow, HospitalityMode, PickedPhoto, SwipeResult (+76 more)
...
Cohesion: 0.10
Nodes (50): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, getElayaTimeGreeting(), pickElayaDailyLine(), metadata (+42 more)
...
Cohesion: 0.03
Nodes (89): AGENT_RUN_SOURCES, AGENT_RUN_STATUSES, AgentRun, AgentRunDocument, AgentRunSchema, AgentRunSource, AgentRunStatus, AdminAgentsController (+81 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.08
Nodes (58): draftFieldsChanged(), BTN, TicketBoardPage(), computeHealthScore(), IntakeDismissReason, getFreshdeskTicketsForMember(), decorate(), getIntakeStats() (+50 more)
...
Cohesion: 0.08
Nodes (32): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction(), getLeadVolumeForDomainAction() (+24 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.03
Nodes (105): BucketRoute(), Index(), RequestsRoute(), WalletRoute(), NameGate(), PhoneScreen(), isMember(), isNonMember() (+97 more)
...
Cohesion: 0.06
Nodes (47): FACT_POLARITIES, FactPolarity, RELATION_KINDS, isOwnEntity(), clip(), getLeadNotes(), maskPii(), maskString() (+39 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.02
Nodes (36): approximateRoot(), asRGBA(), calcAngularFreq(), checkVariantsDidChange(), composeRefs(), ConfirmDialog(), createProjectionNode(), Dialog() (+28 more)
...
Cohesion: 0.04
Nodes (51): AdminSupportController, ConciergeController, contactCacheKey(), SupportQueryDto, ActiveTicket, BUSINESS_LABEL_MAP, categoryOf(), computeStats() (+43 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.04
Nodes (92): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), getDomainHealthMetricsAction(), metadata (+84 more)
...
Cohesion: 0.06
Nodes (53): AdCreativesPage(), EMPTY_FILTERS, AdCreativesManager(), EASE_OUT_SOFT, ALWAYS_ALLOWED_PREFIXES, DOMAIN_NAV_HIDDEN, DOMAIN_ROUTE_MAP, FOUNDER_NAV_PREFIXES (+45 more)
...
Cohesion: 0.11
Nodes (18): Concierge, Elia — The Central Hub, Finance — How Elia Helps, Prototype Snapshots, Shop — How Elia Helps, Step 1 — Client Messages, Step 2 — Elia Chatbot Replies, Step 3 — Ticket Auto-Created in Freshdesk (+10 more)
...
Cohesion: 0.04
Nodes (63): AdminMembersModule, AdminAuditController, AuditQueryDto, AuditLog, AuditLogDocument, AuditLogSchema, AuditModule, AuthModule (+55 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.08
Nodes (42): BridgeBody, LEGACY_TOOL_NAMES, POST(), buildPersonaPromptBlock(), ElayaTurnEvent, ElayaTurnResult, runElayaTurn(), AFFIRMATIVE_PHRASES (+34 more)
...
Cohesion: 0.06
Nodes (43): MCP_CHANNEL, MCP_RATE_LIMIT, MCP_RESOURCE_URIS, MCP_ROLES, MCP_SERVER_INFO, McpIdentity, readClientId(), verifyMcpBearer() (+35 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.06
Nodes (44): getAgentDetailMetricsAction(), getAgentLeadsByPredicateAction(), FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), AgentDealsDrillModal() (+36 more)
...
Cohesion: 0.08
Nodes (44): SIA_ALERT_TIER1_PROFILE_IDS, admin(), Alert, AlertSweepResult, deliverToTech(), Founder, inActiveHours(), readState() (+36 more)

### Community 64 - "Toast & Domain Utilities"
Cohesion: 0.04
Nodes (87): canAccessLead(), activityKnown(), buildSearchWords(), canAskAboutVendors(), describeDatabaseFor(), exportRowsFor(), findMembersFor(), findMembersScopedFor() (+79 more)

### Community 65 - "Community 65"
Cohesion: 0.07
Nodes (37): updatePersonalDetails(), ADMIN_ROLES, createRechargeAction(), CreateRechargeResult, messageForIssue(), getShopEnquiryTypeLabel(), LEAD_SOURCE_DEF, META_MEDIUM_LABELS (+29 more)
...
Cohesion: 0.08
Nodes (20): escapeRegExp(), LegacyAuditController, LegacySummaryQueryDto, ListLegacyCardsQueryDto, LegacyAuditModule, image(), LegacyAuditService, LegacyKind (+12 more)

### Community 68 - "Community 68"
Cohesion: 0.09
Nodes (34): ALERT_ACTIVE_HOURS_IST, ALERT_KINDS, ELAYA_JOB_KINDS, ELAYA_JOB_STATUSES, ELAYA_LABEL_SUBJECTS, ElayaAlertKind, ElayaJobKind, ElayaJobStatus (+26 more)
...
Cohesion: 0.03
Nodes (22): AuthController, AccessTokenPayload, isDemoPhone(), AdminBucketOverviewController, BucketController, AdminChatroomsController, ChatroomsController, paginate() (+14 more)
...
Cohesion: 0.09
Nodes (35): OverviewAsync(), TicketsAsync(), applyTicketFilters(), getFreshdeskOverview(), getFreshdeskSyncHealth(), getNameMaps(), getRecentFreshdeskRuns(), hasFreshdeskFilters() (+27 more)
...
Cohesion: 0.08
Nodes (26): getAgentUsageAction(), recordPresenceAction(), ChartSkeleton(), ChartSkeletonProps, INTERACTION_EVENTS, UsagePresence(), BenchmarkLine, CardConfig (+18 more)
...
Cohesion: 0.02
Nodes (105): api, axiosBaseQuery(), QueryArgs, http, RefreshOutcome, registerSessionHandlers(), session, SessionHandlers (+97 more)

### Community 82 - "Lead Column Preferences"
Cohesion: 0.21
Nodes (9): defineEnum(), EnumDef, SERVICE_CATEGORY_DEF, ServiceInterest, DEF, persistThemeCookie(), ThemeKey, Props (+1 more)
...
Cohesion: 0.09
Nodes (25): AppUsageCard(), CONTENT_KINDS, Entities, entityColumns, EntityRow, InsightsPage(), screenColumns, ScreenRow (+17 more)
...
Cohesion: 0.09
Nodes (32): FD_EXT_BY_MIME, FD_MOMENT_FIELDS, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, FD_WAITING_STATUSES (+24 more)
...
Cohesion: 0.07
Nodes (39): getHelpdeskLibraryAction(), HelpdeskDomainSchema, invalidateHelpdeskCache(), resolveHelpdeskDomain(), upsertServiceCaseAction(), getServiceCategoryLabel(), ServiceCategory, getHelpdeskCases() (+31 more)

### Community 93 - "Revival Service & Policies"
Cohesion: 0.04
Nodes (68): AgentInfo, AgentRun, AgentsPage(), exportColumns, STATUS_META, api, AuditPage(), AuditResponse (+60 more)

### Community 94 - "Community 94"
Cohesion: 0.10
Nodes (33): addValue(), addValueToWillChange(), animateChildren(), animateTarget(), animateVariant(), animateVisualElement(), bindToMotionValue(), calcChildStagger() (+25 more)
...
Cohesion: 0.05
Nodes (65): DrawRing(), useSharedElementSettled(), Dot(), useAmbientGate(), CategoryScreen(), ProductDetailScreen(), PulseDot(), SpecRow() (+57 more)
...
Cohesion: 0.09
Nodes (25): anyTicket, APPLY, creationRule, main(), SITE, siteArgIdx, updateRule, apiKey() (+17 more)
...
Cohesion: 0.12
Nodes (16): Adding a new domain, Adding a new route to a domain, canAccessRoute + Sidebar filtering, Check order inside `canAccessRoute`, Domain selector → `param ?? cookie` (the navigation-persistence fix), Files, Floating Elaya widget — `src/components/elaya/ElayaWidget.tsx` (mounted in the dashboard layout), Layout Components — CLAUDE.md (+8 more)
...
Cohesion: 0.05
Nodes (56): ChatMembership, ChatMembershipDocument, ChatMembershipSchema, ChatMessage, ChatMessageDocument, ChatMessageSchema, Chatroom, ChatroomDocument (+48 more)
...
Cohesion: 0.04
Nodes (95): addLeadNote(), assertLeadFieldEditAccess(), assignLead(), bulkUpdateLeads(), BulkUpdateResult, createManualLead(), ExportPayload, LeadEditContext (+87 more)
...
Cohesion: 0.08
Nodes (27): calcGeneratorDuration(), complete(), constructor(), createAnimateFunction(), createAnimationState(), createGeneratorEasing(), createState(), createTypeState() (+19 more)
...
Cohesion: 0.08
Nodes (35): buildLeadListKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS, REDIS_TTL, SIA_ALERT_KINDS, redis, withRedisCache(), bucketKey() (+27 more)
...
Cohesion: 0.11
Nodes (35): datetime, Any, _iso(), ist_midnight(), period_range(), IST-anchored period ranges — the Python twin of getPeriodDateRange (performance-, The UTC instant of today's 00:00 IST., → (from_iso, to_iso), IST-anchored exactly like the Node resolver. (+27 more)
...
Cohesion: 0.11
Nodes (24): AgentDistributionBar(), AgentDistributionBarProps, SEGMENT_COLORS, CampaignCard(), CampaignCardProps, DOT_COLOR, MotionLink, StatusDatum() (+16 more)
...
Cohesion: 0.04
Nodes (97): ROLES, loadTicketRow(), suggestTicketVendorsAction(), ticketQueendom(), canTransition(), checklistForCategory(), SENTINEL_WARN_BEFORE_MIN, TICKET_ACTIVE_STATUSES (+89 more)
...
Cohesion: 0.06
Nodes (41): BarChart(), BarChartProps, BarChartSeries, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartTokens (+33 more)
...
Cohesion: 0.04
Nodes (68): API_BASE, mediaSrc(), ConnectCard(), createProduct(), createTag(), deleteProduct(), deleteTag(), getProduct() (+60 more)
...
Cohesion: 0.13
Nodes (18): setAgentShiftAction(), toggleAgentRouting(), toggleRoutingSchema, toggleUserActive(), Props, UserStatusControls(), metadata, MobileAgentTasksPage() (+10 more)

### Community 134 - "Community 134"
Cohesion: 0.02
Nodes (80): AdminListWishesQueryDto, PaginationQueryDto, ListConnectProfilesDto, CreateProductDto, ListProductsQueryDto, MediaRefDto, PriceDto, ShelvesQueryDto (+72 more)
...
Cohesion: 0.08
Nodes (36): ActiveTicket, conciergeApi, DashboardResponse, HistoryTicket, DESK_NOTICES, DeskNotice(), EMPTY_LINES, Props (+28 more)
...
Cohesion: 0.05
Nodes (71): BooksBankAccounts(), BooksSkeleton(), BODY, BooksAsync(), BooksPage(), canSee(), SHELL, RefreshBooksButton() (+63 more)
...
Cohesion: 0.17
Nodes (11): buildPlated(), derived, inner, KEYS, nextDir, OUT_DIR, pad, PLATE (+3 more)

### Community 160 - "Community 160"
Cohesion: 0.11
Nodes (20): CANONICAL_CITIES, CITY_ALIASES, cityKey(), clampRecordedAt(), haversineMeters(), ListLocationsQueryDto, LocationController, REGION_CITIES (+12 more)
...
Cohesion: 0.19
Nodes (11): Any, datetime, StaffPrincipal, classify_confirmation(), _normalize(), The confirmation classifier — faithful port of lib/elaya/confirmation.ts.  The p, affirmative' ONLY for an unambiguous yes; everything else 'other'     (the calle, _parse_ts() (+3 more)
...
Cohesion: 0.04
Nodes (74): refreshBooksOverviewAction(), RefreshMemberFinanceSchema, TRAINING_ROLES, updateElayaPersonaAction(), setNotificationPrefAction(), EMPTY, PaletteDealHit, PaletteLeadHit (+66 more)

### Community 177 - "Community 177"
Cohesion: 0.13
Nodes (22): getFreshdeskTicketFor(), FreshdeskOverview(), FreshdeskOverviewSkeleton(), SyncLine(), TILE_GRID, FreshdeskTable(), FreshdeskPage(), TicketChangesTimeline() (+14 more)
...
Cohesion: 0.09
Nodes (18): FcmSendResult, FcmService, TYPE_CHANNEL, TYPE_KICKER, NotificationImageService, DeviceToken, DeviceTokenDocument, DeviceTokenSchema (+10 more)
...
Cohesion: 0.29
Nodes (6): 🧭 Biggest neighborhoods, 📂 Browse by folder, 🚪 Common entry points, 🔍 How to explore, Serene — Knowledge Graph, 🎨 Switch the look
...
Cohesion: 0.20
Nodes (9): 1. Purpose, 2. Who sees it, 3. Data sources, 4. Components, 5. States, 6. Invariants, 7. Open items, 8. See also (+1 more)
...
Cohesion: 0.07
Nodes (15): bulkWriteChunked(), chunk(), toObjectId(), AssignMembersDto, AssignSegmentDto, BrowseExploreQueryDto, CreateExploreCardDto, UpdateExploreCardDto (+7 more)

### Community 203 - "Community 203"
Cohesion: 0.06
Nodes (38): isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, dateSeparatorLabel(), LeadWhatsAppCardProps, describeMeta(), EVENT_META (+30 more)

### Community 204 - "Community 204"
Cohesion: 0.12
Nodes (14): useWidgetDensityTier(), STAT_PALETTES, StatAtom(), StatAtomProps, AnimatedNumber(), AnimatedNumberProps, FADE_TIMING, localeFor() (+6 more)

### Community 205 - "Community 205"
Cohesion: 0.12
Nodes (24): add(), addChild(), addDependent(), addDomEvent(), addUniqueItem(), addVariantChild(), getClosestVariantNode(), getProps() (+16 more)

### Community 206 - "Community 206"
Cohesion: 0.03
Nodes (104): JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, DROPDOWN_VARIANTS, DROPDOWN_VARIANTS_UP, EASE_SPRING, FADE_VARIANTS, FLIP_UP_TRANSFORM_TEMPLATE() (+96 more)

### Community 207 - "Community 207"
Cohesion: 0.33
Nodes (5): alwaysUpdateLinks, baseColor, newFileLocation, readableLineLength, showInlineTitle
...
Cohesion: 0.10
Nodes (41): fdComparable(), budgetHasRoom(), listAgents(), listConversations(), listGroups(), listSlaPolicies(), listTicketFields(), listTicketsUpdatedSince() (+33 more)

### Community 211 - "App Layout Structure"
Cohesion: 0.25
Nodes (8): 3.1 The Shell, 3.2 Sidebar, 3.3 Page controls on the title row (the TopBar is retired), 3.4 Page Content Structure, 3.5 The Canvas Texture, 3.6 Z-Index Scale, 3.7 Auth Surface (canvas-dark), 3. Layout Structure
...
Cohesion: 0.02
Nodes (130): getAgentTasksSummaryAction(), getAgentRecentLeadActivityAction(), CALL_OUTCOME_DEF, clampWidgetHeight(), DASHBOARD_WIDGETS, DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS (+122 more)

### Community 214 - "Claude Write Tools"
Cohesion: 0.15
Nodes (12): Elaya subsystem — CLAUDE.md, File map, Non-negotiables (extend the foundation invariants — never weaken), Playbooks (2026-09-21, migration 0234), The 12 write tools, The channel-parity rule (Phase 1 — structural, non-negotiable), The PII gateway (`pii.ts`), The tool catalog (2026-09-24, Python brain): the router no longer trims what she may call (+4 more)
...
Cohesion: 0.05
Nodes (40): Root(), unstable_settings, lastCheckAt, OtaState, useOtaUpdate(), UpdateBanner(), initSentry(), navigationIntegration (+32 more)
...
Cohesion: 0.05
Nodes (78): ElayaTrainingManager(), emptyStyle, QueendomRosterCard(), seatLabelStyle, UsersTable(), CallerRole, OversightAgentPage(), BudgetPage() (+70 more)
...
Cohesion: 0.04
Nodes (75): createLeadTaskAction(), exportLeadsAction(), RootPage(), GET(), goingColdCutoff(), LEAD_ASSIGNABLE_ROLES, ROUTING_POOL_ROLES, CampaignMetricsAsync() (+67 more)
...
Cohesion: 0.11
Nodes (23): applyGeneratorOptions(), attachTimeline(), canAnimate(), cancel(), clearAnimation(), commitStyles(), finish(), getFinalKeyframe() (+15 more)
...
Cohesion: 0.10
Nodes (23): CityAtlasCard(), CityGroup, fold(), Roster, RosterMember, RosterPerson, toMarkers(), ledgerColumns (+15 more)

### Community 259 - "Community 259"
Cohesion: 0.05
Nodes (72): getBudgetGaugeWidgetAction(), BODY, BooksOverviewStrip(), GRID, SHELL, AccountReportSection(), AdSpendUploadModal(), BudgetAsync() (+64 more)
...
Cohesion: 0.02
Nodes (134): addSubscriptionPaymentAction(), addSubscriptionTopupAction(), archiveSubscriptionAction(), canManageSubscriptions(), createSubscriptionAction(), getSubscriptionDetailAction(), getSubscriptionMonthlyReportAction(), listActiveSubscriptionsAction() (+126 more)

### Community 262 - "Community 262"
Cohesion: 0.07
Nodes (86): actorFromProfile(), requireProfile(), refreshMemberFinanceAction(), deleteNote(), upsertNote(), deleteElayaPlaybookAction(), draftElayaPlaybookAction(), ROLES (+78 more)
...
Cohesion: 0.07
Nodes (49): CampaignFilters(), CampaignFiltersProps, matchDateRangePreset(), GIA_DOMAIN_FILTER_ITEMS, SUBSCRIPTION_DEPARTMENT_OPTIONS, CATEGORY_DOMAIN, DealsFilters(), DealsFiltersProps (+41 more)
...
Cohesion: 0.43
Nodes (6): build(), cell(), load_runs(), Path, (symbol, color, tooltip) for one case in one run., trend_svg()
...
Cohesion: 0.16
Nodes (11): SIGNUP_STATUSES, SignupLead, SignupLeadDocument, SignupLeadSchema, SignupStatus, AdminSignupsController, ListSignupsQueryDto, SeriesQueryDto (+3 more)
...
Cohesion: 0.12
Nodes (20): Any, count_user_messages_today(), get_latest_proposed_action(), get_model_context_messages(), get_notes_for_elaya(), get_or_create_active_conversation(), get_owned_conversation(), get_user_persona() (+12 more)
...
Cohesion: 0.33
Nodes (6): 9. Manager View, 9a-0. `ManagerPerformanceShell` (new, 2026-06-25), 9a. `ManagerPerformanceAsync`, 9b. `ManagerPerformanceSkeleton`, 9c. `ManagerPerformancePanel`, 9d. `AgentDetailPanel`
...
Cohesion: 0.24
Nodes (8): argv, local, localFd, localHost, main(), prodCreds(), RESET, upsertTolerant()

### Community 363 - "Community 363"
Cohesion: 0.04
Nodes (54): refreshAccessToken(), refreshSession(), rotate(), setUnauthorizedHandler(), ApiEnvelope, ApiError, Paginated, REASON_NOTICE (+46 more)
...
Cohesion: 0.04
Nodes (55): LinkNowButton(), iconStyle, MODE_TABS, NewUserClient(), StaffWhatsAppCard(), SPRING_TAB, usePushSubscription(), AppearanceSelector() (+47 more)
...
Cohesion: 0.13
Nodes (20): resolveCustomerPrincipal(), handleCustomerReply(), mediaTypeForKind(), recordBotMessage(), resolveInboundText(), sendTurnMedia(), transcribeWhatsAppAudio(), DeepgramResponse (+12 more)
...
Cohesion: 0.04
Nodes (42): Command, CommandPalette(), ExploreTile(), exportColumns, getLegacySummary(), LegacyCard, LegacyCardsPage, LegacyImage (+34 more)

### Community 401 - "Community 401"
Cohesion: 0.15
Nodes (16): FRESHDESK_ROLES, runFreshdeskSyncNow(), SyncNowResult, FD_SYNC_KEYS, CALLS, main(), MEDIA, MINUTES (+8 more)

### Community 402 - "Community 402"
Cohesion: 0.04
Nodes (51): baseH, baseW, clearTimers(), CLONE_VALUES, cloneH, cloneR, cloneW, cloneX (+43 more)
...
Cohesion: 0.03
Nodes (101): getAssignableUsersAction(), AdCreativeFormModal(), AdCreativeFormModalProps, chevronStyle, inputBase, selectBase, AssetCard(), CARD_HOVER (+93 more)
...
Cohesion: 0.20
Nodes (10): scripts, audit:ui, build, check:tokens, dev, lint, lint:fix, start (+2 more)
...
Cohesion: 0.06
Nodes (44): fmtDateTime(), fmtRelative(), MemberPushPanel(), MemberPickerDialog(), Props, ReachFilter, RoleFilter, fetchMemberReach() (+36 more)

### Community 442 - "Community 442"
Cohesion: 0.09
Nodes (15): Fab(), MobileButton(), MobileButtonProps, DEMO_CONCIERGE, DEMO_THREAD, MobileActionSheet(), metadata, DASHED_LEG (+7 more)

### Community 456 - "Community 456"
Cohesion: 0.03
Nodes (118): chevronStyle, filterSelectStyle, getRolePillStyle(), UserCard(), UsersTableProps, ANTICIPATION_KINDS, CLIENT_EVENT_KINDS, CLIENT_FACETS (+110 more)
...
Cohesion: 0.05
Nodes (62): toVocabularyKey(), collectAll(), CollectOptions, ExportAborted, AnySpec, AnySpec, ExportDialog(), SCOPE_LABEL (+54 more)
...
Cohesion: 0.06
Nodes (49): ConversationIdSchema, getConversationsAction(), getMessagesAction(), markConversationAsRead(), searchConversationsAction(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage() (+41 more)
...
Cohesion: 0.06
Nodes (40): DealsPage(), KIND_LABEL, RevenueTile(), ShopDealRow, shopExportColumns, STATUS_LABEL, TabSpec, listMemberships() (+32 more)

### Community 465 - "Community 465"
Cohesion: 0.18
Nodes (14): datetime, build_notes_prompt_block(), build_persona_prompt_block(), build_playbook_block(), build_system_prompt(), build_time_context(), The Elaya persona — the faithful port of lib/elaya/persona.ts (read era).  Every, THE persona → prompt-block builder (buildPersonaPromptBlock, verbatim).     A fe (+6 more)
...
Cohesion: 0.04
Nodes (49): AdCreativeCarousel(), AdCreativeCarouselProps, AdCreativePlayer(), AdCreativePlayerProps, AdCreativeFormModal, CampaignAdPanelProps, getDomainInterests(), DEFAULT_COLUMN_ORDER (+41 more)
...
Cohesion: 0.11
Nodes (28): freshdeskDb(), getSyncState(), setSyncState(), actorFor(), claimNotes(), closedAtFor(), ExtractCycleStats, getExtractState() (+20 more)

### Community 473 - "Community 473"
Cohesion: 0.05
Nodes (33): membershipColumns, paymentColumns, profileColumns, ProfileField, tasteColumns, usageDayColumns, UsageDayRow, usageScreenColumns (+25 more)
...
Cohesion: 0.11
Nodes (19): createMotionComponent(), filterProps(), getFeatureDefinitions(), getInitializedFeatureDefinitions(), getMixer(), getProjectionFunctionality(), hasBrowserOnlyColors(), initFeatureDefinitions() (+11 more)
...
Cohesion: 0.06
Nodes (40): signOutUser(), getMobileRooms(), EASE_IN_EXPO, ModalScopeContext, useModalFocus(), ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav() (+32 more)

### Community 479 - "Community 479"
Cohesion: 0.24
Nodes (13): getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), markReadSchema, useNotifications(), useNotificationSound(), NotificationsContext, NotificationsProvider() (+5 more)

### Community 480 - "Community 480"
Cohesion: 0.09
Nodes (22): 10. What actually happened (2026-09-17), 11.1 Applied (2026-09-17 ~15:55 IST), 11. The member half: built and rehearsed (2026-09-17 afternoon), 12.1 Finished (2026-09-18), 12. The embed break, and what the rehearsal missed (2026-09-17 evening), 1. Why, in one paragraph, 2.1 `gia` (22 tables, names unchanged), 2.2 `member` (12 tables + slices, prefix dropped) (+14 more)
...
Cohesion: 0.20
Nodes (16): EngagementOutcome, TicketPage(), getTicketVendor(), getTicketVendorReview(), Result, reviewTicketVendorCore(), setTicketVendorCore(), suggestVendorsForTicket() (+8 more)

### Community 490 - "Community 490"
Cohesion: 0.18
Nodes (19): fileInquiry(), flushPendingInquiries(), InquiryInput, parkInquiry(), readQueue(), writeQueue(), HandoffPick, conciergeEnquiryMessage() (+11 more)

### Community 491 - "Community 491"
Cohesion: 0.14
Nodes (11): BottomNav(), ICONS, LONGEST_LABEL, NavTab(), TabIndex, TABS, TabFocusContext, TabFocusProvider() (+3 more)

### Community 492 - "Community 492"
Cohesion: 0.07
Nodes (40): formatRupees(), AWAITING_LEATHER, AwaitingCard(), CompletedRow(), DismissibleRow(), InboxRow(), JokerRow(), QuietRow() (+32 more)

### Community 493 - "Community 493"
Cohesion: 0.18
Nodes (16): _add(), _create(), DEFAULT_DURATIONS, _emit(), _emitQueue(), _emitter, _nextId(), _queue (+8 more)

### Community 495 - "Community 495"
Cohesion: 0.03
Nodes (60): AdCreativesManagerProps, CARD_HOVER, AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, AudioRecorderStatus, AudioRecording (+52 more)

### Community 496 - "Community 496"
Cohesion: 0.19
Nodes (13): DealsAsync(), DealsAsyncProps, searchDeals(), LeadDealCardAsync(), Props, DealsSummary, getDealsByRole(), getDealsByRoleForElaya() (+5 more)
...
Cohesion: 0.14
Nodes (16): ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), ElayaChatShell(), Props, ElayaMessageBubble(), ElayaUiMessage (+8 more)

### Community 499 - "Community 499"
Cohesion: 0.08
Nodes (21): AdminStaffController, AdminStaffModule, AdminStaffService, StaffRow, toRow(), AuthResult, TokenPair, LOGIN_CAP (+13 more)

### Community 500 - "Community 500"
Cohesion: 0.15
Nodes (16): analyseComplexValue(), buildTransformer(), convertBoundingBoxToBox(), createTransformer(), getAnimatableNone(), getAnimatableNone2(), isNone(), jump() (+8 more)

### Community 502 - "Community 502"
Cohesion: 0.09
Nodes (17): AdminMembersController, AdminMembersService, MemberRow, toRow(), isDuplicateKeyError(), CreateMemberDto, IntegrationLinksDto, ListMembersQueryDto (+9 more)

### Community 503 - "Community 503"
Cohesion: 0.05
Nodes (28): AppVersionController, AppVersionMiddleware, isBelow(), AppVersionModule, makeCache(), makeService(), DatacenterIpService, DATACENTER_RANGES (+20 more)

### Community 504 - "Community 504"
Cohesion: 0.23
Nodes (9): inputBase, NoteFormModal(), NoteFormModalProps, NotesManagerProps, ElayaNoteRow, DeleteNoteInput, deleteNoteSchema, UpsertNoteInput (+1 more)
...
Cohesion: 0.07
Nodes (31): Bubble, applyLiveMessage(), AttachmentFile, chatApi, ChatMessage, insertSent(), MessageAttachment, patchRoomsList() (+23 more)
...
Cohesion: 0.10
Nodes (14): MembershipLead, MembershipLeadDocument, AdminMembershipLeadsController, MembershipLeadsController, serialize(), MembershipLeadsRedeliveryService, BACKOFF_MS, buildMembershipLeadPayload() (+6 more)

### Community 512 - "Community 512"
Cohesion: 0.18
Nodes (11): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, ManagerPerformanceShell() (+3 more)
...
Cohesion: 0.22
Nodes (8): DEF, IconKey, persistAppIconCookie(), AppBootScreen(), IconInitializer(), Props, IconSelector(), Props

### Community 515 - "Community 515"
Cohesion: 0.09
Nodes (31): cdnImage(), PreferencesHubScreen(), TastesFlow(), TastesScreen(), OptionCard(), OptionChip(), useSelectionPop(), ChipCloudSection() (+23 more)

### Community 516 - "Community 516"
Cohesion: 0.14
Nodes (14): chat(), ChatRequest, classify_turn_failure(), POST /v1/elaya/chat — the Python brain's chat endpoint (SSE).  WIRE-COMPATIBLE w, → (code, the line she says). Read by shape from the provider's message, never su, BaseException, BaseModel, The principal resolver — the Golden Rule in code (port of principal.ts).  Every (+6 more)
...
Cohesion: 0.26
Nodes (10): getElayaChatSeedAction(), ElayaWidget(), ElayaChatShell, EmbeddedElayaChat(), loadElayaChatShell(), Props, ElayaChatSeed, ElayaGlyph() (+2 more)

### Community 524 - "Community 524"
Cohesion: 0.10
Nodes (26): GENIE_BEATS, GENIE_STILLS, GenieExpression, GenieSide, Props, Props, TourOverlay(), Props (+18 more)

### Community 526 - "Community 526"
Cohesion: 0.12
Nodes (19): addRoomMembers(), AdminRoom, broadcast(), createRoom(), listRooms(), removeRoomMembers(), reshuffle(), RoomMember (+11 more)
...
Cohesion: 0.08
Nodes (31): ANTHROPIC_IMAGE_TYPES, anthropicAdapter, collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt() (+23 more)
...
Cohesion: 0.12
Nodes (25): AppUsagePage(), exportColumns, RANGES, DateWindow, istDaysWindow(), RANGE_LABELS, RangeKey, rangeWindow() (+17 more)

### Community 534 - "Community 534"
Cohesion: 0.12
Nodes (12): MediaController, MediaServeController, MediaModule, STORAGE, IMAGE_MIMES, UploadedImage, DiskStorageAdapter, MemoryStorageAdapter (+4 more)

### Community 535 - "Community 535"
Cohesion: 0.05
Nodes (28): stack, CardWatermark(), CEREMONY, FrostVeil(), GENIE_IN, KEYS, Props, RISE_IN (+20 more)

### Community 536 - "Community 536"
Cohesion: 0.15
Nodes (13): containsCSSVariable(), defaultTransformValue(), fillWildcards(), getBaseTarget(), getBaseTargetFromProps(), getComputedStyle2(), getVariableValue(), parseCSSVariable() (+5 more)
...
Cohesion: 0.02
Nodes (105): ForceUpdateInfo, MotionRoomScreen(), Panel(), ForceUpdateGate(), BEATS, Welcome(), bucketApi, isPendingWish() (+97 more)

### Community 539 - "Community 539"
Cohesion: 0.07
Nodes (21): AccessControlGuard, AdminPagesController, asPageSlug(), BlockDto, PagesController, serialize(), UpdatePageDto, PagesModule (+13 more)

### Community 540 - "Community 540"
Cohesion: 0.06
Nodes (41): acceptedTag(), CANONICAL_BY_LOWER, canonicalTag(), CATEGORY_BY_TAG, CONNECT_GROUP_KEYS, CONNECT_GROUP_LABELS, CONNECT_TAG_CATEGORIES, CONNECT_TAGS (+33 more)

### Community 541 - "Community 541"
Cohesion: 0.18
Nodes (13): getCurrentTreeVariants(), getValueState(), getVariantContext(), isAnimationControls(), isControllingVariants(), isVariantLabel(), isVariantNode(), makeLatestValues() (+5 more)

### Community 542 - "Community 542"
Cohesion: 0.25
Nodes (14): generateMetadata(), generateViewport(), inter, playfairDisplay, buildManifest(), manifest(), iconSrc(), isIconKey() (+6 more)

### Community 543 - "Community 543"
Cohesion: 0.05
Nodes (24): BudgetContentSkeleton(), ElayaLoading(), ErrorLogTableSkeleton(), EscalationsSkeleton(), FreshdeskTableSkeleton(), DossierCardSkeleton(), Props, ROW_WIDTHS (+16 more)

### Community 544 - "Community 544"
Cohesion: 0.08
Nodes (31): Role, ROLES, useAuth, ConfirmOptions, useConfirm(), ConnectProfilePage(), ConnectReportsPage(), exportColumns (+23 more)

### Community 545 - "Community 545"
Cohesion: 0.29
Nodes (10): ELAYA_CAPABILITY_LABELS, ELAYA_DAILY_LINES, ELAYA_STARTER_PROMPTS, ElayaCapabilityKey, ElayaViewer, getElayaCapabilities(), getElayaStarters(), CAPABILITY_ICONS (+2 more)
...
Cohesion: 0.14
Nodes (18): DRESSED_LABEL, exportColumns, VISIBILITY_LABEL, ConnectProfileCard, ConnectProfilePatch, ConnectRosterCard, ConnectRosterPage, ConnectTagCategory (+10 more)

### Community 548 - "Community 548"
Cohesion: 0.18
Nodes (9): FounderPerfActionsContext, FounderPerfActionsContextValue, FounderPerfActionsProvider(), DomainOverviewPanel, FounderPerformanceShell(), Props, Tab, DomainHealthCard (+1 more)

### Community 549 - "Community 549"
Cohesion: 0.20
Nodes (10): build(), buildHTMLStyles(), buildSVGAttrs(), buildSVGPath(), buildTransform(), camelToDash(), renderHTML(), renderInstance() (+2 more)

### Community 550 - "Community 550"
Cohesion: 0.06
Nodes (22): QUESTION_TYPES, QuestionOption, QuestionType, TasteAnswer, TasteQuestion, TasteQuestionDocument, TasteQuestionSchema, TasteResponse (+14 more)

### Community 551 - "Community 551"
Cohesion: 0.11
Nodes (16): AuthBackdrop(), LEFT_IMAGES, RIGHT_IMAGES, canSkipSend(), hasLiveOtp(), lastOtpSentAt(), recordOtpSent(), CursorBar() (+8 more)
...
Cohesion: 0.29
Nodes (10): APPLY, argv, copyCollection(), fail(), FORCE, inventory(), main(), portableIndexSpecs() (+2 more)

### Community 554 - "Community 554"
Cohesion: 0.11
Nodes (17): getLocationDetail(), listLocations(), ListLocationsParams, LocationDetail, LocationRow, LocationSource, LocationsPage, TrailPoint (+9 more)

### Community 555 - "Community 555"
Cohesion: 0.31
Nodes (8): AppearanceKey, applyAppearanceToDom(), DEF, persistAppearanceCookie(), resolvesDark(), systemPrefersDark(), Props, ThemeInitializer()

### Community 556 - "Community 556"
Cohesion: 0.20
Nodes (9): Component contract, Follow-up — 2026-09-23, Review and maintenance, Selection families — 2026-09-24, Serene control system, Source audit — 2026-09-22, Theme and keyboard checks, Upload and mobile action families — 2026-09-24 (+1 more)

### Community 557 - "Community 557"
Cohesion: 0.24
Nodes (6): AlertContent, Props, DialogHost(), DialogState, Listener, useBackToClose()

### Community 558 - "Community 558"
Cohesion: 0.22
Nodes (10): animation(), clear(), clearListeners(), destroy(), flushKeyframeResolvers(), measureAllKeyframes(), readAllKeyframes(), removeChild() (+2 more)

### Community 559 - "Community 559"
Cohesion: 0.14
Nodes (13): BucketMemberRow, BucketMembersPage, listBucketMembers(), listBucketWishes(), listMemberWishes(), ListWishesParams, MemberWish, WishesPage (+5 more)

### Community 560 - "Community 560"
Cohesion: 0.18
Nodes (10): SAVE_KINDS, SavedItem, SavedItemDocument, SavedItemSchema, SaveKind, assertKind(), ImportSaveDto, ImportSavesDto (+2 more)
...
Cohesion: 0.10
Nodes (23): CampaignAdPanel(), CampaignMetricsStripSkeleton(), DateRangePreset, DEF, mondayOf(), resolveDateRangePreset(), serialize(), shiftDays() (+15 more)

### Community 563 - "Community 563"
Cohesion: 0.29
Nodes (14): cardHeader(), CardKind, cardShell(), citySvg(), mandala(), MANDALA_CENTERS, matchSvg(), noteSvg() (+6 more)

### Community 564 - "Community 564"
Cohesion: 0.31
Nodes (9): dedupe(), flushSaveOutbox(), keyOf(), ParkedSave, parkSave(), readQueue(), SAVES_OUTBOX_COPY, writeQueue() (+1 more)

### Community 565 - "Community 565"
Cohesion: 0.25
Nodes (8): PROGRESS, convertOffsetToTimes(), createMixers(), defaultEasing(), defaultOffset(), fillOffset(), interpolate(), keyframes()
...
Cohesion: 0.39
Nodes (7): CallbackEnvelope, CallbackIntent, CallbackOutcome, flushPendingCallbacks(), readQueue(), requestCallback(), writeQueue()
...
Cohesion: 0.23
Nodes (8): LINK, wait(), LinkTopupFlowDeps, LinkTopupOutcome, runLinkTopupFlow(), TOPUP_COPY, TopupLink, TopupLinkPollStatus

### Community 570 - "Community 570"
Cohesion: 0.18
Nodes (10): Color, Components, Design — Indulge Admin (Control Room), Elevation (the heart — no borders anywhere), Logo, Motion ("light travels, weight settles" — operator tempo), Radii, Shell interaction layer (2026-08 Ivory pass) (+2 more)

### Community 571 - "Community 571"
Cohesion: 0.29
Nodes (4): BeforeInstallPromptEvent, InstallPrompt(), Platform, swapInstallIcon()

### Community 572 - "Community 572"
Cohesion: 0.25
Nodes (10): LEGACY_QUESTION_TEXTS, main(), MIGRATED, mongoose, normalizePhone(), normalizeQuestion(), ok(), problem() (+2 more)

### Community 573 - "Community 573"
Cohesion: 0.20
Nodes (9): Data & state — the rules agents break, Deeper reading, Design & motion — design system or nothing, Gates before every commit — nothing runs these for you, indulge-app — the Indulge member app, Stack (verified 2026-08-26), Traps already hit, Version state (2026-08-26) (+1 more)

### Community 574 - "Community 574"
Cohesion: 0.53
Nodes (5): ALL_DOMAINS_ICON, parseGiaDomainParam(), readDomainCookie(), DOMAIN_ITEMS, DomainSelector()

### Community 575 - "Community 575"
Cohesion: 0.22
Nodes (8): Deploy (admin goes LAST: API → app build → admin), Design (⚠ overrides any "flat admin" instinct), Features that need more than an admin deploy, Gates, indulge-admin — staff control room, Page map (18 folders under `src/pages/` + `DashboardPage.tsx`), Staff auth (different from member roles), UX conventions (follow on every new page)

### Community 576 - "Community 576"
Cohesion: 0.22
Nodes (5): merged, OUT, perProvider, ranges, sources

### Community 577 - "Community 577"
Cohesion: 0.22
Nodes (6): CAPPED_DETAIL_ENDPOINTS, MERGED_FIRST_PAGE_SIZE, PERSIST_ENDPOINTS, QueryEntry, QueryMap, rtkqCachePersistTransform
...
Cohesion: 0.25
Nodes (5): APPLY, argv, RECONSTRUCT, REVERT, STATUS

### Community 580 - "Community 580"
Cohesion: 0.33
Nodes (5): counts, feed, get(), PROJECTS, sleep()

### Community 581 - "Community 581"
Cohesion: 0.33
Nodes (4): MEMBER_DATA_ROLES, MEMBER_ROLES, MemberRole, MemberUser

### Community 582 - "Community 582"
Cohesion: 0.33
Nodes (5): CTA_TYPES, CtaType, CURRENCY_SYMBOL, PRICE_REGIONS, PriceRegion
...
Cohesion: 0.40
Nodes (4): files, inventory, root, totals

### Community 586 - "Community 586"
Cohesion: 0.40
Nodes (5): buildMessage(), { getMessaging }, { initializeApp, cert }, main(), mongoose

### Community 587 - "Community 587"
Cohesion: 0.47
Nodes (5): brandOf(), brandsFromProducts(), KNOWN_MAISONS, MAISONS_BY_LENGTH, normalize()

### Community 588 - "Community 588"
Cohesion: 0.67
Nodes (5): beforeBreadcrumb(), beforeSend(), isClientAbort(), redact(), stripQuery()

### Community 589 - "Community 589"
Cohesion: 0.33
Nodes (3): noopStorage, plainReduxStorage, secureReduxStorage

### Community 590 - "Community 590"
Cohesion: 0.40
Nodes (3): initialState, prefsSlice, PrefsState

### Community 591 - "Community 591"
Cohesion: 0.40
Nodes (4): fs, { MongoMemoryServer }, os, path
...
Cohesion: 0.50
Nodes (3): ApiEnvelope, ApiError, Paginated
...
Cohesion: 0.40
Nodes (4): MotionLink, SettingsLinkCard(), SettingsLinkCardProps, SettingsLinkIcon
...
## Knowledge Gaps
- **5974 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+5969 more)
...
- **Why does `useTheme()` connect `Community 538` to `SLA Business Hours`, `Task Constants & UI`, `Community 515`, `Community 140`, `Community 524`, `Community 526`, `Community 402`, `Community 533`, `Community 535`, `Community 544`, `Audio Recorder & Notes`, `Community 551`, `Community 554`, `Lead Sources & Activity`, `Community 427`, `Community 81`, `Community 97`, `Community 228`, `Community 491`, `Community 492`, `Community 507`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `useMediaQuery()` connect `Community 206` to `Community 512`, `Call Outcome Charts`, `SLA Business Hours`, `Community 526`, `Community 276`, `Community 533`, `Service Interests & Cases`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Community 544`, `Community 548`, `Community 554`, `Community 427`, `Agent Deals & Cards`, `Community 574`, `Community 203`, `Community 213`, `Community 478`, `Community 234`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `monthYear()` connect `Shared Types & Props` to `Lead Sources & Activity`?**
...
- **Are the 15 inferred relationships involving `useTheme()` (e.g. with `Root()` and `ChatroomsPage()`) actually correct?**
  _`useTheme()` has 15 INFERRED edges - model-reasoned connections that need verification._
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _6091 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.0024096385542168677 - nodes in this community are weakly interconnected._