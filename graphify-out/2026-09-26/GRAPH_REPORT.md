...
## Corpus Check
- 1449 files · ~6,212,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11045 nodes · 25523 edges · 543 communities (495 shown, 48 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 286 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7705379`
...
7. `giaDb()` - 151 edges
8. `mapRows()` - 141 edges
9. `AppDomain` - 138 edges
10. `formatDate()` - 130 edges
...
Cohesion: 0.05
Nodes (50): SIA_ALERT_TIER1_PROFILE_IDS, canAccessLead(), statusLabel(), getLeadWhatsAppChatFor(), getTicketFor(), ElayaActionPayload, ElayaActionTarget, ElayaActionType (+42 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.08
Nodes (53): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, getElayaTimeGreeting(), pickElayaDailyLine(), ElayaStreamHandlers (+45 more)

### Community 5 - "Task Actions & Mutations"
Cohesion: 0.08
Nodes (35): ActivityCursorSchema, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction(), getAgentDealsScopedAction() (+27 more)
...
Cohesion: 0.04
Nodes (92): mergeError(), mergeVendorsAction(), VENDOR_STATUS_ROLES, actorFor(), claimNotes(), closedAtFor(), ExtractCycleStats, getExtractState() (+84 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.06
Nodes (49): ConversationIdSchema, getConversationsAction(), getMessagesAction(), initiateWhatsAppConversationAction(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction() (+41 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.04
Nodes (82): DRAFT_REVIEW_DECISIONS, DRAFT_REVIEW_SOURCES, INTAKE_ACK_WORDS, INTAKE_DISMISS_REASONS, INTAKE_KINDS, INTAKE_MEMBER_STATUSES, INTAKE_TONES, IntakeDismissReason (+74 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.16
Nodes (15): FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), verifyMetaSignature(), parseWebhookPayload(), MetaWebhookPayload, createRateLimiter() (+7 more)
...
Cohesion: 0.04
Nodes (86): deleteGroupTaskAction(), deleteTaskAction(), getTaskRemarksAction(), ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS (+78 more)

### Community 13 - "Page Skeletons & Flags"
Cohesion: 0.05
Nodes (55): PROFILER_COST_PER_MTOK, PROFILER_MEMBER_STATUSES, DAYS, GROUPS, main(), PER_GROUP, advanceBookmark(), buildWindows() (+47 more)
...
Cohesion: 0.05
Nodes (47): buildLeadListKey(), DASHBOARD_PIPELINE_ROLES, REDIS_KEYS, REDIS_TTL, SIA_ALERT_KINDS, LEAD_ASSIGNABLE_ROLES, LeadDossierPage(), DynamicFormResponses() (+39 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.07
Nodes (55): isNotificationCategoryKey(), resolveCustomerPrincipal(), handleCustomerReply(), maybeSendCustomerWelcome(), mediaTypeForKind(), recordBotMessage(), resolveInboundText(), sendTurnMedia() (+47 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.04
Nodes (79): initialState, Props, useDebounce(), CardHeader(), Props, DETAILS_FIELD, JSONB_FIELD_KEYS, JSONB_GRID_FIELDS (+71 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.04
Nodes (65): FIRST_TOUCH_BUCKETS, FirstTouchBucket, firstTouchBucketForMinutes(), FirstTouchBucketId, AgentCallsDrillModal(), Props, AgentDealsDrillModal(), DealRow (+57 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.03
Nodes (96): LinkNowButton(), canTransition(), FRESHDESK_CATEGORY_TO_TICKET, resolveTicketStatusLabels(), TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BOARD_STATUSES, TICKET_BRIEF_FIELD_LABELS (+88 more)

### Community 20 - "Shared Types & Props"
Cohesion: 0.06
Nodes (47): getAgentUsageAction(), recordPresenceAction(), BarChartProps, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartSkeleton() (+39 more)

### Community 21 - "Agent Performance Shell"
Cohesion: 0.05
Nodes (71): assertLeadFieldEditAccess(), BulkUpdateResult, createLeadTaskAction(), exportLeadsAction(), ExportPayload, LeadEditContext, recordDeal(), revalidateLeadDossier() (+63 more)
...
Cohesion: 0.07
Nodes (62): checklistForCategory(), SENTINEL_WARN_BEFORE_MIN, TICKET_ACTIVE_STATUSES, TICKET_SLA_STOPPED_STATUSES, recordDraftReviewCore(), addTicketNoteCore(), assignTicketCore(), createTicketCore() (+54 more)
...
Cohesion: 0.04
Nodes (87): emptyStyle, QueendomRosterCard(), seatLabelStyle, UsersTable(), ALWAYS_ALLOWED_PREFIXES, DOMAIN_NAV_HIDDEN, DOMAIN_ROUTE_MAP, FOUNDER_NAV_PREFIXES (+79 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.07
Nodes (23): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, CalledModal(), OUTCOME_ITEMS (+15 more)
...
Cohesion: 0.04
Nodes (82): getAssignableUsersAction(), getGroupSubtasksAction(), getPersonalTaskTagsAction(), UsersTableProps, ROLE_LABELS, ROLES_GLOBAL_ACCESS, USER_ROLES, getGiaTasks() (+74 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.09
Nodes (23): BenchmarkLine, CardConfig, computeDelta(), CoreFourGrid(), formatPct(), makeBenchmarkLine(), Props, STAT_PALETTES (+15 more)
...
Cohesion: 0.08
Nodes (50): STAFF_SENDER_NAMES, staffShortName(), siaGroupHref(), admin(), Alert, AlertSweepResult, deliverToFounders(), deliverToTech() (+42 more)
...
Cohesion: 0.06
Nodes (59): addTaskRemarkAction(), createGroupTaskAction(), updateChecklistAction(), updateTaskAction(), updateTaskStatusAction(), emitTaskEvent(), EmitTaskEventInput, resolveTaskDomain() (+51 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.06
Nodes (52): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE, REVIVAL_TRIGGER_STATUSES (+44 more)
...
Cohesion: 0.05
Nodes (74): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getAgentTasksSummaryAction(), getBudgetGaugeWidgetAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction() (+66 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.08
Nodes (37): OverviewAsync(), TicketsAsync(), applyTicketFilters(), FdFilterVocab, getFreshdeskOverview(), getFreshdeskSyncHealth(), getRecentFreshdeskRuns(), hasFreshdeskFilters() (+29 more)
...
Cohesion: 0.08
Nodes (32): FACT_POLARITIES, FactPolarity, RELATION_KINDS, RevivalTriggerStatus, getLeadNotes(), maskPii(), maskString(), main() (+24 more)

### Community 46 - "Dashboard Widget Data Hooks"
Cohesion: 0.24
Nodes (7): CALL_OUTCOME_DEF, defineEnum(), EnumDef, SUGGESTION_CATEGORY_DEF, SUGGESTION_STATUS_DEF, TASK_STATUS_DEF, TASK_TYPE_DEF
...
Cohesion: 0.06
Nodes (60): AddRechargeModal(), fieldLabelStyle, Props, todayIso(), CURRENCY_SYMBOLS, INVOICE_ACCEPT_MIME, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF (+52 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.05
Nodes (56): updateMemberAction(), ROLES, writeIntakeLessonNowAction(), createTicketAction(), dismissIntakeProposalAction(), draftTicketAction(), getTicketHelpAction(), listBoardTicketsAction() (+48 more)
...
Cohesion: 0.07
Nodes (51): createWalkInDeal(), listAgentsForDealDomain(), notifyDealCreated(), recordDeal(), addLeadNote(), assignLead(), bulkUpdateLeads(), createManualLead() (+43 more)
...
Cohesion: 0.08
Nodes (39): BridgeBody, LEGACY_TOOL_NAMES, POST(), buildPersonaPromptBlock(), ElayaTurnEvent, ElayaTurnResult, resolvePendingAction(), runElayaTurn() (+31 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.22
Nodes (13): getElayaChatSeedAction(), Props, ElayaMessageBubble(), ElayaUiMessage, ElayaWidget(), ElayaChatShell, EmbeddedElayaChat(), loadElayaChatShell() (+5 more)
...
Cohesion: 0.09
Nodes (19): CreateUserForm(), CreateUserFormProps, CreateUserMode, FieldsProps, FooterProps, FormFooter(), formStyle, initialState (+11 more)
...
Cohesion: 0.04
Nodes (66): AgentSelfMetrics, AgingStrip(), BODY, BooksBankAccounts(), BooksOverviewStrip(), GRID, SHELL, AccountReportSection() (+58 more)

### Community 64 - "Toast & Domain Utilities"
Cohesion: 0.03
Nodes (127): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+119 more)

### Community 65 - "Community 65"
Cohesion: 0.10
Nodes (23): resolveSuggestionAction(), submitSuggestionAction(), SuggestionCategory, SuggestionStatus, CreateNotificationPayload, dispatchPush(), ensureVapidConfigured(), PushPayload (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.17
Nodes (11): EMPTY, PaletteDealHit, PaletteLeadHit, PaletteTaskHit, getCompletedTasksAction(), getPersonalTasksAction(), MobileAgentTasksPage(), getPersonalTasksFor() (+3 more)

### Community 67 - "Community 67"
Cohesion: 0.10
Nodes (63): setAgentShiftAction(), actorFromProfile(), requireProfile(), addMemoryEntryAction(), retireMemoryEntryAction(), deleteNote(), upsertNote(), draftElayaPlaybookAction() (+55 more)
...
Cohesion: 0.12
Nodes (26): getVendor(), rankVendors(), resolveMergedVendor(), VendorPage(), fmt(), host, line(), main() (+18 more)
...
Cohesion: 0.08
Nodes (33): FD_EXT_BY_MIME, FD_MOMENT_FIELDS, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, fdAttachmentKind() (+25 more)
...
Cohesion: 0.10
Nodes (16): EscalatedLeadsSection(), GoingColdSection(), OverdueTasksSection(), RECIPIENT_META, secondaryCell, tertiaryCell, EscalationsSkeleton(), metadata (+8 more)
...
Cohesion: 0.05
Nodes (47): toggleUserActive(), updateProfileAvatar(), updateUserAuthorization(), EditAuthorizationForm(), initialState, Props, EditProfileForm(), decode() (+39 more)

### Community 82 - "Lead Column Preferences"
Cohesion: 0.06
Nodes (61): addMemberFactAction(), addMemberObservationAction(), addMemberPersonAction(), addMemberVaultItemAction(), adjustMemberHealthAction(), assessMemberNowAction(), deleteMemberPersonAction(), deleteMemberVaultItemAction() (+53 more)
...
Cohesion: 0.10
Nodes (38): CampaignFilters(), CampaignFiltersProps, ALL_DOMAINS_ICON, GIA_DOMAIN_FILTER_ITEMS, parseGiaDomainParam(), persistDomainCookie(), readDomainCookie(), SUBSCRIPTION_DEPARTMENT_OPTIONS (+30 more)
...
Cohesion: 0.06
Nodes (74): RootPage(), BTN, metadata, TicketBoardPage(), GET(), computeHealthScore(), MemberTier, MemberPage() (+66 more)
...
Cohesion: 0.04
Nodes (45): AdCreativeFormModal(), AdCreativeFormModalProps, inputBase, AdCreativesManagerProps, ElayaTrainingManagerProps, inputBase, TrainingAssetFormModal(), TrainingAssetFormModalProps (+37 more)
...
Cohesion: 0.08
Nodes (21): EASE_OUT_SOFT, Props, LINK_BUTTON, metadata, metadata, useFounderPerfActions(), FounderDrillDownDeck, ManagerPerformancePanel() (+13 more)
...
Cohesion: 0.08
Nodes (28): CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, EngagementOutcome, INDULGE_OWN_ENTITIES, PREFERENCE_STANCE_DEF, PreferenceStance, REQUEST_CATEGORY_DEF (+20 more)
...
Cohesion: 0.15
Nodes (6): AMBIGUOUS_CITIES, CATEGORY_WORDS, EXAMPLES, Parsed, SERVICE_WORDS, VendorScoreRing()
...
Cohesion: 0.06
Nodes (75): addLeadCallNote(), armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, cancelSlaTimersForLeadInternal(), describePolicy(), fireSlaBreachHandler() (+67 more)
...
Cohesion: 0.05
Nodes (37): getDomainInterests(), AddSuggestionModal(), AddSuggestionModalProps, borderFor(), fieldChrome, FieldErrors, AddLeadModal(), Agent (+29 more)
...
Cohesion: 0.07
Nodes (23): FounderPerfActionsContext, FounderPerfActionsContextValue, FounderPerfActionsProvider(), DomainOverviewPanel, FounderDomainsData, FounderPerformanceShell(), loadDomainOverviewPanel(), Props (+15 more)
...
Cohesion: 0.05
Nodes (72): getActivityFeedAction(), getDomainTaskSummaryAction(), getMobileBudgetAction(), getMobileDashboardAction(), MOBILE_ROLES, resolveMobileDomain(), metadata, MobileActivityPage() (+64 more)
...
Cohesion: 0.04
Nodes (62): DOMAIN_LINE_COLORS, ACTIVITY_EXPORT_HEADERS, ExportHeader, LEAD_EXPORT_HEADERS, NOTE_EXPORT_HEADERS, getMetaMediumLabel(), EASE_OUT_EXPO, BADGE (+54 more)
...
Cohesion: 0.05
Nodes (72): EASE_IN_OUT, SPRING_CONFIG, siaMessageHref(), ProfileAvatarSection(), Props, SiaGroupKind, SiaGroupRow, SiaMediaInfo (+64 more)
...
Cohesion: 0.16
Nodes (11): PushSupport, usePushSubscription(), UsePushSubscriptionReturn, ConnectedApps(), IconSelector(), ProfilePage(), PushNotificationSettings(), getMyElayaPersona() (+3 more)
...
Cohesion: 0.08
Nodes (28): CARD_HOVER, AssetCard(), CARD_HOVER, KIND_ICON, safeHost(), LINK_BUTTON, AddLeadButton(), AddLeadModal (+20 more)
...
Cohesion: 0.08
Nodes (30): getLeadVolumeByDomainsAction(), BarChart(), BarChartSeries, useDashboardCohortSync(), useWidgetData(), UseWidgetDataOptions, WidgetFetcher, LeadVolumeSummary (+22 more)

### Community 177 - "Community 177"
Cohesion: 0.31
Nodes (10): searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, parseWhatsAppPeriodFromSearchParams(), ConversationList(), ConversationListProps (+2 more)
...
Cohesion: 0.07
Nodes (34): deleteElayaPlaybookAction(), ROLES, upsertElayaPlaybookAction(), Schema, APP_DOMAIN_ENUM, deleteElayaPlaybookCore(), upsertElayaPlaybookCore(), Contact (+26 more)
...
Cohesion: 0.08
Nodes (34): APPLY, IMPORT_ACTOR, LIMIT, mask(), Note, ONLY, REREAD, assessMember() (+26 more)
...
Cohesion: 0.05
Nodes (57): clampWidgetHeight(), DASHBOARD_WIDGETS, DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, defaultGridFor(), DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId() (+49 more)
...
Cohesion: 0.03
Nodes (108): addSubscriptionPaymentAction(), addSubscriptionTopupAction(), archiveSubscriptionAction(), canManageSubscriptions(), createSubscriptionAction(), getSubscriptionDetailAction(), getSubscriptionMonthlyReportAction(), listActiveSubscriptionsAction() (+100 more)
...
Cohesion: 0.04
Nodes (81): AgentDetailAsync(), CallerRole, OversightAgentPage(), BudgetPage(), SearchParams, CampaignListAsync(), CampaignListAsyncProps, CampaignListSkeleton() (+73 more)

### Community 235 - "Community 235"
Cohesion: 0.13
Nodes (16): getRequestCategoryLabel(), getServiceLabel(), titleCase(), FindVendorPage(), metadata, getVendorCities(), hasVendorAccess(), FindVendorPanel() (+8 more)
...
Cohesion: 0.20
Nodes (16): MutationActor, getTicketVendor(), getTicketVendorReview(), Result, reviewTicketVendorCore(), searchVendorsForTicket(), setTicketVendorCore(), suggestVendorsForTicket() (+8 more)
...
Cohesion: 0.03
Nodes (72): getAgentRecentLeadActivityAction(), JUNK_REASONS, LOST_REASONS, RESOLUTION_REASON_LABELS, getLeadSourceLabel(), JOURNEY_STATUSES, LEAD_STATUS_BADGE, LEAD_STATUS_COLORS (+64 more)

### Community 259 - "Community 259"
Cohesion: 0.08
Nodes (48): BooksAsync(), getBooksFor(), assertRoom(), createZbBudget(), env(), getArAgingSummary(), getContact(), getInvoiceDashboard() (+40 more)
...
Cohesion: 0.10
Nodes (23): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, CampaignDetailPage(), CampaignLeadsAsync() (+15 more)
...
Cohesion: 0.19
Nodes (8): ElayaStatusText(), DEMO_CHAT, DEMO_CHAT_SUGGESTIONS, DemoChatMessage, ElayaChatScreenProps, Block, ChatMarkdown(), parseBlocks()
...
Cohesion: 0.04
Nodes (73): signOutUser(), BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS (+65 more)
...
Cohesion: 0.38
Nodes (5): ElayaTrainingManager(), ElayaTrainingPage(), metadata, getAllTrainingAssets(), getTrainingAssetsForBlast()
...
Cohesion: 0.18
Nodes (3): FreshdeskTableSkeleton(), MembersTableSkeleton(), TicketsTableSkeleton()

### Community 401 - "Community 401"
Cohesion: 0.07
Nodes (51): getDomainHealthMetricsAction(), getManagerRosterAction(), getAgentPulse(), getRoster(), parseFilters(), ManagerPerformanceAsync(), Props, AgentPerformanceAsync() (+43 more)
...
Cohesion: 0.09
Nodes (18): loginAction(), loginSchema, RequireProfileResult, updatePasswordAction(), verifyResetOtpAction(), LoginForm(), LoginPage(), metadata (+10 more)
...
Cohesion: 0.29
Nodes (7): DEF, persistThemeCookie(), ThemeKey, useNotificationSound(), NotificationsProvider(), Props, ThemeSelector()
...
Cohesion: 0.11
Nodes (17): countVendors(), getVendorCategories(), getVendorScoreInputs(), listVendors(), listVendorsNeedingReview(), VendorListFilters, AddVendorButton(), metadata (+9 more)

### Community 456 - "Community 456"
Cohesion: 0.04
Nodes (73): ASSESSMENT_MEMBER_STATUSES, ASSESSMENT_RISK_LABELS, ASSESSMENT_RISKS, AssessmentRisk, MEMBER_SORT_LABELS, MEMBER_SORTS, MemberSort, ANTICIPATION_KINDS (+65 more)
...
Cohesion: 0.04
Nodes (70): toggleAgentRouting(), toggleRoutingSchema, refreshBooksOverviewAction(), refreshMemberFinanceAction(), RefreshMemberFinanceSchema, TRAINING_ROLES, updateElayaPersonaAction(), getHelpdeskLibraryAction() (+62 more)
...
Cohesion: 0.07
Nodes (31): PaletteSearchResult, ClientAppLayout(), getMobileRooms(), ModalScopeContext, stack, useModalFocus(), MobileDrawer(), SOFT_OUT (+23 more)
...
Cohesion: 0.26
Nodes (13): REVIEW_DIMENSIONS, SCORE_WEIGHTS, ScoreComponent, VendorScore, clamp01(), computeVendorScore(), plural(), recencySignal() (+5 more)
...
Cohesion: 0.09
Nodes (35): ReviewDimension, VendorStatus, callAdminRpc(), callAdminRpcAll(), callAdminRpcChecked(), AdminClient, findVendorsByHistory(), getVendorUsage() (+27 more)

### Community 491 - "Community 491"
Cohesion: 0.07
Nodes (34): CAMPAIGN_DOMAIN_MAP, resolveDomainFromCampaign(), getShopEnquiryTypeLabel(), LEAD_SOURCE_DEF, LeadSource, META_MEDIUM_LABELS, PLATFORM_LABELS, SHOP_ENQUIRY_TYPE_LABELS (+26 more)

### Community 493 - "Community 493"
Cohesion: 0.10
Nodes (24): BooksSkeleton(), BODY, BooksPage(), canSee(), metadata, SHELL, RefreshBooksButton(), ZohoStatusPill() (+16 more)

### Community 494 - "Community 494"
Cohesion: 0.09
Nodes (4): BudgetContentSkeleton(), OversightSkeleton(), FilterBarSkeleton(), PageHeaderSkeleton()
...
Cohesion: 0.08
Nodes (39): ELEVATED, resolveImprovementRequestAction(), ELAYA_MEMORY_KIND_RANK, ELAYA_MEMORY_SOURCES, ElayaMemoryKind, ElayaMemorySource, ElayaRequestKind, ElayaRequestStatus (+31 more)

### Community 501 - "Community 501"
Cohesion: 0.33
Nodes (8): canSeeMemberFinance(), getMemberFinanceFor(), MemberFinancePage(), metadata, Props, ZohoAsync(), logMemberAccess(), getMemberFinance()
...
Cohesion: 0.31
Nodes (7): AdCreativesPage(), EMPTY_FILTERS, metadata, AdCreativesManager(), getAllAdCreatives(), fetchCampaignMetricsFromRpc(), getCampaignMetrics()
...
Cohesion: 0.05
Nodes (53): ANTHROPIC_IMAGE_TYPES, anthropicAdapter, isOwnEntity(), collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn() (+45 more)
...
Cohesion: 0.05
Nodes (42): SPRING_TAB, useModalScope(), usePopoverKeyboard(), LeadColumnPicker(), InlineSelectField(), AssigneeInlinePicker(), Calendar(), CalendarProps (+34 more)

### Community 534 - "Community 534"
Cohesion: 0.05
Nodes (52): AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, getServiceCategoryLabel(), SERVICE_CATEGORY_DEF, ServiceCategory, ServiceInterest (+44 more)
...
Cohesion: 0.17
Nodes (11): generateViewport(), inter, playfairDisplay, RootLayout(), isAppearanceKey(), isThemeKey(), DashboardLayout(), AppBootScreen() (+3 more)

### Community 543 - "Community 543"
Cohesion: 0.09
Nodes (7): MemberZohoSkeleton(), FIELD_WIDTHS, FilterBarSkeletonProps, PageHeaderSkeletonProps, ShimmerProps, SkeletonCard(), SkeletonCardProps
...
Cohesion: 0.06
Nodes (40): EASE_IN_EXPO, EASE_SPRING, SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, NotificationsContext, NotificationsContextValue, NotificationsProviderProps (+32 more)
...
## Knowledge Gaps
- **5270 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+5265 more)
...
- **Why does `createAdminClient()` connect `Tasks Page Docs` to `SLA Business Hours`, `Auth & Lead Actions`, `Task Constants & UI`, `Community 262`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Community 394`, `Lead Edit & Search`, `Page Skeletons & Flags`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Community 528`, `Task Summary & SLA Policies`, `Community 401`, `Agent Performance Metrics`, `Agent Performance Shell`, `Service Interests & Cases`, `Campaign & Domain Filters`, `Deal Type Definitions`, `Agent Detail & Performance`, `WhatsApp Page Documentation`, `Elaya Actions Service`, `Agent Deals & Cards`, `Lead Sources & Activity`, `Deals Page Documentation`, `Motion & Date Utilities`, `Page Loading Skeletons`, `Escalations & SLA Service`, `Community 442`, `Performance Scorecards & Drills`, `Toast & Domain Utilities`, `Community 65`, `Community 66`, `Community 67`, `Community 68`, `Community 452`, `Community 70`, `Community 202`, `Community 460`, `Community 206`, `Community 81`, `Lead Column Preferences`, `PII Masking & Revival Tests`, `Community 228`, `Community 488`, `Community 234`, `Community 491`, `Community 498`, `Community 501`, `Community 375`, `Community 504`, `Community 254`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 533` to `Lead Import Scripts`, `Community 236`, `Community 361`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `Button` connect `Budget & Spend UI` to `Community 258`, `Community 133`, `Community 134`, `Auth Roles & Cache Actions`, `Lead Edit & Search`, `Community 140`, `Task Summary & SLA Policies`, `Community 147`, `Shared Types & Props`, `Community 405`, `Community 534`, `Agent Performance Metrics`, `Community 533`, `Community 537`, `Settings Page Documentation`, `Community 160`, `Deal Type Definitions`, `Community 545`, `Community 290`, `Community 427`, `Community 304`, `Upload & Add Modals`, `Community 177`, `Community 176`, `Page Loading Skeletons`, `Anthropic LLM Adapter`, `Elaya Principal & Tools`, `Date Range Presets`, `Community 456`, `Community 203`, `Notification Bell & Hooks`, `Community 464`, `Community 81`, `Community 467`, `Community 468`, `Community 213`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Community 475`, `Community 476`, `Community 94`, `Community 97`, `Community 228`, `Community 361`, `Community 234`, `Community 107`, `Community 110`, `Community 370`, `Community 498`, `Profiles Data Model`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _5391 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.00234192037470726 - nodes in this community are weakly interconnected._
