...
## Corpus Check
- 1227 files · ~5,941,792 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9500 nodes · 20076 edges · 515 communities (479 shown, 36 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `54178960`
...
1. `Serene — Changelog` - 773 edges
2. `createAdminClient()` - 298 edges
...
Cohesion: 0.05
Nodes (90): getSiaGroupInfoAction(), getSiaGroupsAction(), getSiaHealthAction(), getSiaMediaAction(), getSiaMessagesAction(), getSiaPairingStatusAction(), GROUP_KINDS, isGroupJid() (+82 more)

### Community 3 - "Auth & Lead Actions"
Cohesion: 0.11
Nodes (35): POST(), FACT_POLARITIES, FactPolarity, RELATION_KINDS, buildPersonaPromptBlock(), ElayaTurnEvent, ElayaTurnResult, runElayaTurn() (+27 more)

### Community 4 - "Task Constants & UI"
Cohesion: 0.04
Nodes (76): ADMIN_ROLES, uploadAdSpendAction(), UploadAdSpendSummary, assignLead(), bulkUpdateLeads(), getDomainHealthMetricsAction(), ADMIN_ROLES, createRechargeAction() (+68 more)

### Community 5 - "Task Actions & Mutations"
Cohesion: 0.12
Nodes (13): EASE_IN_EXPO, ACTION_ITEMS, CommandPaletteProps, EMPTY_RESULTS, GOTO_PAGES, hairline, kbdChipStyle, PaletteItem (+5 more)
...
Cohesion: 0.16
Nodes (14): getLeadNotes(), maskString(), main(), TestLead, testLeads, VERDICT_TAG, wrap(), getLeadNotesFullForElaya() (+6 more)

### Community 8 - "Dashboard Widget Registry"
Cohesion: 0.11
Nodes (33): createManualLead(), isNotificationCategoryKey(), SIA_ALERT_TIER1_PROFILE_IDS, LeadAssignedNotifyInput, notifyLeadAssigned(), DEFAULT_ON, filterRecipientsByPref(), getNotificationPrefs (+25 more)

### Community 9 - "Auth Roles & Cache Actions"
Cohesion: 0.09
Nodes (30): getConversationsAction(), getMessagesAction(), searchConversationsAction(), isWhatsAppPeriod(), WHATSAPP_PERIOD_LABELS, WHATSAPP_PERIODS, WhatsAppPeriod, WHATSAPP_API_BASE (+22 more)

### Community 10 - "WhatsApp Constants & Config"
Cohesion: 0.10
Nodes (29): maybeSendCustomerWelcome(), getMediaDownloadUrl(), verifyMetaSignature(), getOrCreateConversation(), insertInboundMessage(), parseWebhookPayload(), processInboundMessage(), processStatusUpdate() (+21 more)
...
Cohesion: 0.10
Nodes (32): useCreateTriggerModal(), GiaTask, PersonalTasksResult, TaskGroupRow, AddTaskButton(), AddTaskButtonProps, CompletedTasksButton(), GroupTasksTab() (+24 more)
...
Cohesion: 0.07
Nodes (56): VENDOR_ROLES, addReviewCore(), addVendorNoteCore(), AdminClient, classify(), closeEngagementCore(), createVendorCore(), deleteCapabilityCore() (+48 more)

### Community 16 - "Ad Creative UI Components"
Cohesion: 0.11
Nodes (32): canSee(), FreshdeskPage(), OverviewAsync(), parseFilters(), TicketsAsync(), applyTicketFilters(), FdFilterVocab, getFreshdeskClientScope() (+24 more)

### Community 17 - "Budget & Spend UI"
Cohesion: 0.05
Nodes (68): addTaskRemarkAction(), assertAssigneeActive(), createGroupTaskAction(), createPersonalTaskAction(), createSubtaskAction(), deleteTaskAction(), getCompletedTasksAction(), getGroupSubtasksAction() (+60 more)

### Community 18 - "Task Summary & SLA Policies"
Cohesion: 0.08
Nodes (34): resolveDomainFromCampaign(), getDomainInterests(), adaptGoogle(), adaptMeta(), adaptShopApp(), adaptWebsite(), LeadSource, META_COLUMN_KEYS (+26 more)

### Community 19 - "Agent Performance Metrics"
Cohesion: 0.13
Nodes (44): actorFromProfile(), refreshBooksOverviewAction(), refreshClientFinanceAction(), RefreshClientFinanceSchema, addClientFactAction(), addClientObservationAction(), addClientPersonAction(), adjustClientHealthAction() (+36 more)
...
Cohesion: 0.10
Nodes (24): armCadenceForOutcome(), ArmCadenceSchema, CadenceLeadRow, CancelSlaSchema, istDateKey(), policyDeadline(), RefreshActivitySlaSchema, scheduleCadenceTick() (+16 more)
...
Cohesion: 0.16
Nodes (8): CardBody(), cardStyle, DealCard(), DealCardProps, useWonCelebration(), Petal, PetalFall(), PetalFallProps
...
Cohesion: 0.06
Nodes (50): getBudgetGaugeWidgetAction(), AccountReportSection(), BudgetAsync(), Props, BudgetEmptyState(), BudgetSectionHeader(), SectionHeaderDatum(), BudgetTable() (+42 more)

### Community 30 - "Settings Page Documentation"
Cohesion: 0.08
Nodes (45): CampaignFilters(), CampaignFiltersProps, ClientsFilters(), HEALTH_ITEMS, UNLINKED_ITEMS, DateRangePreset, DEF, matchDateRangePreset() (+37 more)
...
Cohesion: 0.04
Nodes (64): createWalkInDeal(), notifyDealCreated(), addLeadNote(), resolveDealShapeForDomain(), REVIVAL_CANDIDATE_STATUSES, REVIVAL_DEFAULT_SILENCE_DAYS, REVIVAL_TASK_PRIORITY, REVIVAL_TASK_TYPE (+56 more)

### Community 33 - "Deal Type Definitions"
Cohesion: 0.05
Nodes (47): DASHBOARD_WIDGETS, WidgetColSpan, DROPDOWN_VARIANTS, DROPDOWN_VARIANTS_UP, FLIP_UP_TRANSFORM_TEMPLATE(), AddWidgetMenu(), DashboardCanvas(), DashboardCanvasProps (+39 more)

### Community 34 - "Audio Recorder & Notes"
Cohesion: 0.04
Nodes (62): ROW_VARIANTS, GROUP_TASK_ACCENT_COLORS, GROUP_TASK_ICONS, TASK_CATEGORY, TASK_PRIORITY, TASK_REMARK_STATUS_LABELS, TASK_STATUS, useTaskCompletionToggle() (+54 more)
...
Cohesion: 0.13
Nodes (38): encoder, isRateLimited, POST(), respondViaPythonBrain(), SSE_HEADERS, getElayaTimeGreeting(), pickElayaDailyLine(), resolveStaffPrincipal() (+30 more)
...
Cohesion: 0.07
Nodes (31): ELAYA_DAILY_LINES, ELAYA_STARTER_PROMPTS, ElayaStreamHandlers, streamElayaChat(), TOOL_STATUS_LABELS, toolStatusLabel(), ElayaChatShell(), Props (+23 more)

### Community 40 - "Elaya Actions Service"
Cohesion: 0.09
Nodes (26): metadata, MobileActivityPage(), metadata, MobileBudgetPage(), ADMIN_ROOMS, DOMAIN_PASTEL_TOKENS, DOMAIN_VERTICALS, DomainVertical (+18 more)
...
Cohesion: 0.08
Nodes (30): getPersonalTasksAction(), getPersonalTaskTagsAction(), getGiaTasks(), getGroupTasksFor(), getPersonalTasksFor(), getVisibleGroupById(), LeadTasksAsync(), Props (+22 more)

### Community 43 - "Lead Sources & Activity"
Cohesion: 0.06
Nodes (39): useWidgetDensityTier(), Cell(), PipelineLine(), TodayStrip(), BenchmarkLine, CardConfig, computeDelta(), CoreFourGrid() (+31 more)
...
Cohesion: 0.03
Nodes (101): ActivityCursorSchema, AgentSelfMetrics, assertDrillAccess(), DOMAIN_LEADS_DRILL_KINDS, DomainLeadsDrillKind, DrillCursorSchema, FIRST_TOUCH_BUCKET_IDS, getAgentCallsForManagerAction() (+93 more)
...
Cohesion: 0.10
Nodes (25): anthropicAdapter, BridgeBody, LlmChatMessage, LlmCompleteRequest, LlmCompleteResult, LlmProviderAdapter, LlmStopReason, LlmToolDefinition (+17 more)

### Community 50 - "Motion & Date Utilities"
Cohesion: 0.20
Nodes (12): FD_SYNC_KEYS, CALLS, main(), MEDIA, MINUTES, POLL, pollLoop(), sleep() (+4 more)
...
Cohesion: 0.08
Nodes (16): BudgetContentSkeleton(), ClientsTableSkeleton(), ElayaLoading(), EscalationsSkeleton(), FreshdeskTableSkeleton(), TicketsTableSkeleton(), FilterBarSkeleton(), FilterBarSkeletonProps (+8 more)
...
Cohesion: 0.08
Nodes (29): recordDeal(), DEAL_CATEGORY_DEF, DEAL_DURATION_DEF, DEAL_TYPE_DEF, DealCategory, DealDuration, DealShape, DealShapeInput (+21 more)

### Community 58 - "Anthropic LLM Adapter"
Cohesion: 0.08
Nodes (25): toggleAgentRouting(), chevronStyle, inputBase, selectBase, TrainingAssetFormModalProps, compareDomainDisplayOrder(), TRAINING_ASSET_KIND_DEF, TRAINING_BUCKET (+17 more)
...
Cohesion: 0.05
Nodes (62): DomainsVolumeSchema, effectiveWidgetDomain(), GaugeScopeSchema, getAgentRecentActivityAction(), getAgentTasksSummaryAction(), getLeadsByCampaignAction(), getLeadStatusSummaryAction(), getLeadVolumeByDomainsAction() (+54 more)

### Community 61 - "Elaya Principal & Tools"
Cohesion: 0.13
Nodes (19): FRESHDESK_ROLES, runFreshdeskSyncNow(), SyncNowResult, anyTicket, APPLY, creationRule, main(), SITE (+11 more)
...
Cohesion: 0.16
Nodes (15): DEFAULT_COLUMN_ORDER, isValidLeadColumnId(), LEAD_COLUMN_MAP, LEAD_COLUMNS, LeadColumnDef, LeadColumnId, EASE_SPRING, getDefaults() (+7 more)

### Community 64 - "Toast & Domain Utilities"
Cohesion: 0.04
Nodes (75): exportLeadsAction(), AdCreativesPage(), EMPTY_FILTERS, CampaignListAsync(), CampaignListAsyncProps, CampaignMetricsStripSkeleton(), ACTIVITY_EXPORT_HEADERS, ExportHeader (+67 more)

### Community 65 - "Community 65"
Cohesion: 0.06
Nodes (29): LeadDossierPage(), DynamicFormResponses(), Props, LeadDealCardAsync(), Props, LeadNotesInput(), LeadNotesSection(), LeadNotesSectionAsync() (+21 more)
...
Cohesion: 0.09
Nodes (25): TICKET_LINK_KINDS, TICKET_ORIGINS, TICKET_SUB_CATEGORIES, extractJson(), TicketDraft, AddTicketNoteSchema, AssignTicketSchema, CreateTicketInput (+17 more)

### Community 68 - "Community 68"
Cohesion: 0.12
Nodes (10): chip, Detail, iconBtn, PasswordReveal, Props, rowMain, rowNote, rowStyle (+2 more)
...
Cohesion: 0.05
Nodes (50): AdCreativeFormModal(), actionBtnStyle, AdCreativesManager(), AdCreativesManagerProps, CARD_HOVER, actionBtnStyle, AssetCard(), CARD_HOVER (+42 more)
...
Cohesion: 0.09
Nodes (26): chevronStyle, EditAuthorizationForm(), initialState, labelStyle, Props, selectStyle, EditProfileForm(), FieldProps (+18 more)
...
Cohesion: 0.06
Nodes (42): getAgentUsageAction(), recordPresenceAction(), resolveColorMap(), DOMAIN_LINE_COLORS, DOMAIN_ICONS, getDomainIcon(), GIA_DOMAIN_ICONS, DomainDealsDrillModal() (+34 more)
...
Cohesion: 0.06
Nodes (28): chevronStyle, CreateUserForm(), CreateUserFormProps, CreateUserMode, FieldProps, FooterProps, formStyle, initialState (+20 more)

### Community 82 - "Lead Column Preferences"
Cohesion: 0.05
Nodes (55): CAMPAIGN_DOMAIN_MAP, ROUTING_POOL_ROLES, AddDealButton(), NewDealModal, Props, DealsAsync(), DealsAsyncProps, DealsSummaryStrip() (+47 more)
...
Cohesion: 0.25
Nodes (8): SubscriptionType, ContentProps, getMulti(), getStr(), SubscriptionsPage(), SubscriptionsTable(), SubscriptionViewTabs(), VIEWS
...
Cohesion: 0.07
Nodes (38): clampWidgetHeight(), DEFAULT_GRID_BY_ROLE, DEFAULT_LAYOUT_BY_ROLE, DENSITY_THRESHOLDS, GridPlacement, isValidWidgetId(), MANAGER_GRID, resolveWidgetDensity() (+30 more)
...
Cohesion: 0.04
Nodes (85): ADMIN_ROLES, deleteAdCreative(), upsertAdCreative(), setAgentShiftAction(), toggleRoutingSchema, requireProfile(), deleteNote(), upsertNote() (+77 more)

### Community 93 - "Revival Service & Policies"
Cohesion: 0.08
Nodes (25): signOutUser(), PlacingLoader(), RequestRow(), STATUS_DOT, ToastPill(), FilterChip(), MobileSegmented(), MobileStepper() (+17 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (29): ElayaFeedbackCard(), ADMIN_NAV, ANALYTICS_NAV, getConfigurationNav(), MAIN_NAV, MOBILE_TRIGGER_PATHS, NavItem, NavLink() (+21 more)
...
Cohesion: 0.07
Nodes (28): assertLeadFieldEditAccess(), revalidateLeadDossier(), updateLeadCity(), updateLeadDomain(), updateLeadEmail(), updateLeadInterests(), updateLeadSource(), getLeadSourceLabel() (+20 more)
...
Cohesion: 0.05
Nodes (49): getHelpdeskLibraryAction(), HelpdeskDomainSchema, resolveHelpdeskDomain(), APP_DOMAIN_ENUM, DOMAIN_ICONS, persistDomainCookie(), getServiceCategoryLabel(), SERVICE_CATEGORY_DEF (+41 more)
...
Cohesion: 0.05
Nodes (54): recordDeal(), invalidateHelpdeskCache(), upsertServiceCaseAction(), BulkUpdateResult, ExportPayload, LeadEditContext, updateLeadStatus(), GIA_DOMAIN_ENUM (+46 more)
...
Cohesion: 0.31
Nodes (18): canTransition(), checklistForCategory(), addTicketNoteCore(), assignTicketCore(), createTicketCore(), dueStamps(), fail(), humanEvent() (+10 more)

### Community 117 - "Task Flow Sequences"
Cohesion: 0.12
Nodes (17): DEF, IconKey, persistAppIconCookie(), usePushSubscription(), Props, AppearanceSelector(), IconSelector(), Props (+9 more)
...
Cohesion: 0.39
Nodes (4): getMobileRooms(), MobileDrawer(), useMobileSession(), MobileTabBar()
...
Cohesion: 0.07
Nodes (28): ALL_TOOLS, ElayaReadToolName, ElayaTool, ElayaToolExecution, findTeammate, findVendors, FOUNDER_UP, getBudget (+20 more)
...
Cohesion: 0.09
Nodes (26): BarChart(), BarChartProps, BarChartSeries, CARTESIAN_MARGIN, cartesianDefaults, ChartFrame(), ChartFrameProps, ChartSkeleton() (+18 more)
...
Cohesion: 0.13
Nodes (20): collectMedia(), CustomerTurnInput, CustomerTurnMedia, CustomerTurnResult, runCustomerTurn(), buildCustomerSystemPrompt(), CustomerPrincipal, ElayaPersona (+12 more)

### Community 134 - "Community 134"
Cohesion: 0.11
Nodes (40): budgetHasRoom(), listAgents(), listConversations(), listGroups(), listSlaPolicies(), listTicketFields(), listTicketsUpdatedSince(), BackfillState (+32 more)
...
Cohesion: 0.14
Nodes (24): getMyNotificationsAction(), markAllReadAction(), markNotificationReadAction(), markReadSchema, SPRING_BOUNCE, useNotifications(), UseNotificationsReturn, useNotificationSound() (+16 more)
...
Cohesion: 0.10
Nodes (35): ZOHO_CACHE_TTL, ZOHO_REDIS_KEYS, createZbBudget(), getArAgingSummary(), getContact(), getInvoiceDashboard(), getOrganization(), getProfitAndLoss() (+27 more)
...
Cohesion: 0.02
Nodes (140): getVendorDetailAction(), rankVendorsAction(), searchVendorsAction(), signVendorInvoiceAction(), CAPABILITY_STANCE_DEF, CapabilityStance, ENGAGEMENT_OUTCOME_DEF, EngagementOutcome (+132 more)
...
Cohesion: 0.16
Nodes (23): GiaDomain, DomainFetchResult, useDomainRoomData(), ProgressCard(), DomainSwiper(), EVENT_PRESENTATION, eventDetail(), FeedState (+15 more)

### Community 177 - "Community 177"
Cohesion: 0.13
Nodes (18): ALWAYS_ALLOWED_PREFIXES, DOMAIN_ROUTE_MAP, TICKET_CATEGORIES, TicketCategory, NewTicketPage(), listQueendomStaff(), NewTicketForm(), parseFilters() (+10 more)
...
Cohesion: 0.11
Nodes (17): SUBSCRIPTION_STATUS_CONFIG, SubscriptionCurrency, Props, DepartmentPills(), DEPT_PILL, PILL_BASE, SubscriptionStatusPill(), TypePill() (+9 more)
...
Cohesion: 0.08
Nodes (47): deleteClientPersonAction(), linkClientGroupAction(), searchClientsAction(), unlinkClientGroupAction(), updateClientPersonAction(), RELATIONS, addFactCore(), addHealthAdjustCore() (+39 more)
...
Cohesion: 0.20
Nodes (14): FreshdeskWebhookPayload, isRateLimited, KNOWN_EVENTS, POST(), isRateLimited, LEAD_SOURCES_SET, logRawPayload(), POST() (+6 more)
...
Cohesion: 0.08
Nodes (35): AgentDetailAsync(), AppDomainCallerRole, TeamDetailAsync(), AgentBreakdownGrid(), AgentOversightMetricsRow(), describeMeta(), EVENT_META, OversightAgentRail() (+27 more)

### Community 235 - "Community 235"
Cohesion: 0.09
Nodes (33): TICKET_ACTIVE_STATUSES, TicketActorKind, TicketChecklistItem, TicketLinkKind, TicketOrigin, TicketResolution, TicketPage(), getTicketDetail() (+25 more)
...
Cohesion: 0.07
Nodes (41): CallerRole, AddRechargeButton(), AddRechargeModal, AdSpendUploadButton(), AdSpendUploadModal, SearchParams, CampaignListSkeleton(), CampaignsPage() (+33 more)
...
Cohesion: 0.14
Nodes (15): fdStatusLabel(), fdStatusTone, FreshdeskOverview(), FreshdeskOverviewSkeleton(), SyncLine(), TILE_GRID, FreshdeskPriorityDot(), FreshdeskStatusPill() (+7 more)

### Community 259 - "Community 259"
Cohesion: 0.07
Nodes (45): ConversationIdSchema, initiateWhatsAppConversationAction(), markConversationAsRead(), SendMessageSchema, sendWhatsAppMediaMessage(), sendWhatsAppMessage(), signWhatsAppMediaAction(), RootPage() (+37 more)
...
Cohesion: 0.15
Nodes (12): AppBootScreen(), CommandPalette, CommandPaletteProvider(), IconInitializer(), ThemeInitializer(), INTERACTION_EVENTS, UsagePresence(), SuggestionComposerModal (+4 more)
...
Cohesion: 0.03
Nodes (82): CALL_OUTCOME_DEF, DealType, defineEnum(), EnumDef, DOMAIN_LABELS, JOURNEY_STATUSES, LEAD_STATUS_BADGE, LEAD_STATUS_COLORS (+74 more)
...
Cohesion: 0.06
Nodes (45): listAgentsForDealDomain(), createUser(), inviteUser(), mapProfileError(), toggleUserActive(), updateProfile(), updateProfileAvatar(), updateUserAuthorization() (+37 more)
...
Cohesion: 0.04
Nodes (73): ClientFactsCard(), ICONS, ClientFormModal(), FIELD, Props, ClientHealthCard(), ClientIdentityCard(), ClientObservationCard() (+65 more)
...
Cohesion: 0.04
Nodes (77): createLeadTaskAction(), getAssignableUsersAction(), chevronStyle, inputBase, selectBase, AddRechargeModal(), fieldLabelStyle, inputStyle (+69 more)
...
Cohesion: 0.14
Nodes (12): INVOICE_ACCEPT_MIME, PAYMENT_TYPES, SUBSCRIPTION_CURRENCY_DEF, SUBSCRIPTION_STATUS_OPTIONS, SUBSCRIPTION_STATUSES, SUBSCRIPTION_TYPE_DEF, SubscriptionShape, SubscriptionShapeInput (+4 more)

### Community 370 - "Community 370"
Cohesion: 0.15
Nodes (11): SubscriptionStatus, AddEditSubscriptionModal, AddSubscriptionButton(), LogTopupModal, RecordPaymentModal, RenewalPickerModal, SubscriptionListItem, SubscriptionPaymentRow (+3 more)
...
Cohesion: 0.10
Nodes (27): PersonalTaskRow, AssigneePickerModal(), CreatePersonalTaskModal(), buildTaskDots(), CalendarTaskRow, CalendarTaskRowProps, DateSection, getDueDateColor() (+19 more)

### Community 375 - "Community 375"
Cohesion: 0.16
Nodes (11): TICKET_BRIEF_FIELD_LABELS, TICKET_BRIEF_FIELDS_BY_CATEGORY, TicketBriefField, BriefState, CARD, FIELD, TicketSelection, FIELD (+3 more)
...
Cohesion: 0.26
Nodes (13): addLeadCallNote(), logSlaScheduleRejections(), refreshActivitySlaTimers(), resolveAgentShift(), scheduleSlaTimersForLead(), getAgentRoutingConfigAdmin(), invalidateLeadCaches(), addLeadCallNoteCore() (+5 more)
...
Cohesion: 0.22
Nodes (9): AudioRecorderStatus, AudioRecording, formatRecorderElapsed(), MIME_CANDIDATES, useAudioRecorder(), UseAudioRecorderOptions, Props, DictationButton() (+1 more)

### Community 401 - "Community 401"
Cohesion: 0.09
Nodes (31): FD_EXT_BY_MIME, FD_PRIORITY_LABELS, FD_SOURCE_LABELS, FD_STATUS_LABELS, FD_TERMINAL_STATUSES, FD_TRACKED_FIELDS, FD_WAITING_STATUSES, fdAttachmentExt() (+23 more)
...
Cohesion: 0.17
Nodes (12): getSpendingOverview(), getSubscriptionMonthlyReport(), getSubscriptions(), groupBy(), lastTwelveMonths(), MONTH_NAMES, monthBounds(), MonthlyReportRow (+4 more)

### Community 404 - "Community 404"
Cohesion: 0.14
Nodes (17): isCadenceCode(), buildSituations(), CreateRuleDraft, CreateRuleForm(), HOURS_MODE_OPTIONS, RECIPIENT_LABELS, RECIPIENT_OPTIONS, RECIPIENT_VERB (+9 more)

### Community 405 - "Community 405"
Cohesion: 0.04
Nodes (59): BODY, BooksOverviewStrip(), GRID, SHELL, AdCreativeFormModal, CampaignAdPanel(), CampaignAdPanelProps, ClientActivityCard() (+51 more)
...
Cohesion: 0.25
Nodes (7): AdCreativeFormModalProps, AdCreativeCarousel(), AdCreativeCarouselProps, AdCreativePlayer(), AdCreativePlayerProps, Props, AdCreative
...
Cohesion: 0.27
Nodes (8): cancelSlaTimersForLead(), cancelSlaTimersForLeadInternal(), cancelSlaTimersForLeadInDb(), cancelRunsByTag(), cancelLeadSlasByLeadTask(), fireLeadSlaTask, FireSlaBreachPayload, _ScheduleLeadSlasPayloadDoc
...
Cohesion: 0.27
Nodes (8): BudgetTab, BudgetTabContext, BudgetTabContextValue, BudgetTabProvider(), useBudgetTab(), BudgetFilterBar(), TABS, BudgetWorkspace()
...
Cohesion: 0.11
Nodes (26): dismissRevivalCandidateAction(), reviveLeadAction(), updateRevivalPolicyAction(), REVIVAL_TRIGGER_STATUSES, RevivalTriggerStatus, reviveLeadCore(), countAutoRevivesToday(), getActiveRevivalPolicies() (+18 more)
...
Cohesion: 0.11
Nodes (20): ElayaTrainingManager(), metadata, MobileAgentTasksPage(), OversightAgentPage(), BudgetPage(), ClientAppLayout(), isAppDomain(), OversightTeamPage() (+12 more)
...
Cohesion: 0.11
Nodes (24): FRESHDESK_CATEGORY_TO_TICKET, TICKET_ACTOR_KINDS, TICKET_APP_STAGE, TICKET_BRIEF_FIELDS, TICKET_CHECKLIST_TEMPLATES, TICKET_EVENT_TYPES, TICKET_PRIORITIES, TICKET_PRIORITY_WEIGHT (+16 more)
...
Cohesion: 0.36
Nodes (8): describePolicy(), fireSlaBreachHandler(), formatSlaTimestamp(), logSlaActivity(), runCadenceTick(), getActiveFounders(), getOpenGiaFollowupTask(), markSlaTimerFired()
...
Cohesion: 0.05
Nodes (52): AdSpendUploadModal(), AgentDistributionBar(), AgentDistributionBarProps, SEGMENT_COLORS, CampaignCard(), CampaignCardProps, DOT_COLOR, MotionLink (+44 more)
...
Cohesion: 0.09
Nodes (23): FdAutomationRule, FdAutomationType, FdBudget, FdBudgetExhausted, FdRequestError, FdResponse, getTicket(), getTicketField() (+15 more)
...
Cohesion: 0.15
Nodes (12): FounderPerfActionsContext, FounderPerfActionsContextValue, FounderPerfActionsProvider(), useFounderPerfActions(), FounderDrillDownDeck, ManagerPerformancePanel(), Props, PerformanceRosterEmptyState() (+4 more)
...
Cohesion: 0.07
Nodes (37): findOwnersInDomain(), getBudget(), getCampaigns(), getDomainHealth(), getEscalations(), getHelpdeskCases(), getHelpdeskHooks(), getLeadByRef() (+29 more)
...
Cohesion: 0.25
Nodes (7): EMPTY, PaletteDealHit, PaletteLeadHit, paletteSearchAction(), PaletteSearchResult, PaletteTaskHit, PaletteSearchSchema

### Community 501 - "Community 501"
Cohesion: 0.26
Nodes (12): resolveCustomerPrincipal(), handleCustomerReply(), mediaTypeForKind(), recordBotMessage(), resolveInboundText(), sendTurnMedia(), transcribeWhatsAppAudio(), DeepgramResponse (+4 more)

### Community 502 - "Community 502"
Cohesion: 0.16
Nodes (17): BooksAsync(), ClientZohoSkeleton(), canSeeClientFinance(), ClientFinancePage(), Props, ZohoAsync(), assertRoom(), env() (+9 more)
...
Cohesion: 0.08
Nodes (15): DetailAppBar(), GreetingBlock(), HomeAppBar(), DEMO_CONCIERGE, DEMO_THREAD, FIELD_CHROME, MobileTextArea(), SearchPill() (+7 more)

### Community 505 - "Community 505"
Cohesion: 0.10
Nodes (19): BooksBankAccounts(), BooksSkeleton(), BODY, BooksPage(), canSee(), SHELL, RefreshBooksButton(), TONES (+11 more)
...
## Knowledge Gaps
- **4737 isolated node(s):** `cmd`, `@supabase/mcp-server-supabase`, `npx`, `@supabase/mcp-server-supabase`, `SUPABASE_ACCESS_TOKEN` (+4732 more)
...
- **Why does `createAdminClient()` connect `Task Constants & UI` to `Lead Mutations & Notifications`, `Community 259`, `Auth & Lead Actions`, `Community 133`, `Community 134`, `Ad Spend & Campaign Mapping`, `Dashboard Widget Registry`, `Community 394`, `WhatsApp Constants & Config`, `Community 140`, `Dashboard Data Actions`, `Ad Creative UI Components`, `Budget & Spend UI`, `Community 401`, `Agent Performance Metrics`, `Task Summary & SLA Policies`, `Agent Performance Shell`, `Community 405`, `Shared Types & Props`, `Community 409`, `Campaign & Domain Filters`, `Chart Components`, `Community 160`, `Agent Detail & Performance`, `Agent Deals & Cards`, `Community 300`, `Deals Page Documentation`, `Community 304`, `Upload & Add Modals`, `Performance Scorecards & Drills`, `Toast & Domain Utilities`, `Community 67`, `Community 457`, `Community 205`, `Notification Bell & Hooks`, `Lead Column Preferences`, `Community 467`, `Community 475`, `Themes & Notifications`, `Community 480`, `Community 97`, `Community 228`, `Community 487`, `Community 234`, `Community 235`, `Community 110`, `Community 495`, `Community 498`, `Tasks Page Docs`, `Community 501`, `Community 251`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `AppDomain` connect `Lead Column Preferences` to `Task Constants & UI`, `Community 133`, `Task Actions & Mutations`, `Dashboard Widget Registry`, `Lead Edit & Search`, `Budget & Spend UI`, `Task Summary & SLA Policies`, `Community 403`, `Community 276`, `Campaign & Domain Filters`, `Settings Page Documentation`, `Chart Components`, `Audio Recorder & Notes`, `Elaya Actions Service`, `Agent Deals & Cards`, `Community 300`, `Deals Page Documentation`, `Community 177`, `Escalations & SLA Service`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Toast & Domain Utilities`, `Community 70`, `Community 203`, `Notification Bell & Hooks`, `Ad Creatives & Campaign Pages`, `PII Masking & Revival Tests`, `Campaign Metrics & Leads UI`, `Community 234`, `Community 365`, `Community 110`, `Community 496`, `Community 498`, `Community 370`, `Community 373`, `Community 251`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `requireProfile()` connect `Themes & Notifications` to `Lead Mutations & Notifications`, `Community 259`, `Task Constants & UI`, `Dashboard Widget Registry`, `Auth Roles & Cache Actions`, `Community 394`, `Community 140`, `Dashboard Data Actions`, `Budget & Spend UI`, `Agent Performance Metrics`, `Shared Types & Props`, `Campaign & Domain Filters`, `Chart Components`, `Community 160`, `Agent Deals & Cards`, `Community 300`, `Deals Page Documentation`, `Anthropic LLM Adapter`, `Performance Scorecards & Drills`, `Elaya Principal & Tools`, `Toast & Domain Utilities`, `Community 456`, `Community 457`, `Community 205`, `Community 206`, `Notification Bell & Hooks`, `Community 475`, `Community 480`, `Community 97`, `Campaign Metrics & Leads UI`, `Community 365`, `Community 110`, `Community 500`?**
...
- **What connects `BM25 ranking algorithm for text search`, `Lowercase, split, remove punctuation, filter short words`, `Build BM25 index from documents` to the rest of the system?**
  _4846 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Changelog Entries` be split into smaller, more focused modules?**
  _Cohesion score 0.002688172043010753 - nodes in this community are weakly interconnected._
