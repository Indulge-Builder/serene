...
| -------------- | ------------------ | --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SeedMandala`  | `SeedMandala.tsx`  | `SeedMandalaProps`                      | **THE procedural brand mark** (logo-motion handoff 2026-07-03). 8 stroked circles, r=46, centers on a ring of radius 46 (offset === r — every circle passes through the exact center; that crossing IS the 8-petal seed flower). Variants: `gradient` (umber→gold, stroke 2.2, default), `currentColor` (stroke 7, tiny in-control sizes), `darkDisc` (light gold, stroke 4 — charcoal/scrim grounds). `draw` (1.15s trace, 90ms stagger) + `spin` (s/rev — FIXED speeds: boot 90 · spinners/buttons/veil 3.5 · Elaya 8 · watermark 40; never faster than 3.5). Brand gradient stops are the ONLY sanctioned component hex — never theme-tinted. Spin/draw are class-driven (`.serene-logo-spin`/`.serene-logo-draw`) so reduced-motion kills them (mark rests finished).
