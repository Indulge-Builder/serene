// ClientActivityCard — the timeline (STORE 4): every touchpoint from every source in one
...
import type { ClientEventRow } from '@/lib/types/client';

const KIND_LABEL: Record<string, string> = {
  message_in: 'Client wrote', message_out: 'We replied', ticket_created: 'Request opened', ticket_status: 'Request moved', ticket_resolved: 'Request resolved',
...
export function ClientActivityCard({ events }: { events: ClientEventRow[] }) {
  return (
