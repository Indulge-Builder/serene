// MemberRequestsCard — the member's requests: today the mirrored Freshdesk tickets (open
...
function Row({ t }: { t: MemberTicketSummary }) {
  return (
...
export function MemberRequestsCard({ tickets }: { tickets: { open: MemberTicketSummary[]; recent: MemberTicketSummary[]; total: number } }) {
