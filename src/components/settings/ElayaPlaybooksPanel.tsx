...
import { upsertElayaPlaybookAction, deleteElayaPlaybookAction } from '@/lib/actions/elaya-playbooks';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(260px, 340px) 1fr', gap: 'var(--space-6)', alignItems: 'start' }} className="serene-playbooks-grid">
        ...
        <SectionCard title={draft.id ? 'Edit playbook' : 'New playbook'} description="Example questions are how people really ask (one per line). The instructions are the method: what to look at, which time window, what to lead with. Elaya reads them word for word.">
