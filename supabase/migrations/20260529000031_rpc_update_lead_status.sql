-- Migration 0031: update_lead_status RPC
-- Wraps all DB writes for updateLeadStatus in a single transaction.
...
-- Won notification logic and SLA scheduling remain in the action layer (application concerns).
