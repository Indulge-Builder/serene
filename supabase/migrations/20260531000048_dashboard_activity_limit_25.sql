-- Bump agent_activity limit from 10 → 25 in get_dashboard_summary.
-- note_added rows are filtered client-side; fetching 25 ensures ~15 meaningful
-- events survive the filter (call_logged + note_added always fire together).
...
BEGIN
  ...
  -- ─────────────────────────────────────────────────────────────────
  -- 2. Agent Recent Activity — limit 25 (note_added filtered client-side)
  -- ─────────────────────────────────────────────────────────────────
